		...
		return (
				<div>
					{ this.renderCourseDropDown() }
            		{
            			...
            			<MappedFields clientCourseId={this.selectedCourse} courseData={this.state.courseData} formValues={this.props.formValues} regFormId={this.props.regFormId} isLoggedInUser={this.props.isLoggedInUser} />
            		}
