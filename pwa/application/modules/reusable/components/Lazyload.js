...
import {debounce,throttle,on, off } from './../utils/lazyloadUtil';
...
const checkNormalVisible = function checkNormalVisible(component) {
  ...
  if (!(node.offsetWidth || node.offsetHeight || typeof node.getClientRects != 'function' || ( typeof node.getClientRects == 'function' && node.getClientRects().length))) return false;
...
import decorator from './LazyloadDecorator';
