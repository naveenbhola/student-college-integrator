...
class ExamVacancies extends React.Component{
			...
			<section>
			        <div className="_container">
			        	...
			        	<div className="_subcontainer">
			        		{this.props.activeSection=="vacancies" && this.props.groupMapping && this.props.groupMapping.length>1?<ExamChangeCourseLayer groupMapping={this.props.groupMapping} selectedGroupName={this.props.selectedGroupName} basePageUrl={this.props.basePageUrl} groupId={this.props.groupId}/>:''}
							{wikiDescription}
