      ...
      return (
         <React.Fragment>
            <div id={this.wikkiContentId} className={classVal}>
                     ...
                     {this.props.sectionname!='homePage'? <div className="gradient-col" style={{display:'none'}} id={this.viewMoreLink} ><a className="gradVw-mr button button--secondary more arrow" onClick={this.showHiddenText.bind(this, this.props.sectionname+'_'+this.props.order)}>View more</a></div>:''}
                 </div>
                     {this.props.sectionname=='homePage'?
               <div className="gradient-col" style={{display:'none'}} id={this.viewMoreLink} ><a className="gradVw-mr button button--secondary more arrow" onClick={this.showHiddenText.bind(this, this.props.sectionname+'_'+this.props.order)}>View more</a></div>:''}
               </React.Fragment>
         )
   }
}
