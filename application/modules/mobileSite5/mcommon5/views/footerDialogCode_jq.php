...
<?php if(MOBILE_SEARCH_V2_INTEGRATION_FLAG == 1){ ?>
	<div data-role="dialog" id="collegeSearchWidget" data-enhance="false" style="display: none;"><!-- dialog--> </div>
...
<div data-role="page" id="questionPostingLayerOneDiv" data-enhance="false" style="display: none;"></div>
<div data-role="page" id="questionPostingLayerTwoTagDiv" data-enhance="false" style="display: none;"></div>
<div data-role="page" id="addMoreTagsPostLayer" data-enhance="false" style="display: none;"></div>
<div data-role="page" id="socialShare" data-enhance="false"></div>
<?php if($boomr_pageid == 'mobilesite_LDP') {?>
	<div id="galleryList"  class= 'hid' data-role="page" data-enhance="false" ></div>
	<div id="galleryDetailList" class="galleryDetailList hid" data-role="page" data-enhance="false" ></div>
...
<?php if($boomr_pageid == 'mobilesite_AnA_homePage' || $boomr_pageid == 'mobilesite_AnA_QDP' || $boomr_pageid == 'mobilesite_TDP' || $boomr_pageid == 'listing_detail_course'){?>
	<div data-role="page" id="answerPostingLayerDiv" data-enhance="false" style="display: none;">
...
<div data-role="page" id="commentPostingLayerDiv" data-enhance="false" style="display: none;">
