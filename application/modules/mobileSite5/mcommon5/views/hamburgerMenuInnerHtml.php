...
?>
	...
	<ul id="mm-m0-p0" class="mm-list">
		...
		<li onclick="window.location='<?php echo SHIKSHA_HOME;?>/best-colleges-for-jobs-based-on-mba-alumni-data';trackEventByGAMobile('HTML5_HAMBURGER_CAREER_COMPASS')"><a href="javascript:void(0);">CAREER COMPASS</a></li-->
	...
	<div id="mm-m0-pcollegereview" style="display: none;" class="otherMenu">
		<ul style="padding: 0px;" class="mm-list" >
			...
			<li class="mm-subtitle" onclick="goToPreviousMenu('0','collegereview')"><a class="mm-subclose" href="#mm-m0-p0">College Reviews</a></li>
		</ul>
		<ul class="level-2-content mm-list">
