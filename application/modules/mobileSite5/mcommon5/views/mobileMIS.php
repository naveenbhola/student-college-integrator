<table align="center"  bgcolor="#fff" border="1" cellpadding="8" cellspacing="0" width="600" style="font:normal 15px Arial,Helvetica,sans-serif; color:#000; border:1px solid #cacaca; border-collapse:collapse">
  <tbody>
    <tr>
    <th colspan="2" bgcolor="#e7e7e7" style="padding:18px 0; font-size:14px">Shiksha Mobile Report <?php echo $date;?></th>
    </tr>
    <tr>
    <td width="450">Total Registration made:</td>
    <td><strong><?php if($siteDate['mobileresgcount']){echo $siteDate['mobileresgcount'];} ?></strong></td>
    </tr>
    <tr>
    <td>Total Responses made:</td>
    ...
    <tr>
    <th colspan="2" bgcolor="#e7e7e7" style="padding:12px 0; font-size:14px">Pagewise Details:</th>
    </tr>
    <tr>
    <td colspan="2" style="font:normal 15px Arial,Helvetica,sans-serif;">
