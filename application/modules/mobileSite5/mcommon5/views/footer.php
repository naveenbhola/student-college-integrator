...
<div style="display: none;">
	...
	<div data-role="page" id="regSScreen" class="sltNone">
	</div>
...
<?php 
$addThisName = ($pageName) ? $pageName : $boomr_pageid;
if(in_array($addThisName,array('RANK_PREDICTOR'))){?>
<script async type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5c1b59506e2754b7"></script>
<?php }?>
</html>
