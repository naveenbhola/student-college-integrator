<?php if(isset($isShowHeader) && $isShowHeader != true || $isShowHeader ==''){?>
...
<header id="page-header" class="clearfix">
    <div class="head-group">
        <h3 style="text-align: left;padding-left: 12px;">Select a location to view colleges</h3>
    </div>
</header>
<?php } ?>

<section class="layer-wrap fixed-wrap of-hide" <?php if(isset($isShowHeader) && $isShowHeader != true  || $isShowHeader ==''){?> style="height: 100%" <?php }else{?> style="height: 100%; margin-top:0px; " <?php }?>>
 ...
 <div class="content-child2 clearfix" style="padding:0 0.7em;">
  <section id="loc-section">   
	...
	<ul class="location-list location-list2" id="city-list">
		...
		<li id="cLI<?php echo $value['Id'];?>"><label id ="L_cLI<?php echo $value['Id'];?>" onClick="setLocationId('<?php echo $value['Id'];?>','city');">
	...
	<li style="padding:8px 6px !important;font-size: 0.9em;background-color:#ebebeb;" id="other_city_heading">&nbsp;Other Cities</li>
		...
		<li id="cLI<?php echo $v['Id'];?>"><label id ="L_cLI<?php echo $v['Id'];?>" onClick="setLocationId('<?php echo $v['Id'];?>','city');">
		<!--<input name="selected_city[]" type="radio" value="<?php echo $value['Name'];?>_<?php echo $value['Id'];?>"/> -->
	...
	<?php foreach( $stateListArray['stateNames'] as $key=>$value){ ?>
		<li id="sLI<?php echo $value['Id'];?>"><label id ="L_sLI<?php echo $value['Id'];?>" onClick="setLocationId('<?php echo $value['Id'];?>','state');">
