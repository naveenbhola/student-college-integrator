...
if(empty($calendarWidgetData)){
    ...
    <div class="data-card">
        <h2 class="color-3 f16 heading-gap font-w6"><?=$categoryName?> Exams Calender <span class="f12 block font-w4 color-6 "><?=$message?></span></h2>
        <div class="lcard color-w f14 color-3">
           <ul class="cls-ul ins-acc-ul f13">
            ...
            <div class="btn-sec">
                <a href="<?=$calendarWidgetLink?>"  class="btn btn-secondary color-w color-b f14 font-w6 m-15top m-5btm" ga-attr="VIEW_ALL_EXAM_CALENDER">View All</a>
            </div>
        </div>
       </div>
