...
<div style="" id="searchInnerCont_2" class="search-inner-container">
    <div id="srchContTab_colleges" class="tbs search-field clearfix" <?php echo $collegeStyle; ?>>
        <form formname="colleges" onsubmit="return false;">
            ...
            <ul>
                <li>
                    <?php $this->load->view('msearch5/msearchV2/collegeWidget'); ?>
                </li>
                <li id="collegeLocationBox">
                    <?php $this->load->view('msearch5/msearchV2/locationWidget'); ?>
                    <?php //$this->load->view('msearch5/msearchV2/advancedOptionsWidget', array('id' => 0)); ?>
                </li>
                <li style="display:none" class="adv-optionList">
                    <p class="adv-title">ADVANCED OPTIONS</p>
                </li>
                <li style="display:none">
                    <?php $this->load->view('msearch5/msearchV2/advancedOptionsWidget', array('id' => 1)); ?>
                </li>
                <li style="display:none">
                    <?php $this->load->view('msearch5/msearchV2/advancedOptionsWidget', array('id' => 2)); ?>
                </li>
                <li style="display:none">
                    <?php $this->load->view('msearch5/msearchV2/advancedOptionsWidget', array('id' => 3)); ?>
                </li>
                ...
                <li>
                    <input type="button" class="green-btn" value="SEARCH" id="submitButtonCollegeSearch" onclick="autoSuggestorInstanceArray.autoSuggestorInstance.handleInputKeys($.Event( 'keypress', { keyCode: 13 } )); event.stopPropagation();">
                </li>
    ...
    <div id="srchContTab_exams" <?php echo $examStyle; ?> class="tbs search-field clearfix">
        <?php echo $this->load->view('msearch5/msearchV2/exam_form'); ?>
    </div>
</div>