    ...
    <div class="rslt-bx">
        <div class="rslt-info">
            <img class="vit-img" src="/public/mobile5/images/vit_m.png" alt="vitee result 2017 png"  />
            <p style="margin-bottom:5px">
                Shiksha is hosting the official VITEEE 2017 Result for your convenience. The scores you can see are directly sourced from the VIT website.
            </p>
            <p>
                <a href="http://www.vit.ac.in" ga-attr="VIT_WEBSITE">Click here</a> to get redirected to the actual result page.
            </p>
            <?php if($showCounter){?>
            <div class="clck-algn">
                <div id="clockdiv">
            ...
            <div class="ex-fm" >
                ...
                <input type="hidden" value="1132" id="trackingPageKeyField">
            </div>
            </form>
        </div>
        </div>
