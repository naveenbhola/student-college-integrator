...
<div>
	...
	<div style="margin:0 10px">
		...
		<div class="row">
			...
			<span class="formHeader"><a class="formHeader" name="main" style="text-decoration:none" >Institute Details</a></span>
			<div class="line_1"></div>
		</div>
		<div style="line-height:16px">&nbsp;</div>
		<div class="row">
			<div class="row1"><b>Test preparatory institute name<span class="redcolor fontSize_13p">*</span>:<br/><span>[ <a href="javascript:void(0);" onClick="showPopup(300,100,'c_institute_name_help',obtainPostitionX(this)-5 , obtainPostitionY(this)+15);" >view example</a> ]</span></b></div>
			<div id="c_institute_name_help" style="visibility:hidden;" class="help-box">
					...
					<ul>
					<li>Should not be less than 10 characters.</li>
			...
			<div class="row2">
				<input type="text" profanity="true" blurMethod="check_Institute_name(this);" name="c_institute_name" id="c_institute_name" validate="validateStr" required="true" maxlength="100" minlength="10" style="width:350px" tip="college_name" caption="University/Institute Name" value="<?php echo $insttitle; ?>" />
				<div style="display:none"><div class="errorMsg" id="c_institute_name_error"></div></div>
			</div>
		</div>
		<div style="line-height:9px;clear:both">&nbsp;</div>
        <div class="row">
			<div class="row1"><b>Also known as:<br/><span>[ <a href="javascript:void(0);" onClick="showPopup(300,100,'c_abbreviation_help',obtainPostitionX(this)-5 , obtainPostitionY(this)+15);" >view example</a> ]</span></b></div>
		...
		<div style="line-height:9px;clear:both">&nbsp;</div>
		<div class="row">
			<div class="row1"><b>Year of establishment:<br/><span>[ <a href="javascript:void(0);" onClick="showPopup(300,100,'i_establish_year_help',obtainPostitionX(this)-5 , obtainPostitionY(this)+15);" >view example</a> ]</span></b></div>
...
<!-- 	<div class="row">
			<div class="row1"><b>AIMA Rating:</b></div>
			<div class="row2">
...
-->
		<div class="row">
			<div class="row1"><b>USP:<br/><span>[ <a href="javascript:void(0);" onClick="showPopup(300,100,'i_usp_help',obtainPostitionX(this)-5 , obtainPostitionY(this)+15);" >view example</a> ]</span></b></div>
		...
		<div class="row">
			<div class="row1"><b>Admission counseling offered:<br/><span>[ <a href="javascript:void(0);" onClick="showPopup(300,100,'counseling_help',obtainPostitionX(this)-5 , obtainPostitionY(this)+15);" >view example</a> ]</span></b></div>
			<div id="counseling_help" class="help-box" style="visibility:hidden;">
					<div style="text-align:right"><a href="javascript:void(0);" onclick="hidePopup('counseling_help');" > Close <span style="background:#CCC" >X</span></a></div>
					<ul>
					<li>Admission Counseling offered (Mostly for institutions abroad).</li>	
					</ul>
			</div>
			<div class="row2">
				<input leftposition = "100" name="admission_counseling" id="admission_counseling_yes" type="radio" <?php if ($admission_counseling == 'yes'): ?> checked <?php endif; ?> value="yes" tip="admission_counselling_offered" caption="Admission counseling offered"/> Yes &nbsp;
                <input leftposition = "50" name="admission_counseling" id="admission_counseling_no" type="radio" <?php if ($admission_counseling == 'no'): ?> checked <?php endif; ?> value="no" tip="admission_counselling_offered" caption="Admission counseling offered"/> No &nbsp;
				<div style="display:none"><div class="errorMsg" id="admission_counseling_yes_error"></div></div>
			</div>
		</div>
		<div style="height:10px;clear:both; overflow:hidden"></div>

		<div class="row">
			<div class="row1"><b>Visa assistance offered:<br/><span>[ <a href="javascript:void(0);" onClick="showPopup(300,100,'visa_help',obtainPostitionX(this)-5 , obtainPostitionY(this)+15);" >view example</a> ]</span></b></div>
			<div id="visa_help" class="help-box" style="visibility:hidden;">
					<div style="text-align:right"><a href="javascript:void(0);" onclick="hidePopup('visa_help');" > Close <span style="background:#CCC" >X</span></a></div>
					<ul>
					<li>Visa Assistance offered (For institutions abroad).</li>	
					</ul>
			</div>
			<div class="row2">
				<input leftposition = "100" name="visa_assistance" id="visa_assistance_yes" type="radio" <?php if ($visa_assistance == 'yes'): ?> checked <?php endif; ?> value="yes" tip="visa_assitance_offered"/> Yes &nbsp;
                <input leftposition = "50" name="visa_assistance" id="visa_assistance_no" type="radio" <?php if ($visa_assistance == 'no'): ?> checked <?php endif; ?> value="no" tip="visa_assitance_offered"/> No &nbsp;
				<div style="display:none"><div class="errorMsg" id="visa_assistance_error"></div></div>
			</div>
		</div>
		<div style="height:10px;clear:both; overflow:hidden"></div>

		<div class="row">
			<div class="row1"><div class="txt_align_r bld"><a id="collLogo" href="javascript:void(0);" onClick="return  replaceInnerHTML(this,'hideInstitueLogo','Logo of the Institute');">+ Logo of the Institute</a><br/><span>[ <a href="javascript:void(0);" onClick="showPopup(300,100,'collLogo_help',obtainPostitionX(this)-5 , obtainPostitionY(this)+15);" >view example</a> ]</span></div></div>
		...
		<div style="height:15px;clear:both;font-size:1px; overflow:hidden"></div>
		...
		<div class="row">
			<div class="row1"><div class="txt_align_r bld"><a id="collFeatPanel" href="javascript:void(0);" onClick="return  replaceInnerHTML(this,'FeaturedPanel','Featured Panel');" >+ Featured Panel</a><br/><span>[ <a href="javascript:void(0);" onClick="showPopup(300,100,'collFeatPanel_help',obtainPostitionX(this)-5 , obtainPostitionY(this)+15);" >view example</a> ]</span></div></div>
			...
			<div class="row2">
				<div style="display:none;" id="FeaturedPanel">
					...
					<?php } ?>
					<div style="position:relative">
						<div><input type="file" name="i_feat_panel[]" id="i_feat_panel" tip="institute_featured_panel"  leftPosition="75" value="0" value="" size="14" style="<?php echo $featured_style; ?>" /></div>
		...
		<div style="height:20px;clear:both;font-size:1px; overflow:hidden"></div>
		...
		<div class="row">
			<div class="row1"><div class="txt_align_r bld"><a id="collTags" href="javascript:void(0);" onClick="return  replaceInnerHTML(this,'AddTags','Tags');">+Tags</a></div></div>
			<div class="row2">
				<div style="display:none;" id="AddTags">
					<div><textarea style="width:300px;height:80px" name="i_tags" id="i_tags" validate="validateStr" maxlength="100" tip="listing_add_tag" style="width:180px" caption="Institute Tags"><?php echo $hiddenTags; ?></textarea></div>
		...
		<?php endif;?>
			...
			<div class="row1"><div class="txt_align_r bld"><span id="collBrochurePanel">Upload Brochure (PDF/Jpeg/MS word file): </span><br/><span>[ <a href="javascript:void(0);" onClick="showPopup(300,100,'institute_request_brochure_link_help',obtainPostitionX(this)-5 , obtainPostitionY(this)+15);" >view example</a> ]</span></div></div>
			...
			<div class="clearFix"></div>
                ...
                <div style="line-height:10px;clear:both;font-size:1px">&nbsp;</div>
	...
	<div class="row">
		<div style="float:left;width:200px;line-height:20px"><div class="txt_align_r bld">Upload Photo<span>[ <a href="javascript:void(0);" onClick="showPopup(300,100,'upload_join_photo_help',obtainPostitionX(this)-5 , obtainPostitionY(this)+15);" >view example</a> ]</span>:</div></div>
	...
	<div class="spacer10 clearFix"></div>
	<div class="row">
		<div style="float:left;width:200px;line-height:20px"><div class="txt_align_r bld">Enter Details<span>[ <a href="javascript:void(0);" onClick="showPopup(300,100,'upload_join_details_help',obtainPostitionX(this)-5 , obtainPostitionY(this)+15);" >view example</a> ]</span>:</div></div>
		...
		<div style="float:left;width:160px">
			<div><textarea tip="enter_details_field" validate="validateStr" maxlength="250" id="details" minlength="0" name="details" class='mceEditor' style="width:500px;height:100px"><?php echo $joinreason[0]['details']; ?></textarea></div>
		...
		<div>
			...
			<?php
				...
				<?php
                    ...
                    ?>
			<div class="spacer5 clearFix"></div><b><a id="addwikkicontent_flag" onclick="addwikkicontent(true);" href="javascript:void(0);" >+ Add more</a></b>
		</div>
	</div>

		<div style="line-height:9px">&nbsp;</div>
		<?php if($usergroup=='cms'):?>
		<div class="formHeader" style="margin:0 10px"><a class="formHeader" name="wikicontent" style="text-decoration:none">SEO Specifications <span>[ <a href="javascript:void(0);" onClick="showPopup(300,100,'seo_section_details_help',obtainPostitionX(this)-5 , obtainPostitionY(this)+15);" >view example</a> ]</span></a></div>
	...
	<div class="row">
			...
			<div style="float:left;width:405px"><div>
				<textarea <?php if($flow=='edit'  || $flow=='upgrade'){echo "disabled='true'";}?> caption="seo url" maxlength="250" minlength="0" class="mceNoEditor" id="listing_seo_url" name="listing_seo_url<?php if($flow=='edit'  || $flow=='upgrade'){echo "_disabled";}?>"><?php echo $seoListingUrl; ?></textarea>
	...
	<div style="line-height:9px;clear:both">&nbsp;</div>
		...
		<div class="row">
                        <div class="row1"><b>Source Type:</b></div>
                        <div class="row2">
                ...
                <div class="row">
                        <div class="row1"><b>Source Name:</b></div>
                        <div class="row2">
                                <input type="text" profanity="true" name="i_source_name" id="i_source_name" validate="validateStr" maxlength="100" style="width:350px"  caption="Source Name" value="<?php echo $source_name; ?>" blurMethod="checkSourceType();"/>
                                <div style="display:none"><div class="errorMsg" id="i_source_name_error"></div></div>
                        </div>
                </div>
     <?php }?>
