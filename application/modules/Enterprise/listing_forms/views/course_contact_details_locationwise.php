<div id="hideContacts_Details1" style="display: inline;" class="row">
        <div style="line-height:9px;clear:both">&nbsp;</div>
            ...
            <div class=row2>
            		<input type="button" value="Save" onclick="updateContactInfoForLocation();$('hideContacts_Details1').style.display='none';"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" value="Cancel" onclick="hideOverlayAnA();$('hideContacts_Details1').style.display='none';"/>
            </div>
        </div>