...
class Paypal_Lib {
	...
	//	$this->paypal_url = 'https://www.paypal.com/cgi-bin/webscr';
		...
		$this->paypal_url = $this->CI->config->item('gateway_url');
	...
	function log_ipn_results($success) 
	{
		...
		error_log("aaaaa1".print_r($this->ipn_response,true));
		
		error_log("aaaaa2".$this->ipn_response);
