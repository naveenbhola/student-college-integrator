                ...
                <div style="width:100%;float:left;clear:both;">
                    <div style="width:40%;float:left;">
                            ...
                            <div style="margin-top:20px; width:100%;">
                                    <span>Article ID 1</span><span style="margin-left:40px;"><input type="text" name="must_read_text1" id="must_read_text1" value="Enter Article ID" default= "Enter Article ID" onfocus="checkTextElementOnTransition(this,'focus')" onblur="checkTextElementOnTransition(this,'blur')" style="color:#aaaaaa"></span><br />
                                    <span>Article ID 2</span><span style="margin-left:40px;"><input type="text" name="must_read_text2" id="must_read_text2" value="Enter Article ID" default= "Enter Article ID" onfocus="checkTextElementOnTransition(this,'focus')" onblur="checkTextElementOnTransition(this,'blur')" style="color:#aaaaaa"></span><br />
                                    <span>Article ID 3</span><span style="margin-left:40px;"><input type="text" name="must_read_text3" id="must_read_text3" value="Enter Article ID" default= "Enter Article ID" onfocus="checkTextElementOnTransition(this,'focus')" onblur="checkTextElementOnTransition(this,'blur')" style="color:#aaaaaa"></span><br />
                                    <span>Article ID 4</span><span style="margin-left:40px;"><input type="text" name="must_read_text4" id="must_read_text4" value="Enter Article ID" default= "Enter Article ID" onfocus="checkTextElementOnTransition(this,'focus')" onblur="checkTextElementOnTransition(this,'blur')" style="color:#aaaaaa"></span><br />
                                    <span>Article ID 5</span><span style="margin-left:40px;"><input type="text" name="must_read_text5" id="must_read_text5" value="Enter Article ID" default= "Enter Article ID" onfocus="checkTextElementOnTransition(this,'focus')" onblur="checkTextElementOnTransition(this,'blur')" style="color:#aaaaaa"></span><br />
                            </div>
                    </div>
