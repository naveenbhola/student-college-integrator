<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Add New Admission Notification</title>
    ...
    <body>
                ...
                <div class="boxcontent_lgraynoBg">
                    ...
                    <?php if($onBehalfOf=="true") { ?>
                        <div class="lineSpace_5">&nbsp;</div>
                            ...
                            <div class="lineSpace_5">&nbsp;</div>
                            <?php } ?>
                    <div class="normaltxt_11p_blk fontSize_16p OrgangeFont mar_full_10p"><strong>Add Admission Notification </strong></div>
        ...
        <script>
            var objForm = document.getElementById('admissionListing');
