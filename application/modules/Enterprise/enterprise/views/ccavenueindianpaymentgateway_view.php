...
<h2>
<span class="OrgangeFont" style="font-size:14px;">For transction through Credit Card/Debit Card/Net Banking/Cash Card/Mobile Payments , click on pay now
</span>
</h2>
<!-- <form method="post" action="https://www.ccavenue.com/shopzone/cc_details.jsp" id="ccAvenuePaymentForm">  -->
<form method="post" action="<?php echo $payment_gateway_url;?>" id="ccAvenuePaymentForm"> 
