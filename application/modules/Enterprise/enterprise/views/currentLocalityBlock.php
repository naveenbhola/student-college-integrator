...
<div id='preferredLocalityBlocks'>
	<div id='preferredLocalityBlock_1'>	
		<?php $this->load->view('enterprise/currentLocalities',array('blockNum' => 1)); ?>
	</div>
</div>
...
var load_preference_zone = function (obj,num){
    ...
    if (boxLength > 0) {
		...
		document.getElementById('hiddencurrentCity_'+num).value= "";
    }
	
	document.getElementById('hiddencurrentCity_'+num).value= "";
	
    if (DD_text != 'Select City') {
		document.getElementById('hiddencurrentMainCity_'+num).value = DD_text;
    } else {
		document.getElementById('hiddencurrentMainCity_'+num).value = "";
    }
...
var selectAllCheckBoxes = function (ref,num) {
    ...
    if ( ref == 1 ) {
		...
		document.getElementById('hiddencurrentCity_'+num).value= str;
    }
}
