...
<!--Pagination Related hidden fields Starts-->
	...
	<input type="hidden" autocomplete="off" id="moduleNameSel" value="<?php echo $moduleName;?>"/>
        <input type="hidden" autocomplete="off" id="typeOfModeration" value="<?php echo 'ques';?>"/>
							...
							<tr>
								<td>
									...
									<tr><td width="10%">&nbsp;</td>
										<td style="line-height:23px;display:block;"><span id="pagLabTop">Filter by Status</span>
											<select name="filter" id="filter" class="normaltxt_11p_blk_arial" onChange="filterLinkQuestionInfo();">
								...
								<td width="60%">
									...
									<tr valign="middle">
										...
										<td valign="top">
											<input type="button" value="Search" class="fontSize_10p" onClick="javascript: searchLinkedEntityReport('ques');"/>
										</td>
									</tr>
									</table></div>
								</td>
						...
						<div id="userAnswers">
							...
							<?php }							      //$threadIdList = '';
						      ...
						      <tr>
							      ...
							      <td width="8%"><input type="button" value="Delete" class="fontSize_10p" onClick="javascript: operateAbuseAll('deleteLinkQuestion',0);"/></td>
							      <td width="14%"><input type="button" value="Accept" class="fontSize_10p" onClick="javascript: operateAbuseAll('acceptLinkQuestion',0);"/></td>
						      ...
						      <?php } ?>
                                                   ...
                                                   for($i=0;$i<count($userInfo1);$i++){
                                                          ?>
                                <div class="lineSpace_10">&nbsp;</div>
						      <div class="" id="linkQuestionDiv<?php echo $userInfo1[$i]['id'];?>">
								      <input type="hidden" id="questionId<?php echo $userInfo1[$i]['id'];?>" value="<?php echo $userInfo1[$i]['id']; ?>">
                                                                      <input type="hidden" id="msgId<?php echo $userInfo1[$i]['id'];?>" value="<?php echo $userInfo2[$i]['msgId']; ?>">
                                                                      <input type="hidden" id="linkedQuestionId<?php echo $userInfo1[$i]['id'];?>" value="<?php echo $userInfo1[$i]['msgId'];?>">
								      ...
								      <div class="">
										  <div style="background:#dddddd;">
										    ...
										    <tr>
											    ...
											    <td width="20%" align="left">&nbsp;&nbsp;<b><?php echo $entityTypeDisplay." Original Thread ID:".$userInfo2[$i]['msgId'];?></b></td>
										  ...
										  <div style="padding:0 10px 0 10px">
											...
											<table cellspacing="0" cellpadding="0" border="0" height="25" width="100%">
											<tr>
												<td align="left" width="<?php if($info[0]->status[$i]=="Removed" || $temp['abuse']['status']=="Removed by Admin") echo "54%"; else echo "64%"; ?>"><img id="<?php echo $userInfo1[$i]['id']; ?>Toggler" src="/public/images/plusSign.gif" onclick="toggleAbuseDetails(<?php echo $userInfo1[$i]['id']; ?>)" align="absmiddle" style="cursor:pointer;margin-top:-8px"/>&nbsp; &nbsp;<a href="javascript:void(0);" class="fontSize_10p blackFont bld" onclick="toggleAbuseDetails(<?php echo $userInfo1[$i]['id']; ?>)">View Question Details</a> </td>
												<?php if($userInfo1[$i]['status']=="draft"){ ?>
												  <td align="right"><input type="button" value="Delete" class="fontSize_10p" onclick="changeLinkedQuestionStatus('<?php echo $userInfo1[$i]['id']; ?>','<?php echo $userInfo2[$i]['msgId'];?>','<?php echo $userInfo1[$i]['msgId'];?>','deleted')"/></td>

  <td align="right"><input type="button" value="Accept" class="fontSize_10p" onClick="changeLinkedQuestionStatus('<?php echo $userInfo1[$i]['id']; ?>','<?php echo $userInfo2[$i]['msgId'];?>','<?php echo $userInfo1[$i]['msgId'];?>','accepted');""/></td>
											...
											<table cellspacing="0" cellpadding="1" border="0" height="40" width="75%" style="border: 1px solid #E6E7E9">
											    ...
											    <tr height="30" style="border-style: dashed; border-width: medium;border-color: lime;">
											      ...
											      <td align="center" style="border-right: 1px solid #E6E7E9;"><a href="#" onClick="window.open('<?php echo getSeoUrl( $userInfo2[$i]['msgId'],'question', $userInfo2[$i]['msgTxt']); ?>');"><?php echo $userInfo2[$i]['msgTxt'];?></a></td>
                                                                                              <td style="border-right: 1px solid #E6E7E9;"><a href="#" onClick="window.open('<?php echo getSeoUrl( $userInfo1[$i]['msgId'],'question', $userInfo1[$i]['msgTxt']); ?>');"><?php echo $userInfo1[$i]['msgTxt'];?></a></td>
