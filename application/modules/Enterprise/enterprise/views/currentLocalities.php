...
<div style="width:100%">
	<div class="cmsSearch_RowLeft">
		<div style="width:100%">
			<div class="txt_align_r" style="<?php if($isMMM) { echo "font:bold 13px arial; padding-top:2px;"; } else { echo "padding-right:5px;"; } ?>">Current Localities:</div>
		</div>
	</div>
	<div class="cmsSearch_RowRight" style="<?php if($isMMM) { echo "width:480px; margin-left:10px;"; } ?>">
	<div style="width:100%">
			<select style="width:157px" onchange="load_preference_zone(this,<?php echo $blockNum; ?>);" id="perference_<?php echo $blockNum; ?>" name="currLocArr_<?php echo $blockNum; ?>[]">
...
<input type="hidden" id="hiddencurrentMainCity_<?php echo $blockNum; ?>" name="hiddencurrentMainCity[]" value="" />
<input type="hidden" id="hiddencurrentCity_<?php echo $blockNum; ?>" name="hiddencurrentCity[]" value="" />