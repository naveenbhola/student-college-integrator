...
<div style="width:430px;padding-left:25px;font-size:13px;">
    <?php if($page_type=='indianpage'):?><span>Study in India |</span><span><a onclick="disableLink(this)" href="<?php echo '/enterprise/MultipleMarketingPage/addRemoveMMPageCourses/'.$page_id.'/abroadpage'?>" id="abroadpage"> Study Abroad </a>|</span><span><a onclick="disableLink(this)" href="<?php echo '/enterprise/MultipleMarketingPage/addRemoveMMPageCourses/'.$page_id.'/testpreppage'?>" id="testpreppage"> Test Prep</a></span>
...
<table cellspacing="0" cellpadding="10" border="0" width="960">
	<tbody>
		<tr>
			...
			<div style="padding-top:10px;float:left;"><form action="/enterprise/MultipleMarketingPage/saveMMPageCourses/<?php echo $page_id?>/<?php echo $page_type?>" method="post">
            ...
            <?php if(is_array($saved_courses_list)  && count($saved_courses_list)>0) {?>
			...
			<span><?php echo "Page URL: "?></span><span style="font-size:12px;"><?php echo $page_url?></span></div>
			<div
