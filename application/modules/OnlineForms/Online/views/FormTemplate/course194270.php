...
?>
	...
	<div id="custom-form-header">
    	<div class="app-left-box">
			<div style="float:right;"> <?php if( $instituteSpecId!=''){?>
       
        <label>Form Id : </label>
                        <span>&nbsp;<?php echo $instituteSpecId; ?></span>
        <?php } ?></div>
			 <div class="clearFix spacer10"></div>
            <div class="inst-name" style="width:98%;margin-left:0px">
                <img src="/public/images/onlineforms/institutes/gnit/logo2.gif" alt="" style="float:left" />
				<div style="float:left; margin-left:70px">
				<h2 style="font-size:20px;">GNIOT COLLEGE OF MANAGEMENT</h2>
				<div style="text-align:left;margin-left:20px">
                   PLOT-6C KNOWLEDGE PARK-2  <br/> Greater Noida, Uttar Pradesh, India- 201306<br/>
                    Email: pgdm@gnit.net<br/>
                </div>
				</div>
            </div>
	...
	<div class="appForm-box" style="width:98%">
            PGDM Application Form : 2014-15
			</div>
        
        <div class="clearFix"></div>
            <div class="reviewTitleBox" style="margin-top:10px">
    	...
    	<div class="educationInfoSection">
			...
			<?php
		           $testsArray = explode(",",$GNIT_testNames);
			  ?>
			  <div class="reviewLeftCol"   style="width:900px !important">
				...
				<?php if(in_array("UPSEE",$testsArray)): ?>
				<ul class="reviewChildLeftCol"  style="width:400px !important;margin-bottom:30px">
					<li>
						<label style="width:150px !important">UPSEE Roll Number:</label>
						<span><?php if(in_array("UPSEE",$testsArray)): ?><?php echo $upseeRollNumberAdditional;?><?php endif; ?></span>
					</li>
					
					<li>
						<label style="width:150px !important">UPSEE Date:</label>
						<span><?php if(in_array("UPSEE",$testsArray)): ?><?php echo $upseeDateOfExaminationAdditional;?><?php endif; ?></span>
					</li>
					...
					<ul class="reviewChildLeftCol"  style="width:400px !important;margin-bottom:30px">
					<li>
						<label style="width:150px !important">UPSEE Score:</label>
						<span><?php if(in_array("UPSEE",$testsArray)): ?><?php echo $upseeScoreAdditional;?><?php endif; ?></span>
					</li>
					
					<li>
						<label style="width:150px !important">UPSEE Percentile:</label>
						<span><?php if(in_array("UPSEE",$testsArray)): ?><?php echo $upseePercentileAdditional;?><?php endif; ?></span>
					</li>
	...
	<div class="rolesResponsiblity">
        ...
        <div class="reviewLeftCol" id="responsibilityList"   style="width:922px !important">
     ...
     <li>
       <div class="rolesResponsiblity">
         ...
         <div id="responsibilityList">
                        <div> I hereby declare that I have read and understood all the rules and regulations of the Institute.I will fully
