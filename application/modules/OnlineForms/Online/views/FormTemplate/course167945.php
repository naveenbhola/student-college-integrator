...
?>
	...
	<div id="custom-form-header">
    	<div class="app-left-box">
            <div class="inst-name" style="width:87%;margin-left:0px">
                <img src="/public/images/onlineforms/institutes/shantibuinessshcool/logo2.gif" alt="SIVA SIVANI INSTITUTE OF MANAGEMENT" style="float:left" />
				<div style="float:right">
				<h2 style="font-size:20px;">SHANTI BUSINESS SCHOOL</h2>
				<div style="text-align:left;margin-left:20px">
		                    Opp. Vraj Garden, Off. S. P. Ring Road, Shela-380058 Ahmedabad
				</div>
				</div>
            </div>
	    ...
	    <?php if( $instituteSpecId!=''){?>
                                ...
                                Form Id: <?php echo 'S'.$instituteSpecId; ?>
                         </div>
                        <?php } ?>
	...
	<?php
		$testsArray = explode(",",$SHANTIBSCHOOL_testNames);
	?>
	<div class="familyInfoSection">
			<div class="reviewTitleBox">
				<strong>TESTS:</strong>
