...
?>
	...
	<div id="custom-form-header">
    	<div class="app-left-box">
            ...
            <div class="inst-name" style="width:80%;margin-left:0px">
                <img src="/public/images/onlineforms/institutes/jkbusiness/logo2_2015.gif" alt="/public/images/onlineforms/institutes/jkbusiness/logo2_2015.gif?>" style="float:left" />
		
				<div style="float:right">
				<h2 style="font-size:20px;">JK Business School</h2>
				<div style="text-align:center;margin-left:20px">
					JKBS Campus, Gurgaon Sohna Expressway,<br>
					Damdama Lake Road, Bhondsi,
					Gurgaon, Haryana-122102<br>
					Ph: 9958672673<br>
					E-Mail: admissions@jkbschool.org<br>
					Website: www.jkbschool.org<br>
				</div>
				</div>
            </div>
	...
	<?php
		$testsArray = explode(",",$testNamesJKBS);
		?>
			...
			<div class="reviewLeftCol"   style="width:900px !important">
				...
				<ul class="reviewChildLeftCol"  style="width:400px !important;">
					...
					<li>
						...
						<span><?php echo $cmatPercentileAdditionalJKBS;?></span>
					</li>
					<?php endif; ?>
				</ul>
	...
	<li>
				...
				<div class="spacer15 clearFix"></div>
				<div class="fieldBoxLarge" style="padding-left:33px; width:865px; font-size: 14px;font-style:italic;color:#666;">
