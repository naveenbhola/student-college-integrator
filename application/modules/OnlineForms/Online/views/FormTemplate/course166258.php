	...
	<div id="custom-form-header">
    	<div class="app-left-box">
            ...
            <div class="inst-name" style="width:87%;margin-left:0px">
                <img src="/public/images/onlineforms/institutes/vgbs/logo2.gif" alt="Vishwakarma Global Business School" style="float:left" />
				<div style="float:right">
				<h2 style="font-size:20px;">Vishwakarma Global Business School</h2>
				<div style="text-align:left;margin-left:20px">
					Sr. No. 3/6, Kondhwa (Bk), Pune: 411048. India<br/>
					Telephone: 020-64783754 / 20261157 <br/>
					Email: admission@vgbs.edu.in<br/>
					Website: www.vgbs.edu.in <br/>
				</div>
				</div>
            </div>
	    ...
	    <div class="applicationFormEditLink"><strong class="editFormLink" style="font-size:14px">(<a title="Edit form" href="/Online/OnlineForms/showOnlineForms/<?php echo $courseId; ?>/1/1">Edit form</a>)</strong></div>
			      <?php } ?>
	    <div class="clearFix spacer10"></div>
	    <div class="appForm-box" style="width:104%">Application Form for PGDM</div>
	...
	<div class="familyInfoSection">
			...
			<div class="reviewLeftCol"   style="width:900px !important">
				<ul class="reviewChildLeftCol"  style="width:400px !important;margin-bottom:30px">
					...
					<li>
						<label style="width:150px !important">CAT Date of Exam:</label>
			...
			<div class="reviewLeftCol"   style="width:900px !important">
				...
				<ul class="reviewChildLeftCol"  style="width:400px !important;margin-bottom:30px">
					...
					<li>
						<label style="width:150px !important">MAT Date of Exam:</label>
			...
			<div class="reviewLeftCol"   style="width:900px !important">
				...
				<ul class="reviewChildLeftCol"  style="width:400px !important;margin-bottom:30px">
					...
					<li>
						<label style="width:150px !important">XAT Date of Exam:</label>
			...
			<div class="reviewLeftCol"   style="width:900px !important">
				...
				<ul class="reviewChildLeftCol"  style="width:400px !important;margin-bottom:30px">
					<li>
						<label style="width:150px !important">ATMA Roll No:</label>
						<span><?php if(in_array("ATMA",$testsArray)): ?><?php echo $atmaRollNumberAdditional;?><?php endif; ?></span>
					</li>
					
					<li>
						<label style="width:150px !important">ATMA Date of Exam:</label>
			...
			<div class="reviewLeftCol"   style="width:900px !important">
				...
				<ul class="reviewChildLeftCol"  style="width:400px !important;margin-bottom:30px">
					...
					<li>
						<label style="width:150px !important">CMAT Date of Exam:</label>
				...
				<ul class="reviewChildLeftCol"  style="width:400px !important;margin-bottom:30px">
					<li>
						...
						<span><?php if(in_array("CMAT",$testsArray)): ?><?php echo $cmatPercentileAdditionalVGBS;?><?php endif; ?></span>
					</li>
