	  ...
	  <strong class="applicationFormEditLink">(<a title="Edit form" href="/Online/OnlineForms/showOnlineForms/<?php echo $courseId; ?>/1/1">Edit form</a>)</strong>
    	...
    	<div class="previewHeader">
            ...
            <div class="courseNameDetails">
	            <img src="/public/images/onlineforms/institutes/nimt/logo2.gif" alt="" />
	        <p>NIMT<br />APPLICATION FORM</p>
	    </div>
...
<?php if( $instituteSpecId!=''){?>
                                ...
                                Form Id: <?php echo 'NIMTSK'.$instituteSpecId; ?>
                         </div>
                        <?php } ?>
        ...
        <div class="contactInfoSection">
            ...
            <div class="reviewLeftCol">
                ...
                <?php //if($profile_data['CstreetName']):?>
                    ...
                    <?php //endif;
                    //if($profile_data['Cstate']):preferredGDPILocation
                    ?>
                    <li>
                        <label>State:</label>
     ...
     <?php $testNamesArray = explode(',',$testNamesNIMT);?>
             <div class="spacer25 clearFix"></div>
	     <div class="educationBlock">
	     <?php if($catDateOfExaminationAdditional && $catScoreAdditional && $catRollNumberAdditional && $catPercentileAdditional && in_array('CAT', $testNamesArray) ):?>
                	<div class="educationTitle educationTitleBg">
                ...
                <div class="clearFix"></div>
                <?php endif;?>
                <?php if($xatDateOfExaminationAdditional && $xatScoreAdditional && $xatRollNumberAdditional && $xatPercentileAdditional && in_array('XAT', $testNamesArray)  ):?>
                	<div class="educationTitle educationTitleBg">
                ...
                <div class="clearFix"></div>
                <?php endif;?>
                <?php if($cmatDateOfExaminationAdditional && $cmatScoreAdditional && $cmatRollNumberAdditional && $cmatRankAdditional && in_array('CMAT', $testNamesArray)  ):?>
                                	<div class="educationTitle educationTitleBg">
                    	<p class="educationCol widthAuto">CMAT Score Details</p>
                    </div>
                ...
                <div class="clearFix"></div>
				<?php endif;?>
				  <?php if($gmatDateOfExaminationAdditional && $gmatScoreAdditional && $gmatRollNumberAdditional && $gmatPercentileAdditional && in_array('GMAT', $testNamesArray) ):?>              
                    <div class="educationTitle educationTitleBg">
                    	<p class="educationCol widthAuto">GMAT Score Details</p>
                    </div>
...
border="1" bordercolor="#000000" class="educationTable">
                                     <tr>
                                         <?php
if(isset($preferredGDPILocation) && $preferredGDPILocation!=''){ ?>
                                         <td align="center"><?php
if($preferredGDPILocation=='87') echo "Ghaziabad"; else echo
"<strike>Ghaziabad</strike>";?></td>
                                         <td align="center"><?php
if($preferredGDPILocation=='74') echo "Delhi"; else echo
"<strike>Delhi</strike>";?></td>
                                         <td align="center"><?php
if($preferredGDPILocation=='161') echo "Noida"; else echo
"<strike>Noida</strike>";?></td>
                                         <td align="center"><?php
if($preferredGDPILocation=='151') echo "Mumbai"; else echo
"<strike>Mumbai</strike>";?></td>
                                         <td align="center"><?php
if($preferredGDPILocation=='278') echo "Bangalore"; else echo
"<strike>Bangalore</strike>";?></td>
                                         <td align="center"><?php
if($preferredGDPILocation=='64') echo "Chennai"; else echo
"<strike>Chennai</strike>";?></td>
                                         <td align="center"><?php
if($preferredGDPILocation=='702') echo "Hyderabad"; else echo
"<strike>Hyderabad</strike>";?></td>
                                         <td align="center"><?php
if($preferredGDPILocation=='130') echo "Kolkata"; else echo
"<strike>Kolkata</strike>";?></td>
                                         <td align="center"><?php
if($preferredGDPILocation=='174') echo "Pune"; else echo
"<strike>Pune</strike>";?></td>
                                         <td align="center"><?php
if($preferredGDPILocation=='63') echo "Chandigarh"; else echo
"<strike>Chandigarh</strike>";?></td>
                                         <td align="center"><?php
if($preferredGDPILocation=='109') echo "Jaipur"; else echo
"<strike>Jaipur</strike>";?></td>
                                         <td align="center"><?php
if($preferredGDPILocation=='172') echo "Pondicherry"; else echo
"<strike>Pondicherry</strike>";?></td>
                                         <td align="center"><?php
if($preferredGDPILocation=='30') echo "Ahmedabad"; else echo
"<strike>Ahmedabad</strike>";?></td>
                                         <td align="center"><?php
if($preferredGDPILocation=='89') echo "Goa"; else echo
"<strike>Goa</strike>";?></td>
                                         <?php }else{ ?>
                                         <td align="center">Ghaziabad</td>
                                         <td align="center">Delhi</td>
                                         <td align="center">Noida</td>
					...
					<td align="center">Pondicherry</td>
