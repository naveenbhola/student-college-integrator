	...
	<div id="custom-form-header">
    	<div class="app-left-box">
            ...
            <div class="inst-name" style="width:80%;margin-left:0px">
                <img src="/public/images/onlineforms/institutes/vignana/logo2.gif" alt="/public/images/onlineforms/institutes/vignana/logo2.gif?>" style="float:left" />
		
				<div style="float:right">
				<h2 style="font-size:20px;">Vignana Jyothi Institute of Management</h2>
				<div style="text-align:center;margin-left:20px">
					Bachupally, (Via) Kukatpally, <br>
					Hyderabad Telangana India - 500090<br>
					Ph: 9849800819<br>
					E-Mail: admissions@vjim.edu.in<br>
					Website: vjim.edu.in<br>
				</div>
				</div>
            </div>
			...
			<div class="reviewLeftCol"   style="width:900px !important">
				...
				<ul class="reviewChildLeftCol"  style="width:400px !important;">
					...
					<li>
						...
						<span><?php echo $cmatPercentileAdditionalVGBS;?></span>
					</li>
					<?php endif; ?>
				</ul>
