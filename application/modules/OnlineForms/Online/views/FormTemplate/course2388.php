...
?>
	...
	<div id="custom-form-header">
    	<div class="app-left-box">
			<div style="float:right">Application Ref. No. G<?=$instituteSpecId?></div>
			 <div class="clearFix spacer10"></div>
            <div class="inst-name" style="width:80%;margin-left:0px">
                <img src="/public/images/onlineforms/institutes/GSIB/logo2.gif" alt="/public/images/onlineforms/institutes/GSIB/logo2.gif?>" style="float:left" />
		
				<div style="float:right">
				<h2 style="font-size:13px;">GITAM School of International Business (GSIB)</h2>
				<div style="text-align:center;margin-left:20px">
					GITAM University, Gandhinagar Campus,<br>
					Rushikonda, Visakhapatnam -530045,<br>
					Andhra Pradesh, India.<br>
					Ph: 9490886714<br>
					E-Mail: admission@gsib.org<br>
					Website: www.gsib.org<br>
				</div>
				</div>
            </div>
	...
	<?php
		$testsArray = explode(",",$GSIB_testNames);
		?>
...
<ul class="reviewChildLeftCol"  style="width:400px !important;">
					<?php if(in_array("GET",$testsArray)): ?>
					<li>
						<label style="width:150px !important">GET Registration No:</label>
						<span><?php echo $getRollNumberAdditional;?></span>
					</li>
					
					<li>
						<label style="width:150px !important">GET Date:</label>
						<span><?php echo $getDateOfExaminationAdditional;?></span>
					</li>
					<?php endif; ?>
				</ul>
				...
				<ul class="reviewChildLeftCol"  style="width:400px !important;">
					<?php if(in_array("GET",$testsArray)): ?>
					<li>
						<label style="width:150px !important">GET Score:</label>
						<span><?php echo $getScoreAdditional;?></span>
					</li>
					
					<li>
						<label style="width:150px !important">GET Percentile:</label>
						<span><?php echo $getPercentileAdditional;?></span>
					</li>
					<?php endif; ?>
				</ul>
