	...
	<div id="custom-form-header">
    	<div class="app-left-box">
            ...
            <div class="inst-name" style="width:80%;margin-left:0px">
                <img src="/public/images/onlineforms/institutes/taxila/Taxila_Logo.jpg" alt="<?=$instituteInfo['institute_name']?>" style="float:left" />
				<div style="float:right">
				<h2 style="font-size:20px;"><?=$instituteInfo['institute_name']?></h2>
				<div style="text-align:left;margin-left:20px">
					Taxila Business School,<br>
                    Sector 9, Mandir Marg, Patel Marg, Mansarovar,<br>
                    Jaipur, Rajasthan (India) Pin Code: 302020<br>
					E-Mail: admission@taxila.in<br>
					Website: https://taxila.in/<br>
				</div>
				</div>
            </div>
    ...
    <?php endif;endfor;//endif;?>
        ...
        <li>
            <div class="colums-width">
                ...
                <div class="form-details"><?php echo $PG_StreamTAXILAMBA2019; ?></div>
            </div>
        </li>
        ...
        <li>
            <div class="colums-width">
                ...
                <div class="form-details"><?php echo $PG_College_UniversityTAXILAMBA2019; ?></div>
            </div>
        </li>
        ...
        <li>
            <div class="colums-width">
                <label>PG Year: </label>
                <div class="form-details"><?php echo $PG_YearTAXILAMBA2019; ?></div>
            </div>
        </li>
        ...
        <li>
            <div class="colums-width">
                ...
                <div class="form-details"><?php echo $PG_ResultTAXILAMBA2019; ?></div>
            </div>
        </li>
    
        <li style="width: 100%">
            <div class="colums-width" style="width: 100%">
                <label  style="width:100%;padding: 0 0 5px;text-align: left;">Statement Of Purpose </label>
                <div class="form-details" style="width: 100%"><?php echo $SOPTAXILAMBA2019; ?></div>
            </div>
        </li>
...
certificates on demand at any time. I also undertake that I shall abide by the rules and regulations of TBS - Taxila Business School Jaipur.
