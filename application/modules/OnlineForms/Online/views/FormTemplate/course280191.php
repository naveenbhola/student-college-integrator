    	...
    	<div class="app-left-box">
            ...
            <div class="inst-name">
				...
				<div style="text-align:left">
					Charoli Bk.via Lohegaon,<br>
					District Pune - 412 105, Maharashtra , India<br>
					Ph: 020 – 67077942 / 43<br>
					E-Mail: info@adypu.edu.in<br>
					Website: http://adypu.edu.in<br>
				</div>
				</div>
            </div>
    ...
    <ul>
        ...
        <li>
            <div class="colums-width">
                ...
                <div class="form-details"><?php echo $Aadhaar_NumberADYPUBTECH2019; ?></div>
            </div>
        </li>
        </ul>
        ...
        <li>
            <div class="colums-width">
                ...
                <div class="form-details"><?php echo $Father_Annual_IncomeADYPUBTECH2019; ?></div>
            </div>
        </li>
        ...
        <li>
            <div class="colums-width">
                ...
                <div class="form-details"><?php echo $Mother_Annual_IncomeADYPUBTECH2019; ?></div>
            </div>
        </li>
        </ul>

        <div class="reviewTitleBox">
                <strong>Graduation Information</strong>
        </div>  
        <ul class = "adjust_ul">
        <li>
            <div class="colums-width">
                <label>Graduation Percentage marks (Applicable only in case of CGPA/Grades): </label>
                <div class="form-details"><?php echo $Graduation_PercentageADYPUBTECH2019; ?></div>
            </div>
        </li>
        </ul>
       ...
       <div class="reviewTitleBox">
        ...
        <li>
            <div class="colums-width">
                <label>Course Applied For: </label>
                <div class="form-details"><?php echo $Course_AppliedADYPUBTECH2019; ?></div>
            </div>
        </li>
        </ul>
        ...
        <ul class = "adjust_ul full_listul">
        <li>
            <div class="colums-width">
                <label>Year: </label>
                <div class="form-details"><?php echo $Year_1ADYPUBTECH2019; ?></div>
            </div>
        </li>
        ...
        <li>
            <div class="colums-width">
                ...
                <div class="form-details"><?php echo $Award_Name_1ADYPUBTECH2019; ?></div>
            </div>
        </li>
        ...
        <li>
            <div class="colums-width">
                ...
                <div class="form-details"><?php echo $Awarding_Institution_1ADYPUBTECH2019; ?></div>
            </div>
        </li>
        ...
        <li>
            <div class="colums-width">
                ...
                <div class="form-details"><?php echo $Level_1ADYPUBTECH2019; ?></div>
            </div>
        </li>
        ...
        <li>
            <div class="colums-width">
                <label>Remarks: </label>
                <div class="form-details"><?php echo $Remarks_1ADYPUBTECH2019; ?></div>
            </div>
        </li>
        ...
        <li>
            <div class="colums-width">
                <label>Year: </label>
                <div class="form-details"><?php echo $Year_2ADYPUBTECH2019; ?></div>
            </div>
        </li>
        ...
        <li>
            <div class="colums-width">
                <label>Name of the Award: </label>
                <div class="form-details"><?php echo $Award_Name_2ADYPUBTECH2019; ?></div>
            </div>
        </li>
        ...
        <li>
            <div class="colums-width">
                <label>Awarding Institution: </label>
                <div class="form-details"><?php echo $Awarding_Institution_2ADYPUBTECH2019; ?></div>
            </div>
        </li>
        ...
        <li>
            <div class="colums-width">
                <label>Level (International, National, State): </label>
                <div class="form-details"><?php echo $Level_2ADYPUBTECH2019; ?></div>
            </div>
        </li>
        ...
        <li>
            <div class="colums-width">
                <label>Remarks: </label>
                <div class="form-details"><?php echo $Remarks_2ADYPUBTECH2019; ?></div>
            </div>
        </li>
    </ul>
        ...
        <li>
            <div class="colums-width">
                ...
                <div class="form-details"><?php echo $Study_at_ADYPUADYPUBTECH2019; ?></div>
            </div>
        </li>
        ...
        <li>
            <div class="colums-width">
                ...
                <div class="form-details"><?php echo $Know_about_ADYPUADYPUBTECH2019; ?></div>
            </div>
        </li>
    </ul>
        <div>
...
.lowerCase{ padding:6px 12px; overflow:hidden; margin-bottom:10px; clear:both; *height:0.01%}
.lowerCase strong{float:left; font-size:16px;}
.lowerCase a{float:right; margin-top:3px}
</style>
