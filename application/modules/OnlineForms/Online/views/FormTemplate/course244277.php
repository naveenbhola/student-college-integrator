    ...
    <ul>
        ...
        <li>
            <div class="colums-width">
                ...
                <div class="form-details"><?php echo $Aadhaar_NumberADYPUMBA2019; ?></div>
            </div>
        </li>
        </ul>
        ...
        <li>
            <div class="colums-width">
                ...
                <div class="form-details"><?php echo $Father_Annual_IncomeADYPUMBA2019; ?></div>
            </div>
        </li>
        ...
        <li>
            <div class="colums-width">
                ...
                <div class="form-details"><?php echo $Mother_Annual_IncomeADYPUMBA2019; ?></div>
            </div>
        </li>
        </ul>
        ...
        <li>
            <div class="colums-width">
                ...
                <div class="form-details"><?php echo $Graduation_PercentageADYPUMBA2019; ?></div>
            </div>
        </li>
        </ul>
       ...
       <div class="reviewTitleBox">
        ...
        <li>
            <div class="colums-width">
                <label>Course Applied For: </label>
                <div class="form-details"><?php echo $Course_AppliedADYPUMBA2019; ?></div>
            </div>
        </li>
        </ul>
        ...
        <li>
            <div class="colums-width">
                <label>Year: </label>
                <div class="form-details"><?php echo $Year_1ADYPUMBA2019; ?></div>
            </div>
        </li>
        ...
        <li>
            <div class="colums-width">
                ...
                <div class="form-details"><?php echo $Award_Name_1ADYPUMBA2019; ?></div>
            </div>
        </li>
        ...
        <li>
            <div class="colums-width">
                ...
                <div class="form-details"><?php echo $Awarding_Institution_1ADYPUMBA2019; ?></div>
            </div>
        </li>
        ...
        <li>
            <div class="colums-width">
                ...
                <div class="form-details"><?php echo $Level_1ADYPUMBA2019; ?></div>
            </div>
        </li>
        ...
        <li>
            <div class="colums-width">
                <label>Remarks: </label>
                <div class="form-details"><?php echo $Remarks_1ADYPUMBA2019; ?></div>
            </div>
        </li>
        ...
        <li>
            <div class="colums-width">
                <label>Year: </label>
                <div class="form-details"><?php echo $Year_2ADYPUMBA2019; ?></div>
            </div>
        </li>
        ...
        <li>
            <div class="colums-width">
                <label>Name of the Award: </label>
                <div class="form-details"><?php echo $Award_Name_2ADYPUMBA2019; ?></div>
            </div>
        </li>
        ...
        <li>
            <div class="colums-width">
                <label>Awarding Institution: </label>
                <div class="form-details"><?php echo $Awarding_Institution_2ADYPUMBA2019; ?></div>
            </div>
        </li>
        ...
        <li>
            <div class="colums-width">
                <label>Level (International, National, State): </label>
                <div class="form-details"><?php echo $Level_2ADYPUMBA2019; ?></div>
            </div>
        </li>
        ...
        <li>
            <div class="colums-width">
                <label>Remarks: </label>
                <div class="form-details"><?php echo $Remarks_2ADYPUMBA2019; ?></div>
            </div>
        </li>
    </ul>
        ...
        <li>
            <div class="colums-width">
                ...
                <div class="form-details"><?php echo $Study_at_ADYPUADYPUMBA2019; ?></div>
            </div>
        </li>
        ...
        <li>
            <div class="colums-width">
                ...
                <div class="form-details"><?php echo $Know_about_ADYPUADYPUMBA2019; ?></div>
            </div>
        </li>
    </ul>
        <div>
