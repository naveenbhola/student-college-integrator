<link href="/public/css/onlineforms/tjohn/TJOHN_styles.css" rel="stylesheet" type="text/css"/>
	  ...
	  <strong class="applicationFormEditLink">(<a title="Edit form" href="/Online/OnlineForms/showOnlineForms/<?php echo $courseId; ?>/1/1">Edit form</a>)</strong>
    	...
    	<div class="previewHeader">
            ...
            <div class="courseNameDetails">
	            <img src="/public/images/onlineforms/institutes/tjohn/logo2.jpg" alt="" />
	        <p>T. John Institute of Management and Science<br />APPLICATION FORM</p>
	    </div>
	...
	<div class="rolesResponsiblity" style="float:left; width:100%">
		<div class="reviewTitleBox"><strong>Course Preference:</strong></div>
		 <div class="course-box">
				    ...
				    <tr>
					<td style="font-size:16px" align="center">Tick (<img src="/public/images/onlineforms/institutes/tjohn/tick-icn.gif" alt="" />) the Name of the Course Applied</td>
				    </tr>
				    <tr>
					<td><span class='check-box'><?php if($coursePrefTJOHN0=='MBA') echo "<img src='/public/images/onlineforms/institutes/mitcom/tick-icn.gif' alt='' />";?></span>
							<span style="float:left; width:500px;padding-top: 4px;">
...
<div class="rolesResponsiblity">
	...
	<li>
				...
				<div style="padding-left:33px">
					I, Mr. /Ms. <?php echo (isset($middleName) && $middleName!='')?$firstName." ".$middleName." ".$lastName:$firstName." ".$lastName;?> have read the above rules and regulation of the T. John Institute of Management and Science.
