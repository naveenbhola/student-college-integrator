<link href="/public/css/onlineforms/manipal/Manipal_styles.css" rel="stylesheet" type="text/css"/>
	  ...
	  <strong class="applicationFormEditLink">(<a title="Edit form" href="/Online/OnlineForms/showOnlineForms/<?php echo $courseId; ?>/1/1">Edit form</a>)</strong>
    	...
    	<div class="previewHeader">
            ...
            <div class="courseNameDetails">
	            <img src="/public/images/onlineforms/institutes/manipal/logo2.jpg" alt="" />
	        <p>Manipal University<br />APPLICATION FORM <?php if($instituteInfo[0]['instituteInfo'][0]['sessionYear']){ echo $instituteInfo[0]['instituteInfo'][0]['sessionYear'];} else{echo "2012";}?></p>
	    </div>
        ...
        <div id="responsibilityList">
            <table width="40%" cellpadding="7" cellspacing="0" border="1" bordercolor="#000000" class="educationTable">
                                    <tr>
                                        ...
                                        <td align="center"><?php if($preferredGDPILocation=='261') echo "Manipal"; else echo "<strike>Manipal</strike>";?></td>
                                        <td align="center"><?php if($preferredGDPILocation=='278') echo "Banglore"; else echo "<strike>Banglore</strike>";?></td>
                                        <?php }else{ ?>
                                        <td align="center">Manipal</td>
