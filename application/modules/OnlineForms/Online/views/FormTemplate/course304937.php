...
?>
    ...
    <ul class="adjust_ul">
        ...
        <li>
            <div class="colums-width">
                <label>Program: </label>
                <div class="form-details"><?php echo $StreamProgramMap[$NIIT_programme]; ?></div>
            </div>
        </li>
        ...
        <li>
            <div class="colums-width">
                <label>Stream: </label>
                <div class="form-details"><?php echo $StreamProgramMap[$NIIT_stream]; ?></div>
            </div>
        </li>
     ...
     <ul class="adjust_ul">
        <li>
            <div class="colums-width">
                ...
                <div class="form-details"><?php echo $NIIT_10Marks; ?></div>
            </div>
        </li>
          <li>
            <div class="colums-width">
                <label>10th Marks (Total): </label>
                <div class="form-details"><?php echo $NIIT_10MarksTotal; ?></div>
            </div>
        </li>
        ...
        <li>
            <div class="colums-width">
                ...
                <div class="form-details"><?php echo $NIIT_12Marks; ?></div>
            </div>
        </li>
        <li>
            <div class="colums-width">
                <label>12th Marks (Total): </label>
                <div class="form-details"><?php echo $NIIT_12MarksTotal; ?></div>
            </div>
        </li>
    
     <li>
            <div class="colums-width">
                <label>PCM/PCB Marks: </label>
                <div class="form-details"><?php echo $NIIT_PCMBMarks; ?></div>
            </div>
        </li>
    
        <li>
            <div class="colums-width">
                <label>PCM/PCB Marks (Total): </label>
                <div class="form-details"><?php echo $NIIT_PCMBMarksTotal; ?></div>
            </div>
        </li>
    ...
    <ul class="adjust_ul">
        <li>
            <div class="colums-width">
                <label>Address: </label>
                <div class="form-details"><?php echo $NIIT_12SchoolAddress; ?></div>
            </div>
        </li>
        ...
        <li>
            <div class="colums-width">
                <label>Branch: </label>
                <div class="form-details"><?php echo $NIIT_12branch; ?></div>
            </div>
        </li>
        <li>
            <div class="colums-width">
                <label>School code: </label>
                <div class="form-details"><?php echo $NIIT_schoolCode; ?></div>
            </div>
        </li>
