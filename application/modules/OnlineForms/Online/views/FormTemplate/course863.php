<link href="/public/css/onlineforms/kohinoor/KOHINOOR_styles.css" rel="stylesheet" type="text/css"/>
	  ...
	  <strong class="applicationFormEditLink">(<a title="Edit form" href="/Online/OnlineForms/showOnlineForms/<?php echo $courseId; ?>/1/1">Edit form</a>)</strong>
    	...
    	<div class="previewHeader">
            ...
            <div class="courseNameDetails">
	            <img src="/public/images/onlineforms/institutes/kohinoor/logo2.jpg" alt="" />
	        <p>Kohinoor Buisness School Khandala<br />APPLICATION FORM</p>
	    </div>
	...
	<div class="rolesResponsiblity">
        ...
        <div id="responsibilityList">
            <table width="100%" cellpadding="7" cellspacing="0" border="1" bordercolor="#000000" class="educationTable">
				    <tr>
                                        <td align="center" style="font-weight:bold;font-size:14px;">First Preference</td>
					<td align="center" style="font-weight:bold;font-size:14px;">Second Preference</td>
                                    </tr>
                                    <tr>
                                        <td align="center"><?=$pref1Kohinoor;?></td>
					<td align="center"><?=$pref2Kohinoor;?></td>
                                    </tr>
                                </table>
        </div>
