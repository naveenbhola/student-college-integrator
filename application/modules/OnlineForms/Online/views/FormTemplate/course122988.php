...
?>
	...
	<div id="custom-form-header">
    	<div class="app-left-box">
            ...
            <div class="inst-name" style="width:88%;margin-left:0px">
                <img src="/public/images/onlineforms/institutes/bulmim/logo2.gif" alt="Usha & Lakshmi Mittal Institute of Management" style="float:left" />
				<div style="float:right">
				<h2 style="font-size:20px;">Usha & Lakshmi Mittal Institute of Management</h2>
				<div style="text-align:left;margin-left:20px">
					Copernicus Lane, K. G. Marg, New Delhi - 110001<br/>					
					Phone +91-11-23073852
					<br/>Fax +91-11-23387903
					<br/>Web: www.bulmim.ac.in
				</div>
				</div>
            </div>
	...
	<div class="appForm-box" style="width:98%">
				2-Year Full Time Post Graduate Diploma in Management (PGDM)
			</div>
	...
	<?php
		$testsArray = explode(",",$BULMIM_testNames);
	?>
	<div class="familyInfoSection">
			<div class="reviewTitleBox">
			...
			<div class="reviewLeftCol"   style="width:900px !important">
				...
				<ul class="reviewChildLeftCol"  style="width:400px !important;margin-bottom:30px">
					...
					<li>
						...
						<span><?php if(in_array("CMAT",$testsArray)): ?><?php echo $cmatPercentileBULMIM;?><?php endif; ?></span>
					</li>
