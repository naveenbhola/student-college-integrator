	  ...
	  <strong class="applicationFormEditLink">(<a title="Edit form" href="/Online/OnlineForms/showOnlineForms/<?php echo $courseId; ?>/1/1">Edit form</a>)</strong>
    	...
    	<div class="previewHeader">
            ...
            <div class="courseNameDetails">
	            <img src="/public/images/onlineforms/institutes/jgiidea/logo2.jpg" alt="" />
	        <p>JGI iDEA<br />APPLICATION FORM</p>
	    </div>
	...
	<div class="rolesResponsiblity" style="float:left; width:100%">
		<div class="reviewTitleBox"><strong>Course Preference:</strong></div>
		 <div class="course-box">
				    ...
				    <tr>
					<td style="font-size:16px" align="center">Tick (<img src="/public/images/onlineforms/institutes/jgiidea/tick-icn.gif" alt="" />) the Name of the Course Applied</td>
				    </tr>
				    <tr>
					<td><span class='check-box'><?php if($coursePrefJGIiDEA0=='MBA') echo "<img src='/public/images/onlineforms/institutes/jgiidea/tick-icn.gif' alt='' />";?></span>
							<span style="float:left; width:500px;padding-top: 4px;">
											MBA + PGP in Entrepreneurship
							</span>
					</td>
				   </tr>
...
<div class="rolesResponsiblity">
	...
	<li>
				...
				<div style="padding-left:33px">
					I, Mr. /Ms. <?php echo (isset($middleName) && $middleName!='')?$firstName." ".$middleName." ".$lastName:$firstName." ".$lastName;?> have read the above rules and regulation of the JGI iDEA.
