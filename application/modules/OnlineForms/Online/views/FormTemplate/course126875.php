<link href="/public/css/onlineforms/nba/NBA_styles.css" rel="stylesheet" type="text/css"/>
	  ...
	  <strong class="applicationFormEditLink">(<a title="Edit form" href="/Online/OnlineForms/showOnlineForms/<?php echo $courseId; ?>/1/1">Edit form</a>)</strong>
    	...
    	<div class="previewHeader">
            ...
            <div class="courseNameDetails">
	            <img src="/public/images/onlineforms/institutes/nba/logo.jpg" alt="" />
	        <p>NBA School Of Business New Delhi<br />APPLICATION FORM</p>
	    </div>
	   ...
	   <?php
	     ...
	     function createExamBlock($examType,$profile_data,$showRank='false'){
		    $dateVal = $examType.'DateOfExaminationAdditional';
		    $scoreVal = $examType.'ScoreAdditional';
		    $percentileVal = $examType.'PercentileAdditional';
		    $rankVal = $examType.'Rank';
		    $rollNumberVal = $examType.'RollNumberAdditional';
	    ...
	    <?php createExamBlock('xat',$profile_data); ?>
