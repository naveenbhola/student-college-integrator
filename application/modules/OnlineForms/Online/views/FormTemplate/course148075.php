...
?>
	...
	<div id="custom-form-header">
    	<div class="app-left-box">
            ...
            <div class="inst-name" style="width:80%;margin-left:0px">
                <img src="/public/images/onlineforms/institutes/asbm/logo2.jpg" alt="<?=$instituteInfo['institute_name']?>" style="float:left" />
				<div style="float:right">
				<h2 style="font-size:20px;">Asian School of Business Management</h2>
				<div style="text-align:left;margin-left:20px">
					Address: ASBM, Corporate Office, 8, Sai Anandam Complex,<br> Patia Square, Bhubaneswar, Odisha, Pin - 751024<br>
					Ph: 033-2420 5200 / 5216, Fax: 2282 6350<br>
					E-Mail: admission@asbm.ac.in<br>
					Website: www.asbm.ac.in<br>
				</div>
				</div>
            </div>
	...
	<div class="appForm-box">Application Form: 2015-2017</div> 
            ...
            <div class="reviewLeftCol">
                ...
                <?php //if($profile_data['gender']):?>
                    ...
                    <li>
                        ...
                        <span>Post Graduate Diploma in Management (PGDM)</span>
                    </li>
	...
	<li>
                        ...
                        <div class="spacer15 clearFix"></div>
                        <div style="padding-left:33px">I declare that the information furnished in this application are true to the best of my knowledge and belief and I understand that my application may be rejected and admission cancelled if any information provided herein is found to be incorrect at any time.
