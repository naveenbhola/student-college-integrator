<link href="/public/css/onlineforms/cmr/CMR_styles.css" rel="stylesheet" type="text/css"/>
	  ...
	  <strong class="applicationFormEditLink">(<a title="Edit form" href="/Online/OnlineForms/showOnlineForms/<?php echo $courseId; ?>/1/1">Edit form</a>)</strong>
    	...
    	<div class="previewHeader">
            ...
            <div class="courseNameDetails">
	            <img src="/public/images/onlineforms/institutes/cmr/logo2New.jpg" alt="" />
	        <p>CMR GROUP OF INSTITUTIONS<br />APPLICATION FORM</p>
	    </div>
		...
		<div class="reviewTitleBox"><strong>Course Preference:</strong></div>
		 <div class="course-box">
                    	<table width="100%" cellpadding="6" cellspacing="0" border="1" bordercolor="#000000" class="educationTable">
                            <tr>
                                <td style="font-size:16px" colspan="3" align="center">Tick (<img src="/public/images/onlineforms/institutes/cmr/tick-icn.gif" alt="" />) the Name of the Course Applied</td>
                            </tr>
                            <tr>
                                <td><span class='check-box'><?php if($coursePrefCMR3=='PGDM - CMR CENTER FOR BUISNESS STUDIES') echo "<img src='/public/images/onlineforms/institutes/cmr/tick-icn.gif' alt='' />";?></span>
                                                <span style="float:left; width:220px">
                                                                                MBA(BU)* - CMR CENTER FOR BUSINESS STUDIES
                                                                                                </span>
                                                                                                                                </td>

                                <td><span class='check-box'><?php if($coursePrefCMR1=='PGDM - CMR INSTITUTE OF MANAGEMENT STUDIES (AUTONOMOUS)') echo "<img src='/public/images/onlineforms/institutes/cmr/tick-icn.gif' alt='' />";?></span>
                                                <span style="float:left; width:260px">
                                                                                MBA(BU)* - CMR INSTITUTE OF MANAGEMENT STUDIES (AUTONOMOUS)</span>
                                                                                                                </td>

                <td><span class='check-box'><?php if($coursePrefCMR2=='PGDM - CMR INSTITUTE OF TECHNOLOGY') echo "<img src='/public/images/onlineforms/institutes/cmr/tick-icn.gif' alt='' />";?></span>
                                <span style="float:left; width:260px">
                                                                MBA(VTU)** - CMR INSTITUTE OF TECHNOLOGY</span>
                                                                                                </td>
                           </tr>
                           <tr>

                            	<td><span class='check-box'><?php if($coursePrefCMR0=='PGDM - CMR INSTITUTE OF MANAGEMENT AND TECHNOLOGY') echo "<img src='/public/images/onlineforms/institutes/cmr/tick-icn.gif' alt='' />";?></span>
				<span style="float:left; width:220px">
                                PGDM - CMR INSTITUTE OF MANAGEMENT AND TECHNOLOGY</span>
                                </td>

                <td><span class='check-box'><?php if($coursePrefCMR4=='PGDM - CMRS BANGALORE SCHOOL OF BUISNESS') echo "<img src='/public/images/onlineforms/institutes/cmr/tick-icn.gif' alt='' />";?></span>
                                <span style="float:left; width:260px">
                                                                PGDM - CMR BANGALORE SCHOOL OF BUSINESS</span>
                                                                                                </td>
	...
	<div class="rolesResponsiblity">
        ...
        <div id="responsibilityList">
            <table width="25%" cellpadding="7" cellspacing="0" border="1" bordercolor="#000000" class="educationTable">
                                    <tr>
					<?php  if(isset($preferredGDPILocation) && $preferredGDPILocation!=''){ ?>
                                        <td align="center"><?php if($preferredGDPILocation=='278') echo "Bangalore"; else echo "<strike>Bangalore</strike>";?></td>
					<?php }else{ ?>
