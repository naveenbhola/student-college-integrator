<link href="/public/css/onlineforms/icbm/ICBM_styles.css" rel="stylesheet" type="text/css"/>
	  ...
	  <strong class="applicationFormEditLink">(<a title="Edit form" href="/Online/OnlineForms/showOnlineForms/<?php echo $courseId; ?>/1/1">Edit form</a>)</strong>
    	...
    	<div class="previewHeader">
            ...
            <div class="courseNameDetails">
	            <img src="/public/images/onlineforms/institutes/icbm/logo2.jpg" alt="" />
	        <p>ICBM - School of Business Excellence<br />APPLICATION FORM</p>
	    </div>
	...
	<div class="rolesResponsiblity">
        ...
        <div id="responsibilityList">
            <table width="100%" cellpadding="7" cellspacing="0" >
				     <tr>
                                <td><span class='check-box'><?php if($coursePrefICBM0=='MBA') echo "<img src='/public/images/onlineforms/institutes/cmr/tick-icn.gif' alt='' />";?></span>
				<span style="float:left; width:324px">
                               Post Graduate Diploma in Business Management (PGDM)</span>
                                </td>
	...
	<li>
                        ...
                        <div style="padding-left:33px">
                        	I confirm that I have read the Prospectus for the PGDM program. I am registering for the programe and understand the terms and
