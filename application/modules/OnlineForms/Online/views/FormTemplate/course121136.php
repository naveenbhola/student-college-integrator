...
?>
	...
	<div id="custom-form-header">
		...
		<div style="float:right;">Application Ref. No. <?=$instituteInfo['sessionYear']?>/<?=$instituteInfo['courseTitle']?>/S<?=$instituteSpecId?></div>
		 <div class="inst-name" style="width:97%;">
			...
			<div class="float_L"><img src="/public/images/onlineforms/institutes/IBA_2015/logo2.gif" alt="" /></div>
			
			<div>
				<p style="font-size:17px;line-height:18px;">
				<b style="font-size: 19px;">Indus Business Academy,</b>
					<br/>Plot No. 44, Knowledge Park III,
					<br/>Greater Noida - 201308 (U.P).
					<br/>Ph: +91-120-2334000, E-Mail: admin@ibagreaternoida.org
					<br/>Website: www.iba.edu.in
			</div>			
		</div>
	...
	<?php
		$testsArray = explode(",",$IBA_testNames);
		//_p($testsArray);die;
	?>
	<div class="familyInfoSection">
			<div class="reviewTitleBox">
			...
			<div>
				...
				<ul class="reviewChildRightCol" >
					...
					<li>
						...
						<span><?php echo $cmatPercentileIBA;?></span>
					</li>
					<?php endif; ?>
				</ul>
			</div>
