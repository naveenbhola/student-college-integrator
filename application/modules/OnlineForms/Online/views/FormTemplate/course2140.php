<link href="/public/css/onlineforms/niilm/NIILM_styles.css" rel="stylesheet" type="text/css"/>
	  ...
	  <strong class="applicationFormEditLink">(<a title="Edit form" href="/Online/OnlineForms/showOnlineForms/<?php echo $courseId; ?>/1/1">Edit form</a>)</strong>
    	...
    	<div class="previewHeader">
            ...
            <div class="courseNameDetails">
	            <img src="/public/images/onlineforms/institutes/niilm/logo2.jpg" alt="" />
	        <p>NIILM Greater Noida<br />APPLICATION FORM</p>
	    </div>
        ...
        <?php
        $testsArray = explode(",",$NIILM_testNames);
        ?>
	<div class="reviewTitleBox">
	...
	<ul class="reviewChildRightCol">
           <li> 
            	<div class="colums-width">
                    ...
                    <div class="form-details"><?php if(in_array("CMAT",$testsArray)): ?><?php echo $cmatPercentileNIILM;?><?php endif; ?></div>
                </div>
            </li>
	</ul>
	</div>
