...
?>
    ...
    <div id="custom-form-header">
        <div class="app-left-box">
            ...
            <div class="inst-name" style="width:80%;margin-left:0px">
                <img src="/public/images/onlineforms/institutes/aimit/logo2.gif" alt="/public/images/onlineforms/institutes/aimit/logo2.gif?>" style="float:left" />
        
                <div style="float:right">
                <h2 style="font-size:18px;">St Aloysius Institute of Management and <br> Information Technology (AIMIT)</h2>
                <div style="text-align:center;margin-left:-20px">
                    St Aloysus College, <br> Kotekar, Beeri,<br> Mangalore - 575022<br>
                    Ph: 9902695552<br>
                    E-Mail: admissions@staloysius.ac.in / fr.denzil@staloysius.ac.in <br>
                    Website: www.staloysius.ac.in/<br>
                </div>
                </div>
            </div>
    ...
    <?php
        $testsArray = explode(",",$AIMIT_testNames);
        ?>
        ...
        <div class="familyInfoSection">
            ...
            <div class="reviewLeftCol"   style="width:900px !important">
                ...
                <ul class="reviewChildLeftCol"  style="width:400px !important;">
                    <?php if(in_array("PGCET",$testsArray)): ?>
                    <li>
                        <label style="width:150px !important">PGCET Registration No:</label>
                        <span><?php echo $pgcetRollNumberAdditional;?></span>
                    </li>
                    
                    <li>
                        <label style="width:150px !important">PGCET Date:</label>
                        <span><?php echo $pgcetDateOfExaminationAdditional;?></span>
                    </li>
                    <?php endif; ?>
                </ul>
                ...
                <ul class="reviewChildLeftCol"  style="width:400px !important;">
                    <?php if(in_array("PGCET",$testsArray)): ?>
                    <li>
                        <label style="width:150px !important">PGCET Score:</label>
                        <span><?php echo $pgcetScoreAdditional;?></span>
                    </li>
                    
                    <li>
                        <label style="width:150px !important">PGCET Percentile:</label>
                        <span><?php echo $pgcetPercentileAdditional;?></span>
                    </li>
                    <?php endif; ?>
                </ul>
                
            <ul class="reviewChildLeftCol"  style="width:400px !important;">
                    <?php if(in_array("KMAT",$testsArray)): ?>
                    <li>
                        <label style="width:150px !important">KMAT Registration No:</label>
                        <span><?php echo $kmatRollNumberAdditional;?></span>
                    </li>
                    
                    <li>
                        <label style="width:150px !important">KMAT Date:</label>
                        <span><?php echo $kmatDateOfExaminationAdditional;?></span>
                    </li>
                    <?php endif; ?>
                </ul>
                ...
                <ul class="reviewChildLeftCol"  style="width:400px !important;">
                    <?php if(in_array("KMAT",$testsArray)): ?>
                    <li>
                        <label style="width:150px !important">KMAT Score:</label>
                        <span><?php echo $kmatScoreAdditional;?></span>
                    </li>
                    
                    <li>
                        <label style="width:150px !important">KMAT Percentile:</label>
                        <span><?php echo $kmatPercentileAdditional;?></span>
                    </li>
                    <?php endif; ?>
                </ul>
            </div>
