<link href="/public/css/onlineforms/sage/SAGE_styles.css" rel="stylesheet" type="text/css"/>
	  ...
	  <strong class="applicationFormEditLink">(<a title="Edit form" href="/Online/OnlineForms/showOnlineForms/<?php echo $courseId; ?>/1/1">Edit form</a>)</strong>
    	...
    	<div class="previewHeader">
            ...
            <div class="courseNameDetails">
	            <img src="/public/images/onlineforms/institutes/sage/logo2.jpg" alt="" />
	        <p>SAGE Bangalore<br />APPLICATION FORM</p>
	    </div>
	...
	<div class="rolesResponsiblity">
        ...
        <div id="responsibilityList">
            <table width="30%" cellpadding="7" cellspacing="0" border="1" bordercolor="#000000" class="educationTable">
                                    <tr>
