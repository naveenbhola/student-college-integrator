    	...
    	<?php if(!isset($_REQUEST['viewForm']) && !$sample) { ?><div class="previewTetx">This is how your form will be viewed by the institute</div><?php } ?>
            ...
            <div id="custom-form-header">
                <div class="app-left-box">
                    ...
                    <div class="inst-name" style="width:97%;margin-left:0px">
                        <img src="/public/images/onlineforms/institutes/mitcon/logo2.gif" alt="MITCON Institute of Management" style="float:left" />
                        <div style="float:right">
                            <h2 style="font-size:20px;">MITCON Institute of Management</h2>
                            <div style="text-align:center;margin-left:20px">
                                33/1, Opp. Chhatrapati Shivaji Sports Complex, Balewadi, Pune - 411 045<br/>
                                Tel: 020-66289600 Fax: 020-66289601 Admission Cell: 88888 44011/12/13/14/15/16/17<br/>
                                E-mail: admissions@mima.edu.in &nbsp;&nbsp; Website: www.mima.edu.in
                            </div>
                        </div>
                    </div>
	...
	<div class="appForm-box" style="width:98%">
        Academic Year : 2013 - 2014
            ...
            <ul class="reviewChildLeftCol">
                <li>
                    <label style="font-weight: bold;font-size:13px;">Course:</label>
                    <span style="width:300px;font-size:13px;""><?php echo $MITCONcourse;?></span>
                </li>
            </ul>
...
<?php
$testsArray = explode(",",$MITCONTestNames);
?>
<div class="familyInfoSection">
    <div class="reviewTitleBox">
    ...
    <div class="reviewLeftCol"   style="width:900px !important">
        ...
        <ul class="reviewChildLeftCol"  style="width:400px !important;margin-bottom:30px">
            ...
            <li>
                ...
                <span><?php if(in_array("CMAT",$testsArray)): ?><?php echo $cmatPercentileMITCON;?><?php endif; ?></span>
            </li>
    ...
    <div class="reviewLeftCol">
        <ul class="reviewChildLeftCol" style="width:700px;">
            <li>
                <label>Blood Group:</label>
                <span><?php echo $MITCONBloodgroup;?></span>
            </li>
        </ul>
    </div>
    ...
    <div class="reviewLeftCol">
        <ul class="reviewChildLeftCol" style="width:700px;">
            <li>
                <label style="width:260px;">Emergency Contact No. (with STD code):</label>
                <span><?php echo $MITCONEmergencyNumber;?></span>
            </li>
        </ul>
    </div>
    ...
    <div class="reviewLeftCol">
        <ul class="reviewChildLeftCol">
            <li>
                ...
                <span><?php echo $MITCONPassport;?></span>
            </li>
        </ul>
    </div>
    ...
    <div class="reviewLeftCol">
        <ul class="reviewChildLeftCol">
            <li>
                <label>PAN No.:</label>
                <span><?php echo $MITCONPanNumber;?></span>
            </li>
        </ul>
    </div>
    ...
    <div class="reviewLeftCol">
        <ul class="reviewChildLeftCol">
            <li>
                ...
                <span><?php echo $MITCONPassingExam;?></span>
            </li>
        </ul>
    </div>

    <div class="reviewLeftCol" style="font-size: 13px;">
        <ul class="reviewChildLeftCol" style="width:700px;">
            <li>
                <label style="width:183px;">Preferred Mode of Payment:</label>
                <span><?php echo $MITCONModeOfPayment;?></span>
            </li>
        </ul>
    </div>
    ...
    <div class="reviewLeftCol" style="font-size: 13px;">
        <ul class="reviewChildLeftCol" style="width:700px;">
            <li>
                <label style="width:209px;">Whether Hostel facility required:</label>
                <span><?php echo $MITCONHostelRequired;?></span>
            </li>
        </ul>
    </div>
    ...
    <div class="reviewLeftCol" style="font-size: 13px;">
        <ul class="reviewChildLeftCol" style="width:700px;">
            <li>
                ...
                <span style="width:300px;"><?php echo $MITCONComputer;?></span>
            </li>
        </ul>
    </div>

    <div class="reviewLeftCol" style="font-size: 13px;">
        <ul class="reviewChildLeftCol" style="width:870px;">
            <li>
                <label style="width:223px;">Sports / Extra Curricular Activities:</label>
                <span style="width: 616px;"><?php echo $MITCONExtraCurricular;?></span>
            </li>
        </ul>
    </div>
    ...
    <div class="reviewLeftCol" style="font-size: 13px;">
        <ul class="reviewChildLeftCol" style="width:700px;">
            <li>
                <label style="width:338px;">From where did you come to know about MITCON? :</label>
                <span><?php echo $MITCONSourceOfInformation;?></span>
            </li>
        </ul>
    </div>
...
<div class="familyInfoSection">
    ...
    <div class="familyInfoSection">
        <div class="reviewTitleBox">
            <strong>GD/PI Date:</strong>
        </div>
        <div id="responsibilityList">
            <ul>
                <li><?=$MITCONGDPIDate?></li>
            </ul>
        </div>
    </div>
