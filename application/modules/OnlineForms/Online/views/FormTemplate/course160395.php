...
?>
	...
	<div id="custom-form-header">
    	<div class="app-left-box">
            ...
            <div class="inst-name" style="width:80%;margin-left:0px">
                <img src="/public/images/onlineforms/institutes/AIMSPune/logo2.gif" alt="/public/images/onlineforms/institutes/AIMSPune/logo2.gif?>" style="float:left" />
		
				<div style="float:right">
				<h2 style="font-size:21px;">Aims Institute of Management Studies</h2>
				<div style="text-align:center;margin-left:20px">
					Sr. No. 30/3/1. 30/4/A, 30/4/B, Buchade Wasti, Marunji,<br>
					Tal. Mulshi, Near Akshara International School<br>
					Pune-411057, Maharashtra, India.<br>
					Ph: 7722003777<br>
					E-Mail: admission@aimsinstitute.in, <br> aimsadmissions2015@gmail.com<br>
					Website: www.aimsinstitute.in<br>
				</div>
				</div>
            </div>
            ...
            <div class="reviewLeftCol">
                ...
                <?php //if($profile_data['gender']):?>
                    ...
                    <li>
                        ...
                        <span>MBA-AEEP (Advanced Employability Enhancement Program) </span>
                    </li>
	...
	<?php
		$testsArray = explode(",",$AIMSPune_testNames);
		?>
