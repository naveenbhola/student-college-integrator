...
?>
	...
	<div id="custom-form-header">
    	<div class="app-left-box">
            ...
            <div class="inst-name" style="width:80%;margin-left:0px">
                <img src="/public/images/onlineforms/institutes/ubs/logo2.jpg" alt="Universal Business School" style="float:left" />
				<div style="float:right">
				<h2 style="font-size:20px;">Universal Business School</h2>
				<div style="text-align:left;margin-left:20px">
					105, Runwal & Omkar Esquare,<br/>
					Eastern Express Highway,<br/>
					Sion East, Sion,<br/>
					Mumbai, Maharashtra, India<br/>
					Email: info@ubs.org.in<br/>
					Website: www.ubs.org.in<br/>
				</div>
				</div>
            </div>
	...
	<div class="appForm-box" style="width:98%">
				Application Form 2013 - 2014 Batch
			</div>
	...
	<?php
		$testsArray = explode(",",$UBS_testNames);
	?>
	<div class="familyInfoSection">
			<div class="reviewTitleBox">
				<strong>RECENT COMPETITIVE EXAMINATION(S) RESULT:</strong>
			</div>
