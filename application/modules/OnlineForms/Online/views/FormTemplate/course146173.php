...
?>
	...
	<div id="custom-form-header">
    	<div class="app-left-box">
			<div style="float:right">Application Ref. No. <?=$instituteSpecId?>/ 2 0 1 4</div>
			 <div class="clearFix spacer10"></div>
            <div class="inst-name" style="width:80%;margin-left:0px">
                <img src="/public/images/onlineforms/institutes/myra/logo2.jpg" alt="MYRA School of Business," style="float:left" />
				<div style="float:right">
				<h2 style="font-size:20px;">MYRA School of Business,</h2>
				<div style="text-align:left;margin-left:20px"><center>
					Near Infosys, Opp. Power Grid,<br>
					Yelwal, Mysore - 571130<br>
					Website: www.myra.ac.in<br></center>
				</div>
				</div>
            </div>
	...
	<div class="appForm-box" style="width:98%">
				APPLICATION FORM FOR ADMISSION IN 2014 BATCH
			</div>
            ...
            <div class="reviewLeftCol">
                ...
                <?php //if($profile_data['gender']):?>
                    ...
                    <li>
                        ...
                        <span><?php echo $Myra_course; ?></span>
                    </li>
	...
	<div class="rolesResponsiblity">
        ...
        <div class="reviewLeftCol"   style="width:900px !important">
				<ul class="reviewChildLeftCol"  style="width:400px !important;margin-bottom:10px">
					<li>
						<label style="width:150px !important">Preference 1 :</label>
						<span><?php echo $gdpiLocation;?></span>
					</li>
				</ul>
				<ul class="reviewChildLeftCol"  style="width:400px !important;margin-bottom:10px">
					<li>
						<label style="width:150px !important">Preference 2 :</label>
						<span><?php echo $Myra_GDPI2;?></span>
					</li>
				</ul>
				<ul class="reviewChildLeftCol"  style="width:400px !important;margin-bottom:10px">
					<li>
						<label style="width:150px !important">Preference 3 :</label>
						<span><?php echo $Myra_GDPI3;?></span>
					</li>
				</ul>
		</div>
	</div>
	<?php
		$testsArray = explode(",",$Myra_testNames);
	?>
	<div class="familyInfoSection">
			<div class="reviewTitleBox">
				<strong>TESTS:</strong>
			...
			<div class="reviewLeftCol"   style="width:900px !important">
				...
				<ul class="reviewChildLeftCol"  style="width:400px !important;margin-bottom:30px">
					...
					<li>
						...
						<span><?php if(in_array("CAT",$testsArray)): ?><?php echo $catScoreAdditional;?><?php endif; ?></span>
                                ...
                                <ul class="reviewChildRightCol"  style="width:400px !important;margin-bottom:30px">
                                   <li>
				...
				<ul class="reviewChildRightCol"  style="width:400px !important;margin-bottom:30px">
					<li>
						<label style="width:150px !important">GRE Registration No:</label>
						<span><?php if(in_array("GRE",$testsArray)): ?><?php echo $Myra_GRE_regNo;?><?php endif; ?></span>
					</li>
					
					<li>
						<label style="width:150px !important">GRE Score:</label>
						<span><?php if(in_array("GRE",$testsArray)): ?><?php echo $Myra_GRE_score;?><?php endif; ?></span>
					</li>
