    	...
    	<div class="app-left-box">
            ...
            <div class="inst-name" style="width:90%;margin-left:0px">
				...
				<div style="text-align:left;margin-left:20px">
					P.B.No. 1668, Peelamedu,Coimbatore - 641 004, India<br>
					Phone: +91 422 - 4304400 / 4304447,<br>
					Fax: +91 422- 4304444 e-mail: admissions@psgim.ac.in <br>
					Website: www.psgim.ac.in, www.psgtech.edu, www.facebook.com/psgim<br>
				</div>
				</div>
            </div>
   ...
   <div class="spacer15 clearFix"></div>
	...
	<ul>
		...
		<li>
			...
			<td><?=$graduationExaminationName?></td>
