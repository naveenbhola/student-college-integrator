...
?>
	...
	<div id="custom-form-header">
    	<div class="app-left-box">
            ...
            <div class="inst-name" style="width:80%;margin-left:0px">
                <img src="/public/images/onlineforms/institutes/Doon/logo2.gif" alt="/public/images/onlineforms/institutes/Doon/logo2.gif?>" style="float:left" />
		
				<div style="float:right">
				<h2 style="font-size:13px;">Doon Business School</h2>
				<div style="text-align:center;margin-left:20px">
					MI - 122, Selaqui, Dehradun, Behind Pharma City,<br>
					Dehradun, Uttarakhand, India- 248001 <br>
					Ph: 9910058209<br>
					E-Mail: admissions@dbs.org<br>
					Website: www.doonbusinessschool.com<br>
				</div>
				</div>
            </div>
	...
	<?php
		$testsArray = explode(",",$Doon_testNames);
		?>
