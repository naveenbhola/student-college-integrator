...
?>
	...
	<div id="custom-form-header">
    	<div class="app-left-box">
            <div class="inst-name" style="width:87%;margin-left:0px">
                <img style="margin-left:106px;" src="/public/images/onlineforms/institutes/mimt/logo2.gif" alt="MANGALMAY INSTITUTE OF TECHNOLOGY AND MANAGEMENT" />
		 <div class="clearFix spacer20"></div>
				<div style="float:right;margin-right:-55px">
				<h2 style="font-size:20px;">MANGALMAY INSTITUTE OF MANAGEMENT AND TECHNOLOGY</h2>
				<div style="text-align:left;margin-left:96px">
		                    Campus - 8 & 9, Knowledge Park -II , Greater Noida, Uttar Pradesh, India- 201310
				</div>
				</div>
            </div>
	    ...
	    <?php if( $instituteSpecId!=''){?>
                                ...
                                Form Id: <?php echo $instituteSpecId; ?>
                         </div>
                        <?php } ?>
           <div class="appForm-box" style="width:104%"><span>Application Form: <?php if($instituteInfo[0]['instituteInfo'][0]['sessionYear']){ echo $instituteInfo[0]['instituteInfo'][0]['sessionYear'];} else{echo "2014";}?>-<?php if($instituteInfo[0]['instituteInfo'][0]['sessionYear']){ echo intval($instituteInfo[0]['instituteInfo'][0]['sessionYear'])+2;} else{echo "2015";}?></span></div>
     ...
     <div class="spacer20 clearFix"></div>
     <div class="rolesResponsiblity" style="float:left;">
     	<h3>Roles &amp; Responsibilities:</h3>
        <div id="responsibilityList" style="margin-top:6px;">
            <ul>
    ...
    <div class="reviewLeftCol widthAuto">
     ...
     <div class="rolesResponsiblity">
     	<h3>Roles &amp; Responsibilities:</h3>
        <div id="responsibilityList" style="margin-top: 8px;">
            <ul>
	...
	<?php
		$testsArray = explode(",",$MIMTBSCHOOL_testNames);
	?>
	<div class="familyInfoSection">
			<div class="reviewTitleBox">
				<strong>TESTS:</strong>
