...
?>
	...
	<div id="custom-form-header">
		...
		<div style="float:right">Application Ref. No. <?=$instituteInfo['sessionYear']?>/<?=$instituteInfo['courseTitle']?>/S<?=$instituteSpecId?></div>
		 <div class="inst-name" style="width:97%; margin-top: 25px;">
			
			<div class="float_L"><img src="/public/images/onlineforms/institutes/HBS/logo2.gif" alt="" /></div>
			
			<div>
				<p style="font-size:18px;line-height:18px;">
				<b>Hyderabad Business School GITAM University</b>,
					<br/>Rudraram, Patancheru Mandal,
					<br/> Medak- 502329, Telangana.
					<br/>Ph: 9542424254, E-Mail: admissions@ghbs.in
					<br/>Website: www.ghbs.in
			</div>			
		</div>
	...
	<div class="appForm-box" style="width:98%">
				APPLICATION FORM FOR MBA 2015-2017
			</div>
	...
	<?php
		$testsArray = explode(",",$HBS_testNames);
		//_p($testsArray);die;
	?>
	<div class="familyInfoSection">
			<div class="reviewTitleBox">
			...
			<div>
				...
				<ul class="reviewChildRightCol" >
					...
					<li>
						...
						<span><?php echo $cmatPercentileHBS;?></span>
					</li>
					<?php endif; ?>
				</ul>
			</div>
