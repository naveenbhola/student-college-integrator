...
?>
	...
	<div id="custom-form-header">
    	<div class="app-left-box">
            ...
            <div class="inst-name" style="width:80%;margin-left:0px">
                <img src="/public/images/onlineforms/institutes/galaxy/logo2.gif" alt="Galaxy Institute Of Management" style="float:left" />
				<div style="float:right">
				<h2 style="font-size:20px;">Galaxy Institute Of Management</h2>
				<div style="text-align:left;margin-left:20px">
					Tambaram Road, Vellarai,<br/>
					Sriperumbudhur,<br/>
					Chennai, 602105
					Phone: (044) 42102510, 8939814407 <br/>
					E-Mail: admissions@galaxy.edu.in<br>
					Website: www.galaxy.edu.in<br>
				</div>
				</div>
            </div>
	...
	<div class="appForm-box" style="width:98%">
				Master of Business Administration (MBA) 2014 - 2015 Batch
			</div>
            ...
            <div class="reviewLeftCol">
                ...
                <?php //if($profile_data['gender']):?>
                    ...
                    <li>
                        ...
                        <span><?php echo $Galaxy_course;?></span>
                    </li>
	...
	<?php
		$testsArray = explode(",",$Galaxy_testNames);
	?>
	<div class="familyInfoSection">
			<div class="reviewTitleBox">
			...
			<div class="reviewLeftCol"   style="width:900px !important">
				...
				<ul class="reviewChildLeftCol"  style="width:400px !important;margin-bottom:30px">
					<li>
						<label style="width:150px !important">GMAT Registration No:</label>
						<span><?php if(in_array("GMAT",$testsArray)): ?><?php echo $gmatRollNumberAdditional;?><?php endif; ?></span>
					</li>
					
					<li>
						<label style="width:150px !important">GMAT Date:</label>
				...
				<ul class="reviewChildLeftCol"  style="width:400px !important;margin-bottom:30px">
					<li>
						<label style="width: 160px ! important; margin-left: -10px;">TANCET Registration&nbsp;No:</label>
						<span><?php if(in_array("TANCET",$testsArray)): ?><?php echo $tancetRollNumberAdditional;?><?php endif; ?></span>
					</li>
					
					<li>
						<label style="width:150px !important">TANCET Date:</label>
						<span><?php if(in_array("TANCET",$testsArray)): ?><?php echo $tancetDateOfExaminationAdditional;?><?php endif; ?></span>
					</li>
				...
				<ul class="reviewChildLeftCol"  style="width:400px !important;margin-bottom:30px">
					<li>
						<label style="width:150px !important">TANCET Score:</label>
						<span><?php if(in_array("TANCET",$testsArray)): ?><?php echo $tancetScoreAdditional;?><?php endif; ?></span>
					</li>
					
					<li>
						<label style="width:150px !important">TANCET Percentile:</label>
						<span><?php if(in_array("TANCET",$testsArray)): ?><?php echo $tancetPercentileAdditional;?><?php endif; ?></span>
					</li>
