...
?>
    ...
    <div id="custom-form-header">
        <div class="app-left-box">
            ...
            <div class="inst-name" style="width:80%;margin-left:0px">
                <img src="/public/images/onlineforms/institutes/BIBS/logo2.gif" alt="/public/images/onlineforms/institutes/BIBS/logo2.gif?>" style="float:left" />
        
                <div style="float:right">
                <h2 style="font-size:16px;">Bengal Institute of Business studies</h2>
                <div style="text-align:center;margin-left:20px">
                    18D Lakeview Road,<br>
                    Kolkata-700029<br>
                    West Bengal, India.<br>
                    Ph: 9007098910 / 9007135530<br>
                    E-Mail: info@bibs.co.in<br>
                    Website: http://bibs.co.in<br>
                </div>
                </div>
            </div>
            ...
            <div class="reviewLeftCol">
                ...
                <?php //if($profile_data['gender']):?>
                    ...
                    <li>
                        ...
                        <span>Post Graduate Programme in Business Management</span>
                    </li>
    ...
    <?php
        $testsArray = explode(",",$BIBS_testNames);
        ?>
        ...
        <div class="familyInfoSection">
            ...
            <div class="reviewLeftCol"   style="width:900px !important">
                ...
                <ul class="reviewChildLeftCol"  style="width:400px !important;">
                    <?php if(in_array("BIBSAT",$testsArray)): ?>
                    <li>
                        <label style="width:150px !important">BIBSAT Registration No:</label>
                        <span><?php echo $bibsatRollNumberAdditional;?></span>
                    </li>
                    
                    <li>
                        <label style="width:150px !important">BIBSAT Date:</label>
                        <span><?php echo $bibsatDateOfExaminationAdditional;?></span>
                    </li>
                    <?php endif; ?>
                </ul>
                ...
                <ul class="reviewChildLeftCol"  style="width:400px !important;">
                    <?php if(in_array("BIBSAT",$testsArray)): ?>
                    <li>
                        <label style="width:150px !important">BIBSAT Score:</label>
                        <span><?php echo $bibsatScoreAdditional;?></span>
                    </li>
                    
                    <li>
                        <label style="width:150px !important">BIBSAT Percentile:</label>
                        <span><?php echo $bibsatPercentileAdditional;?></span>
                    </li>
                    <?php endif; ?>
                </ul>
            </div>
