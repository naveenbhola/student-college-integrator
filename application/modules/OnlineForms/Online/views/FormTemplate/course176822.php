<link href="/public/css/onlineforms/agbs/AGBS_styles.css" rel="stylesheet" type="text/css"/>
	  ...
	  <strong class="applicationFormEditLink">(<a title="Edit form" href="/Online/OnlineForms/showOnlineForms/<?php echo $courseId; ?>/1/1">Edit form</a>)</strong>
    	...
    	<div class="previewHeader">
            ...
            <div class="courseNameDetails">
	            <img src="/public/images/onlineforms/institutes/agbs/logo2.gif" alt="" />
	        <p> Amity Global Business School <br />APPLICATION FORM-2014</p>
	    </div>
...
<div class="spacer15 clearFix"></div>
   ...
   <li>
                ...
                <div class="preff-cont"> Ahmedabad<span class="option-box"><?php if($preferredGDPILocation=="30"){ echo "<img src='/public/images/onlineforms/institutes/agbs/tick-icn.gif' border=0 />"; } ?></span></div>
                <div class="preff-cont">Chandigarh <span class="option-box"><?php if($preferredGDPILocation=="63"){ echo "<img src='/public/images/onlineforms/institutes/agbs/tick-icn.gif' border=0 />"; } ?></span></div>
                <div class="preff-cont">Indore <span class="option-box"><?php if($preferredGDPILocation=="106"){ echo "<img src='/public/images/onlineforms/institutes/agbs/tick-icn.gif' border=0 />"; } ?></span></div>
                <div class="preff-cont">Mumbai <span class="option-box"><?php if($preferredGDPILocation=="151"){ echo "<img src='/public/images/onlineforms/institutes/agbs/tick-icn.gif' border=0 />"; } ?></span></div>
                <div class="preff-cont">Pune <span class="option-box"><?php if($preferredGDPILocation=="174"){ echo "<img src='/public/images/onlineforms/institutes/agbs/tick-icn.gif' border=0 />"; } ?></span></div>
                <div class="preff-cont">Bangalore <span class="option-box"><?php if($preferredGDPILocation=="178"){ echo "<img src='/public/images/onlineforms/institutes/agbs/tick-icn.gif' border=0 />"; } ?></span></div>
                <div class="preff-cont">Chennai <span class="option-box"><?php if($preferredGDPILocation=="64"){ echo "<img src='/public/images/onlineforms/institutes/agbs/tick-icn.gif' border=0 />"; } ?></span></div>
                
                <div class="preff-cont">Kochi <span class="option-box"><?php if($preferredGDPILocation=="127"){ echo "<img src='/public/images/onlineforms/institutes/agbs/tick-icn.gif' border=0 />"; } ?></span></div>
                <div class="preff-cont">Noida <span class="option-box"><?php if($preferredGDPILocation=="161"){ echo "<img src='/public/images/onlineforms/institutes/agbs/tick-icn.gif' border=0 />"; } ?></span></div>
                <div class="preff-cont">Bhubaneswar <span class="option-box"><?php if($preferredGDPILocation=="912"){ echo "<img src='/public/images/onlineforms/institutes/agbs/tick-icn.gif' border=0 />"; } ?></span></div>
                <div class="preff-cont">Hyderabad <span class="option-box"><?php if($preferredGDPILocation=="702"){ echo "<img src='/public/images/onlineforms/institutes/agbs/tick-icn.gif' border=0 />"; } ?></span></div>
                 <div class="preff-cont">Kolkata <span class="option-box"><?php if($preferredGDPILocation=="130"){ echo "<img src='/public/images/onlineforms/institutes/agbs/tick-icn.gif' border=0 />"; } ?></span></div>
                 <div class="preff-cont">Patna  <span class="option-box"><?php if($preferredGDPILocation=="171"){ echo "<img src='/public/images/onlineforms/institutes/agbs/tick-icn.gif' border=0 />"; } ?></span></div>
            </li>
            
            <li>
            	<h3 class="form-title">Campus where You want to study:</h3>
                <div class="preff-cont"><strong>Preference 1:&nbsp</strong><?php
				      echo $pref1AGBS;
				?></div>
                <div class="preff-cont"><strong>Preference 2:&nbsp</strong><?php
				      echo $pref2AGBS;
				?></div>
            </li>
            ...
            <li>
            	...
            	<div style="float: left; width: 100%">I, &nbsp; <span style="width:300px; border-bottom: 1px solid #000; display: inline-block">&nbsp;<?php echo (isset($middleName) && $middleName!='')?$firstName." ".$middleName." ".$lastName:$firstName." ".$lastName;?></span> hereby certify that the information given in theApplication (All relevant Forms) is complete and accurate. I understand and agree that misrepresentation or omission of facts will justify the denial of admission, the cancellation of admission, or expulsion.<BR />
<p style="margin-top:10px">I have read and do hereby consent to the Terms & Conditions or Admission being enclosed with the Application Form.</p>
