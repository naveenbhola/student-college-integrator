<link href="/public/css/onlineforms/asbm/ASBM_styles.css" rel="stylesheet" type="text/css"/>
	  ...
	  <strong class="applicationFormEditLink">(<a title="Edit form" href="/Online/OnlineForms/showOnlineForms/<?php echo $courseId; ?>/1/1">Edit form</a>)</strong>
    	...
    	<div class="previewHeader">
            ...
            <div class="courseNameDetails">
	            <img src="/public/images/onlineforms/institutes/asbm/logo.jpg" alt="" />
	        <p>Asian School of Buisness Management Bhubaneswar<br />APPLICATION FORM</p>
	    </div>
        ...
        <div id="responsibilityList">
            <table width="100%" cellpadding="7" cellspacing="0" border="1" bordercolor="#000000" class="educationTable">
					...
					<?php if(isset($preferredGDPILocation) && $preferredGDPILocation!=''){ ?>
                                        <td align="center"><?php if($preferredGDPILocation=='912') echo "Bhubaneswar"; else echo "<strike>Bhubaneswar</strike>";?></td>
	...
	<li>
                        ...
                        <div style="padding-left:33px">
                        	I declare that the information furnished in this application are true to the best of my knowledge and belief and I
understand that my application may be rejected and admission cancelled if any information provided herein is found to be incorrect at any time.
