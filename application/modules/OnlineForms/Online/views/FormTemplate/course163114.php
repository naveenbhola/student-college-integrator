...
?>
	...
	<div id="custom-form-header">
    	<div class="app-left-box">
			<div style="float:right">Application Ref. No. SK<?=$instituteSpecId?></div>
			 <div class="clearFix spacer10"></div>
            <div class="inst-name" style="width:80%;margin-left:0px">
                <img src="/public/images/onlineforms/institutes/usb/logo2.jpg" alt="Unitedworld School of Business" style="float:left" />
				<div style="float:right">
				<h2 style="font-size:20px;">Unitedworld School of Business</h2>
				<div style="text-align:left;margin-left:20px">
					407, 4th Floor, <br/>
					Zodiac Square,Opp. Gurudwara,<br/>
					S.G. Road, Bodakdev,<br/>
					Ahmedabad-380054, Gujarat<br/>
					Email: admission@unitedworld.in <br/>
					Website: www.unitedworld.in<br/>
				</div>
				</div>
            </div>
	...
	<?php
		$testsArray = explode(",",$USB_testNames);
	?>
	<div class="familyInfoSection">
			<div class="reviewTitleBox">
				<strong>TESTS:</strong>
			...
			<div class="reviewLeftCol"   style="width:900px !important">
				...
				<ul class="reviewChildLeftCol"  style="width:400px !important;">
					...
					<li>
						...
						<span><?php echo $cmatPercentileUSB;?></span>
					</li>
					<?php endif; ?>
				</ul>
