<link href="/public/css/onlineforms/isms/ISMS_styles.css" rel="stylesheet" type="text/css"/>
	  ...
	  <strong class="applicationFormEditLink">(<a title="Edit form" href="/Online/OnlineForms/showOnlineForms/<?php echo $courseId; ?>/1/1">Edit form</a>)</strong>
    	...
    	<div class="previewHeader">
            ...
            <div class="courseNameDetails">
	            <img src="/public/images/onlineforms/institutes/isms/logo2.jpg" alt="" />
	        <p>International School of Management Studies<br />APPLICATION FORM</p>
	    </div>
            ...
            <div class="reviewLeftCol">
                ...
                <?php //if($profile_data['gender']):?>
                    ...
                    <li>
                        ...
                        <span>BTEC EDSML Level 7 - (MBA Progression)</span>
                    </li>
	...
	<div class="rolesResponsiblity">
        ...
        <div id="responsibilityList">
            <table width="100%" cellpadding="7" cellspacing="0" >
				     <tr>
                                <td><span class='check-box'><?php if($coursePrefISMS0=='MBA') echo "<img src='/public/images/onlineforms/institutes/cmr/tick-icn.gif' alt='' />";?></span>
				<span style="float:left; width:260px">
                                BTEC EDSML Level 7 - (MBA Progression)</span>
                                </td>
	...
	<li>
                        ...
                        <div style="padding-left:33px">
                        	I HAVE READ AND UNDERSTOOD THE TERMS & CONDITIONS IN RESPECT TO THE COURSE FEE,&nbsp;REGISTRATION AND REFUND POLICIES AS DETAILED IN THE RELEVANT SECTIONS OF THE PROSPECTUS AND WEBSITE.&nbsp;I AGREE TO ABIDE BY THEM FULLY.
