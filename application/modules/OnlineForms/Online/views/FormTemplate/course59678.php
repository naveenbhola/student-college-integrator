	...
	<div id="custom-form-header">
    	<div class="app-left-box">
            ...
            <div class="inst-name" style="width:80%;margin-left:0px">
				...
				<h2 style="font-size:15px;"><?=$instituteInfo['institute_name']?></h2>
				<div style="text-align:left;margin-left:20px">
					Plot No. 5, Rao Tula Ram Marg,<br> 
                    Opposite Army R&R Hospital,<br> 
                    Vasant Vihar, Basant Gaon,<br> 
                    Delhi<br>
					Ph: +91-11-47285048, +91-9711828929, +91-9999848024<br>
					E-Mail: admissions@fiib.edu.in<br>
					Website: http://www.fiib.edu.in<br>
				</div>
				</div>
            </div>
    ...
    <div id="custom-form-content">
        ...
        <ul class="adjust_ul">
            <li>
                <div class="colums-width">
                    <label>How did you come to know IIFB?: </label>
                    <div class="form-details">
                        <?php 
                            echo $HowdidyoucometoknowFIIBFIIBMBA2019; 
                            if (in_array(" Others",explode(",",$HowdidyoucometoknowFIIBFIIBMBA2019))){
                                echo "(".$SpecifyNameFIIBMBA2019.")";
                            }
                        ?>
        ...
        <ul  class="adjust_ul">
            ...
            <li>
                <div class="colums-width">
                    ...
                    <div class="form-details"><?php echo $Father_OrganizationFIIBMBA2019; ?></div>
                </div>
            </li>
            ...
            <li>
                <div class="colums-width">
                    ...
                    <div class="form-details"><?php echo $Mother_OrganizationFIIBMBA2019; ?></div>
                </div>
            </li>
            ...
            <li>
                <div class="colums-width">
                    ...
                    <div class="form-details"><?php echo $Father_MobileFIIBMBA2019; ?></div>
                </div>
            </li>
            ...
            <li>
                <div class="colums-width">
                    ...
                    <div class="form-details"><?php echo $Mother_MobileFIIBMBA2019; ?></div>
                </div>
            </li>
        </ul>

        <div class="reviewTitleBox">
                <strong>Xth Education Details</strong>
        </div> 
        <ul class="adjust_ul">
                <li>
                    <div class="colums-width">
                        <label>Stream: </label>
                        <div class="form-details"><?php echo $Stream_Std_XFIIBMBA2019; ?></div>
                    </div>
                </li>
                ...
                <li>
                    <div class="colums-width">
                        ...
                        <div class="form-details"><?php echo $Certificate_Awards_Std_XFIIBMBA2019; ?></div>
                    </div>
                </li>
        </ul>

        <div class="reviewTitleBox">
                <strong>XIIth Education Details</strong>
        </div> 
        <ul class="adjust_ul">
            <li>
                <div class="colums-width">
                    <label>Stream: </label>
                    <div class="form-details"><?php echo $Stream_Std_XIIFIIBMBA2019; ?></div>
                </div>
            </li>
            ...
            <li>
                <div class="colums-width">
                    <label>Certificate/Awards: </label>
                    <div class="form-details"><?php echo $Certificate_Awards_Std_XIIFIIBMBA2019; ?></div>
                </div>
            </li>
        ...
        <ul class="adjust_ul">
            <li>
                <div class="colums-width">
                <label>Certificate/Awards: </label>
                <div class="form-details"><?php echo $Certificate_Awards_GraduationFIIBMBA2019; ?></div>
                </div>
            </li>
        ...
        <ul class="adjust_ul">
            ...
            <div class="colums-width">
                <label>Stream: </label>
                <div class="form-details"><?php echo $Stream_Post_GraduationFIIBMBA2019; ?></div>
            </div>
            </li>
            ...
            <li>
                <div class="colums-width">
                    ...
                    <div class="form-details"><?php echo $Institution_Post_GraduationFIIBMBA2019; ?></div>
                </div>
            </li>
            ...
            <li>
                <div class="colums-width">
                    ...
                    <div class="form-details"><?php echo $Board_Post_GraduationFIIBMBA2019; ?></div>
                </div>
            </li>
            ...
            <li>
                <div class="colums-width">
                    ...
                    <div class="form-details"><?php echo $YearofCompletion_Post_GraduationFIIBMBA2019; ?></div>
                </div>
            </li>
            ...
            <li>
                <div class="colums-width">
                    ...
                    <div class="form-details"><?php echo $Percentage_Post_GraduationFIIBMBA2019; ?></div>
                </div>
            </li>
            ...
            <li>
                <div class="colums-width">
                    <label>Certificate/Awards: </label>
                    <div class="form-details"><?php echo $Certificate_Awards_Post_GraduationFIIBMBA2019; ?></div>
                </div>
            </li>
        </ul>

        <div class="reviewTitleBox">
                <strong>Other Education Details</strong>
        </div> 
        <ul class="adjust_ul">       
            <li>
                <div class="colums-width">
                    <label>Stream: </label>
                    <div class="form-details"><?php echo $Stream_OtherFIIBMBA2019; ?></div>
                </div>
            </li>
            ...
            <li>
                <div class="colums-width">
                    <label>Institute: </label>
                    <div class="form-details"><?php echo $Institution_OtherFIIBMBA2019; ?></div>
                </div>
            </li>
            ...
            <li>
                <div class="colums-width">
                    <label>Board/University: </label>
                    <div class="form-details"><?php echo $Board_OtherFIIBMBA2019; ?></div>
                </div>
            </li>
            ...
            <li>
                <div class="colums-width">
                    <label>Year of Completion: </label>
                    <div class="form-details"><?php echo $YearofCompletion_OtherFIIBMBA2019; ?></div>
                </div>
            </li>
            ...
            <li>
                <div class="colums-width">
                    <label>Percentage: </label>
                    <div class="form-details"><?php echo $Percentage_OtherFIIBMBA2019; ?></div>
                </div>
            </li>
            ...
            <li>
                <div class="colums-width">
                    <label>Certificate/Awards: </label>
                    <div class="form-details"><?php echo $Certificate_Awards_OtherFIIBMBA2019; ?></div>
                </div>
            </li>   
        </ul>

        <div class="reviewTitleBox">
                <strong>Professional/additional qualifications (if any)</strong>
        </div> 
        <ul class="adjust_ul">
            ...
            <li>
                <div class="colums-width">
                    ...
                    <div class="form-details"><?php echo $QualificationFIIBMBA2019; ?></div>
                </div>
            </li>
            ...
            <li>
                <div class="colums-width">
                    <label>Institute: </label>
                    <div class="form-details"><?php echo $InstitutionFIIBMBA2019; ?></div>
                </div>
            </li>
            ...
            <li>
                <div class="colums-width">
                    <label>Board/University: </label>
                    <div class="form-details"><?php echo $Board_UniversityFIIBMBA2019; ?></div>
                </div>
            </li>
            ...
            <li>
                <div class="colums-width">
                    <label>Year of Completion: </label>
                    <div class="form-details"><?php echo $YearFIIBMBA2019; ?></div>
                </div>
            </li>
            ...
            <li>
                <div class="colums-width">
                    <label>Percentage: </label>
                    <div class="form-details"><?php echo $PercentageFIIBMBA2019; ?></div>
                </div>
            </li>
        </ul>

        <div class="reviewTitleBox">
                <strong>Disability/long term health condition</strong>
        </div> 
        <ul class="adjust_ul">
            <li>
                <div class="colums-width">
                    <label>I have a Disability: </label>
                    <div class="form-details"><?php echo $Disability_FlagFIIBMBA2019; ?></div>
                </div>
            </li>
            
        <?php if ($Disability_FlagFIIBMBA2019!= "No") { ?>
            <li style="width: 100%">
                <div class="colums-width" style="width: 100%">
                    <label style="width:100%;padding: 0 0 5px;text-align: left;">Disability Detail: </label>
                    <div class="form-details" style="width: 100%"><?php echo $DisabilityDetailFIIBMBA2019; ?></div>
                </div>
            </li>
        <?php } ?> 
        </ul>
...
certificates on demand at any time. I also undertake that I shall abide by the rules and regulations of <?php echo $instituteInfo['institute_name'] ?>.
