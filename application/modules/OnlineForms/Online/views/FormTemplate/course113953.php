...
?>
    ...
    <div id="custom-form-header">
        <div class="app-left-box">
            ...
            <div class="inst-name" style="width:80%;margin-left:0px">
                <img src="/public/images/onlineforms/institutes/praxis/logo2.gif" alt="/public/images/onlineforms/institutes/praxis/logo2.gif?>" style="float:left" />
        
                <div style="float:right">
                <h2 style="font-size:22px;">Praxis Business School</h2>
                <div style="text-align:center;margin-left:-20px">
                    Admissions Office, Bakrahat Road,<br>
                    P.O. Rasapunja,<br>
                    24 Parganas (S), Kolkata- 700104<br>
                    Ph: 9836877599<br>
                    E-Mail: deblina@praxis.ac.in<br>
                    Website: www.praxis.ac.in<br>
                </div>
                </div>
            </div>
            ...
            <div class="reviewLeftCol">
                ...
                <?php //if($profile_data['gender']):?>
                    ...
                    <li>
                        ...
                        <span>Post Graduate Program in Business Management (PGPBM)</span>
                    </li>
    ...
    <?php
        $testsArray = explode(",",$PBSM_testNames);
        ?>
