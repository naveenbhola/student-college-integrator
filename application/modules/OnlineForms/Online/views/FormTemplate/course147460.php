...
?>
	...
	<div id="custom-form-header">
    	<div class="app-left-box">
            ...
            <div class="inst-name" style="width:90%;margin-left:0px">
                <img src="/public/images/onlineforms/institutes/aims/logo.gif" alt="Acharya Institute of Management & Sciences" style="float:left" />
				<div style="float:right;margin-top: 20px;">
				<h2 style="font-size:20px;">AIMS Institutes</h2>
				<div style="text-align:left;margin-left:20px">
					<p>1st cross, 1st stage, Peenya, Bangalore 560 058, INDIA. <br />
					Tel : +91 80 2837 6430 / 2839 0433 / 4117 9588 / 4125 3496 / 2839 0434<br />
					Fax : +91 80 28378268 <br/>E-mail : admission@theaims.ac.in<br />
					<span>Website : http://www.theaims.ac.in/</span>
					</p>
				</div>
				</div>
            </div>
	...
	<div class="appForm-box" style="width:98%">
            	Application Form For Admission in Academic Year 2016 - 2017
			</div>
                ...
                <ul>
                	<li>
                    	<div class="formColumns">
                            ...
                            <div style="width:290px; float:left;font-size:14px;"><?php echo $programAIMS;?></div>
						</div>
            ...
            <div class="reviewLeftCol">
                ...
                <?php //if($profile_data['gender']):?>
                    ...
                    <li>
                        ...
                        <span>Master of Business Administration (BU)</span>
                    </li>
		...
		<?php
		$testsArray = explode(",",$QualifyingNameAIMS);
		?>
		<div class="familyInfoSection">
			<div class="reviewTitleBox">
			...
			<div class="reviewLeftCol"   style="width:900px !important">
				...
				<ul class="reviewChildLeftCol"  style="width:400px !important;margin-bottom:30px">
					<li>
						<label style="width:150px !important">CAT Roll Number:</label>
						<span><?php if(in_array("CAT",$testsArray)): ?><?php echo $catRollNumberAdditional;?><?php endif; ?></span>
					</li>

					<li>
						<label style="width:150px !important">CAT Date of Examination:</label>
				...
				<ul class="reviewChildLeftCol"  style="width:400px !important;margin-bottom:30px">
					<li>
						<label style="width:150px !important">MAT Roll Number:</label>
						<span><?php if(in_array("MAT",$testsArray)): ?><?php echo $matRollNumberAdditional;?><?php endif; ?></span>
					</li>

					<li>
						<label style="width:150px !important">MAT Date of Examination:</label>
				...
				<ul class="reviewChildLeftCol"  style="width:400px !important;margin-bottom:30px">
					<li>
						<label style="width:150px !important">GMAT Score:</label>
						<span><?php if(in_array("GMAT",$testsArray)): ?><?php echo $gmatScoreAdditional;?><?php endif; ?></span>
					</li>

					<li>
						<label style="width:150px !important">GMAT Percentile:</label>
				...
				<ul class="reviewChildLeftCol"  style="width:400px !important;margin-bottom:30px">
					<li>
						<label style="width:150px !important">GMAT Roll Number:</label>
						<span><?php if(in_array("GMAT",$testsArray)): ?><?php echo $gmatRollNumberAdditional;?><?php endif; ?></span>
					</li>

					<li>
						<label style="width:150px !important">GMAT Date of Examination:</label>
				...
				<ul class="reviewChildLeftCol"  style="width:400px !important;margin-bottom:30px">
					<li>
						<label style="width:150px !important">XAT Roll Number:</label>
						<span><?php if(in_array("XAT",$testsArray)): ?><?php echo $xatRollNumberAdditional;?><?php endif; ?></span>
					</li>

					<li>
						<label style="width:150px !important">XAT Date of Examination:</label>
				...
				<ul class="reviewChildLeftCol"  style="width:400px !important;margin-bottom:30px">
					<li>
						<label style="width:150px !important">CMAT Roll Number:</label>
						<span><?php if(in_array("CMAT",$testsArray)): ?><?php echo $cmatRollNumberAdditional;?><?php endif; ?></span>
					</li>

					<li>
						<label style="width:150px !important">CMAT Date of Examination:</label>
                ...
                <ul class="reviewChildLeftCol"  style="width:400px !important;margin-bottom:30px">
                    <li>
                        <label style="width:150px !important">ATMA Roll Number:</label>
                        <span><?php if(in_array("ATMA",$testsArray)): ?><?php echo $atmaRollNumberAdditional;?><?php endif; ?></span>
                    </li>

                    <li>
                        <label style="width:150px !important">ATMA Date of Examination:</label>
