...
?>
	...
	<div id="custom-form-header">
    	<div class="app-left-box">
            ...
            <div class="inst-name" style="width:92%;margin-left:0px">
                <img src="/public/images/onlineforms/institutes/asmibmr/logo2.jpg" alt="ASM Group of Institutes" style="float:left" />
				<div style="float:right">
				<h2 style="font-size:20px;">ASM Group of Institutes</h2>
				<div style="text-align:center;margin-left:20px">
					Audyogik Shikshan Mandal, S. No. 29/1 + 2A, CTS No. 4695, Opp. PCMC Building, <br>
					Behind Sterling Honda Showroom, Near Empire Estate, Pimpri, Pune - 411018<br>
					Call: 9422009207/09/10/12/14 +91-20-27475090 / 27478666 / 66351700<br>
					Email: ibmrc@vsnl.in<br>Website: www.asmedu.org
				</div>
				</div>
            </div>
	...
	<div class="appForm-box" style="width:98%">
				Master of Business Administration (MBA) 2013 - 2014 Batch
			</div>
	...
	<?php
		$testsArray = explode(",",$ASMIBMRTestNames);
	?>
	<div class="familyInfoSection">
			<div class="reviewTitleBox">
			...
			<div class="reviewLeftCol"   style="width:900px !important">
				...
				<ul class="reviewChildLeftCol"  style="width:400px !important;margin-bottom:30px">
					...
					<li>
						...
						<span><?php if(in_array("CMAT",$testsArray)): ?><?php echo $cmatPercentileASMIBMR;?><?php endif; ?></span>
					</li>
