...
?>
	...
	<div id="custom-form-header">
    	<div class="app-left-box">
			<div style="float:right"><?php if(isset($firstName) && $firstName!='') {echo 'Application No. MBA/2013-14/S'.$instituteSpecId;} ?></div>
			 <div class="clearFix spacer10"></div>
            <div class="inst-name" style="width:98%;margin-left:0px">
                <img src="/public/images/onlineforms/institutes/jaypee/logo2.jpg" alt="Jaypee Institute of Information Technology" style="float:left" />
				<div style="float:right">
				<h2 style="font-size:20px;">Jaypee Institute of Information Technology</h2>
				<div style="text-align:center;margin-left:20px">
                    (Declared Deemed to be University u/s 3 of the UGC Act, 1956)<br/>
                    <p style="font-size:18px;margin-top:5px;">Jaypee Business School</p>
                    A - 10, Sector - 62, Noida (UP) India 201307<br/>
                    Tel: 91+ (120) 2594179 (Ms. Aradhana Goyal), 91+ (120) 2594479 (Dr. Asit Bandopadhyay)<br/>
                    Email: webadmin@jiit.ac.in Website: www.jbs.ac.in<br/>
                </div>
				</div>
            </div>
    ...
    <?php endif;endfor;//endif;?>
        ...
        <div class="educationInfoSection">
            ...
            <div class="educationBlock">
                <div class="educationTitle educationTitleBg">
                    <p class="educationCol educationTitleColFirst" style="width:260px;">Composite/Total Score</p>
                    <p class="educationCol" style="width:260px;">Percentile (%)</p>
                    <p class="educationCol" style="width:260px;">Result Valid Upto</p>
                </div>
                <?php
                ...
                <ul>
                    <li>
                        <div class="formAutoColumns">
                            <label class="labelBg" style="padding-top:5px;"><strong>CAT</strong></label>
                            <span class="educationCol educationColFirst word-wrap" style="width:260px;"><?php if(in_array("CAT",$testsArray)): ?><?php echo $catScoreAdditional;?><?php endif; ?></span>
                            <span class="educationCol word-wrap" style="width:260px;"><?php if(in_array("CAT",$testsArray)): ?><?php echo $catPercentileAdditional;?><?php endif; ?></span>
                            <span class="educationCol word-wrap" style="width:260px;"><?php if(in_array("CAT",$testsArray)): ?><?php echo $catValidUptoJaypee;?><?php endif; ?></span>
                        </div>
                    </li>

                    <li>
                        <div class="formAutoColumns">
                            <label class="labelBg" style="padding-top:5px;"><strong>MAT</strong></label>
                            <span class="educationCol educationColFirst word-wrap" style="width:260px;"><?php if(in_array("MAT",$testsArray)): ?><?php echo $matScoreAdditional;?><?php endif; ?></span>
                            <span class="educationCol word-wrap" style="width:260px;"><?php if(in_array("MAT",$testsArray)): ?><?php echo $matPercentileAdditional;?><?php endif; ?></span>
                            <span class="educationCol word-wrap" style="width:260px;"><?php if(in_array("MAT",$testsArray)): ?><?php echo $matValidUptoJaypee;?><?php endif; ?></span>
                        </div>
                    </li>
	...
	<div class="rolesResponsiblity">
        ...
        <div class="reviewLeftCol"   style="width:900px !important">
				<ul class="reviewChildLeftCol"  style="width:400px !important">
					<li>
						<label style="width:90px !important">Preference:</label>
