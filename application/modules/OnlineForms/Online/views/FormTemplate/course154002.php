<link href="/public/css/onlineforms/suryadatta/SURYADATTA_styles.css" rel="stylesheet" type="text/css"/>
	  ...
	  <strong class="applicationFormEditLink">(<a title="Edit form" href="/Online/OnlineForms/showOnlineForms/<?php echo $courseId; ?>/1/1">Edit form</a>)</strong>
    	...
    	<div class="previewHeader">
            ...
            <div class="courseNameDetails">
	            <img src="/public/images/onlineforms/institutes/suryadatta/logo2.jpg" alt="" />
	        <p>Suryadatta Group of Institutes<br />APPLICATION FORM</p>
	    </div>
            ...
            <div class="reviewLeftCol">
                ...
                <?php //if($profile_data['gender']):?>
                    ...
                    <li>
                        ...
                        <span>PGDM with Dual Specialization</span>
                    </li>
	...
	<div class="rolesResponsiblity" style="float:left; width:100%">
		<div class="reviewTitleBox"><strong>Course Preference:</strong></div>
		 <div class="course-box">
				    ...
				    <tr>
					<td style="font-size:16px" align="center">Tick (<img src="/public/images/onlineforms/institutes/suryadatta/tick-icn.gif" alt="" />) the Name of the Course Applied</td>
				    </tr>
				    <tr>
					<td><span class='check-box'><?php if($coursePrefSURYADATTA0=='PGDM') echo "<img src='/public/images/onlineforms/institutes/jgiidea/tick-icn.gif' alt='' />";?></span>
