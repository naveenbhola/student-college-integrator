<link href="/public/css/onlineforms/sinhgad/SBS_styles.css" rel="stylesheet" type="text/css"/>
	  ...
	  <strong class="applicationFormEditLink">(<a title="Edit form" href="/Online/OnlineForms/showOnlineForms/<?php echo $courseId; ?>/1/1">Edit form</a>)</strong>
    	...
    	<div class="previewHeader">
            ...
            <div class="courseNameDetails">
	            <img src="/public/images/onlineforms/institutes/sinhgad/logo2.jpg" alt="" />
	        <p>Sinhgad Business Schools<br /></p>

               <p style="font-size:16px; font-weight:normal;">19/15, Erandwane, Smt. Khilare Marg, Off Karve Road, Pune-411004<br/>
                    Tel: 09881000922, 09623448939<br/>
                    Email: admissions@sinhgad.edu</p></br>
	  ...
	  <div class="familyInfoSection">
			...
			<?php
		$testsArray = explode(",",$SBS_testNames);
			?>
				...
				<ul class="reviewChildLeftCol"  style="width:400px !important;margin-bottom:30px">
					...
					<li>
                        ...
                        <div class="reviewRightCol"   style="width:900px !important">
...
</ol><div class="clearFix spacer25"></div>
