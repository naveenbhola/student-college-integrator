<link href="/public/css/onlineforms/mitcom/MITCOM_styles.css" rel="stylesheet" type="text/css"/>
	  ...
	  <strong class="applicationFormEditLink">(<a title="Edit form" href="/Online/OnlineForms/showOnlineForms/<?php echo $courseId; ?>/1/1">Edit form</a>)</strong>
    	...
    	<div class="previewHeader">
            ...
            <div class="courseNameDetails">
	            <img src="/public/images/onlineforms/institutes/mitcom/logo2.jpg" alt="" />
	        <p>MITCOM College Of Management<br />APPLICATION FORM</p>
	    </div>
...
<div class="spacer20 clearFix"></div>
	<div class="rolesResponsiblity" style="float:left; width:100%">
		<div class="reviewTitleBox"><strong>Course Preference:</strong></div>
		 <div class="course-box">
                    	<table width="100%" cellpadding="6" cellspacing="0" border="1" bordercolor="#000000" class="educationTable">
                            <tr>
                                <td style="font-size:16px" colspan="4" align="center">Tick (<img src="/public/images/onlineforms/institutes/mitcom/tick-icn.gif" alt="" />) the Name of the Course Applied</td>
                            </tr>
                            <tr>
                                <td><span class='check-box'><?php if($coursePrefMITCOM0=='1') echo "<img src='/public/images/onlineforms/institutes/mitcom/tick-icn.gif' alt='' />";?></span>
                                                <span style="float:left; width:160px;padding-top:5px;padding-left:5px;">
                                                                                MBA in General Management
                                                                                                </span>
                                                                                                                                </td>

                                <td><span class='check-box'><?php if($coursePrefMITCOM1=='2') echo "<img src='/public/images/onlineforms/institutes/mitcom/tick-icn.gif' alt='' />";?></span>
                                                <span style="float:left; width:160px;padding-left:5px;">
                                                                                MBA-PGP in Retail Business Management</span>
                                                                                                                </td>

                <td><span class='check-box'><?php if($coursePrefmitcom2=='3') echo "<img src='/public/images/onlineforms/institutes/mitcom/tick-icn.gif' alt='' />";?></span>
                                <span style="float:left; width:160px;padding-left:5px;">
                                                                MBA-PGP in Agri & Food Business Management</span>
                 
		                                                                       </td>
		<td><span class='check-box'><?php if($coursePrefMITCOM3=='4') echo "<img src='/public/images/onlineforms/institutes/mitcom/tick-icn.gif' alt='' />";?></span>
				<span style="float:left; width:200px;padding-left:5px;">
                                MBA in Forestry & Environment Management</span>
                                </td>
                           </tr>
                ...
                <td><span class='check-box'><?php if($coursePrefMITCOM4=='5') echo "<img src='/public/images/onlineforms/institutes/mitcom/tick-icn.gif' alt='' />";?></span>
                                <span style="float:left; width:160px;padding-left:5px;">
                                                                PGP in Project Construction & Infrastructure Management</span>
                                                                                                </td>
		<td><span class='check-box'><?php if($coursePrefMITCOM5=='6') echo "<img src='/public/images/onlineforms/institutes/mitcom/tick-icn.gif' alt='' />";?></span>
                                <span style="float:left; width:160px;padding-left:5px;">
                                                                Project Construction Management</span>
                                                                                                </td>

		<td><span class='check-box'><?php if($coursePrefMITCOM6=='7') echo "<img src='/public/images/onlineforms/institutes/mitcom/tick-icn.gif' alt='' />";?></span>
                                <span style="float:left; width:160px; padding-top:8px;padding-left:5px;">
                                                                MBA - LE</span>
                                                                                                </td>

		<td><span class='check-box'><?php if($coursePrefMITCOM7=='8') echo "<img src='/public/images/onlineforms/institutes/mitcom/tick-icn.gif' alt='' />";?></span>
                                <span style="float:left; width:200px; padding-top:8px;padding-left:5px;">
                                                                MCA - LE</span>
                                                                                                </td>
                            </tr>
                        </table>
...
<div class="rolesResponsiblity">
        ...
        <div id="responsibilityList">
            <table width="40%" cellpadding="7" cellspacing="0" border="1" bordercolor="#000000" class="educationTable">
                                    <tr> 
                                        ...
                                        <td align="center"><?php if($preferredGDPILocation=='174') echo "Pune"; else echo "<strike>Pune</strike>";?></td>
                                        <?php }else{ ?>
	...
	<li>
                        ...
                        <div style="padding-left:33px">
                        	I, Mr. /Ms. <?php echo (isset($middleName) && $middleName!='')?$firstName." ".$middleName." ".$lastName:$firstName." ".$lastName;?> have read the above rules and regulation of the MIT College of Management.
...
disobeying the order or instruction given by the college authorities from time to time.
