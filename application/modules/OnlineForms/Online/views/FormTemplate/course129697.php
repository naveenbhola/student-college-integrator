<link href="/public/css/onlineforms/abbs/ABBS_styles.css" rel="stylesheet" type="text/css"/>
	  ...
	  <strong class="applicationFormEditLink">(<a title="Edit form" href="/Online/OnlineForms/showOnlineForms/<?php echo $courseId; ?>/1/1">Edit form</a>)</strong>
    	...
    	<div class="previewHeader">
            ...
            <div class="courseNameDetails">
	            <img src="/public/images/onlineforms/institutes/abbs/logo2.jpg" alt="" />
	        <p>Acharya Bangalore B-School<br />APPLICATION FORM</p>
	    </div>
	  ...
	  <div class="familyInfoSection">
			...
			<?php
		$testsArray = explode(",",$ABBS_testNames);
			?>
        ...
        <div id="responsibilityList">
            <table width="100%" cellpadding="7" cellspacing="0" border="1" bordercolor="#000000" class="educationTable">
					...
					<?php  if(isset($preferredGDPILocation) && $preferredGDPILocation!=''){ ?>
                                        <td align="center"><?php if($preferredGDPILocation=='212') echo "Vijaywada"; else echo "<strike>Bhopal</strike>";?></td>
                                        <td align="center"><?php if($preferredGDPILocation=='138') echo "Lucknow"; else echo "<strike>Bangalore</strike>";?></td>
                                        <td align="center"><?php if($preferredGDPILocation=='35') echo "Allahabad"; else echo "<strike>Gorakhpur</strike>";?></td>
                                        <td align="center"><?php if($preferredGDPILocation=='702') echo "Hyderabad"; else echo "<strike>Hyderabad</strike>";?></td>
					<td align="center"><?php if($preferredGDPILocation=='130') echo "Kolkata"; else echo "<strike>Kolkata</strike>";?></td>
					...
					<td align="center"><?php if($preferredGDPILocation=='213') echo "Vishakapatanam"; else echo "<strike>Vishakapatanam</strike>";?></td>
					<td align="center"><?php if($preferredGDPILocation=='122') echo "Kanpur"; else echo "<strike>Patna</strike>";?></td>
					<td align="center"><?php if($preferredGDPILocation=='209') echo "Varanasi"; else echo "<strike>Ranchi</strike>";?></td>
					<td align="center"><?php if($preferredGDPILocation=='912') echo "Bhubaneswar"; else echo "<strike>Vishakapatanam</strike>";?></td>
					<?php }else{ ?>
                                        <td align="center">Vijaywada</td>
					...
					<td align="center">Kolkata</td>
                                        ...
                                        <td align="center">Vishakapatanam</td>
	...
	<li>
				...
				I stand by the admission/approval rules of the concerned University and stand to oblige by it and its regulations. I also stand by the declaration given by my son/daughter to the college.<div class="clearFix spacer25"></div>
