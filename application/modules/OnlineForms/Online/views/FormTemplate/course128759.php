...
?>
    	...
    	<?php if(!isset($_REQUEST['viewForm']) && !$sample) { ?><div class="previewText">This is how your form will be viewed by the institute</div><?php } ?>
	
	<div id="custom-form-header">
    	<div class="app-left-box">
			<div style="float:right">Application Ref. No. S<?=$instituteSpecId?></div>
			 <div class="clearFix spacer10"></div>
            <div class="inst-name" style="width:82%;margin-left:0px">
                <img src="/public/images/onlineforms/institutes/jaipuria/logo20152.gif" alt="/public/images/onlineforms/institutes/jaipuria/logo20152.gif" style="float:left;margin-right:10px" />
				<div style="float:right; margin-top:14px;">
				<h2 style="font-size:20px;">Jaipuria Institute of Management</h2>
				<div style="text-align:left;">
					
					New Delhi - 110005 (11/6B, 2nd Floor, Shanti Chambers, Pusa Road)<br>
					Ph: +91 11 40088000 <br>
					
					Lucknow - 226010 (Vineet Khand, Gomti Nagar)<br>
					Ph: +91 522 2394296/97, 2398096 <br>
					
					Noida - 201309(A-32A, Sector- 62, Opp. IBM)<br>
					Ph: +91 120 4638300<br>
					
					Jaipur - 302033 (1, Bambala Institutional Area, Pratap Nagar, Sanganer)<br>
					Ph: +91 141 4771300<br>
					
					Indore - 453771(Dakachya, Indore Dewas Highway, Near Shipra Naka)<br>
					Ph: +91 8800110513 <br>
					E-Mail: indore@jaipuria.ac.in<br>
					Website: jaipuri.ac.in<br>
				</div>
				</div>
            </div>
	...
	<div class="appForm-box" style="width:98%">
				Application Form 2015 - 2016 Batch
			</div>
	...
	<?php
		$testsArray = explode(",",$Jaipuria_testNames);
	?>
	...
	<li>
                        ...
                        <div style="padding-left:33px">
                        	I certify that the particulars given by me are true to the best of my knowledge and belief. I understand that Jaipuria Institute
of Management will have the right to cancel my admission and ask me to withdraw from the programme if any discrepancies
are found in the information furnished. I will also abide by the general discipline and norms of conduct during the
programme.<br>
I authorise Jaipuria Institute of Management to send me SMS and Email to update me with latest admission news and
details relevant to me.
