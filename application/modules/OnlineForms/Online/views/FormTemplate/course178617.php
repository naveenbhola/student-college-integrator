	...
	<div id="custom-form-header">
    	<div class="app-left-box">
            ...
            <div class="inst-name" style="width:87%;margin-left:0px">
                <img src="/public/images/onlineforms/institutes/vsbm/logo2.gif" alt="Vishwakarma Global Business School" style="float:left" />
				<div style="float:right">
				<h2 style="font-size:20px;">Vishveshwarya School of Management</h2>
				<div style="text-align:left;margin-left:20px">
				Centre for corporate and Industry (C & I ) Affairs <br/>VGI C-56/28 Behind Fortis, Noida Sec-62<br/>
				Email: admissions@vishveshwarya.com<br/>
				Mobile: 8130293770<br/>
				</div>
				</div>
            </div>
			...
			<div class="reviewLeftCol"   style="width:900px !important">
				...
				<ul class="reviewChildLeftCol"  style="width:400px !important;margin-bottom:30px">
					<li>
						...
						<span><?php if(in_array("CMAT",$testsArray)): ?><?php echo $cmatPercentileAdditionalVSBM;?><?php endif; ?></span>
					</li>
