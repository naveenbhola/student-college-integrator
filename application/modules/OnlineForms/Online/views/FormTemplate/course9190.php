...
?>
	...
	<div id="custom-form-header">
		...
		<div style="width: 100%">
			<div style="float: left;"><img src="/public/images/onlineforms/institutes/globsyn/logo2New.gif" alt="" /></div>
			
			<div class="inst-name" style="line-height: 17px; width: 70%; font-size: 15px;">
			
			<b style="font-size: 19px">Globsyn Business School,</b>
			<br/>Apeejay House, Suite # Sabha,
			<br/>8th Floor, 15 Park Street, Block - A,
			<br/>Kolkata - 700 016, Ph: +919836395967,
			<br/>E-Mail: gbsdirect@globsyn.edu.in
			<br/>Website: www.globsyn.edu.in
			</div>
		</div>
	...
	<div class="appForm-box" style="width:98%">
				APPLICATION FORM FOR PGDM 2015-2017
	</div>
    	...
    	<div class="familyInfoSection">
            ...
            <div class="reviewLeftCol">
                <ul class="reviewChildLeftCol" style="width:700px;">
                    <li>
                        <label>Programme(s) applied:</label>
                        <span style="width:500px;"><?php echo $courseGlobsyn;?></span>
                    </li>
                </ul>
            </div>
        </div>
	...
	<?php
		$testsArray = explode(",",$Globsyn_testNames);
		//_p($testsArray);die;
	?>
	<div class="familyInfoSection">
			<div class="reviewTitleBox">
			...
			<div>
				...
				<ul class="reviewChildRightCol" >
					...
					<li>
						...
						<span><?php echo $cmatPercentileGlobsyn;?></span>
					</li>
					<?php endif; ?>
				</ul>
			</div>
        ...
        <div id="responsibilityList">
            <table width="100%" cellpadding="7" cellspacing="0" border="1" bordercolor="#000000" class="educationTable">
                                    <tr>
                                        ...
                                        <td align="center"><?php if($preferredGDPILocation=='80') echo "Durgapur"; else echo "<strike>Durgapur</strike>";?></td>
                                        <td align="center"><?php if($preferredGDPILocation=='189') echo "Siliguri"; else echo "<strike>Siliguri</strike>";?></td>
                                        <td align="center"><?php if($preferredGDPILocation=='912') echo "Bhubaneshwar"; else echo "<strike>Bhubaneshwar</strike>";?></td>
                                        <td align="center"><?php if($preferredGDPILocation=='180') echo "Ranchi"; else echo "<strike>Ranchi</strike>";?></td>
                                        <td align="center"><?php if($preferredGDPILocation=='116') echo "Jamshedpur"; else echo "<strike>Jamshedpur</strike>";?></td>
                                        ...
                                        <td align="center">Bhubaneshwar</td>
