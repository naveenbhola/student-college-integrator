...
<div class='formChildWrapper'>
	<div class='formSection'>
		<ul>
			...
			<li>
				...
				<input type='checkbox'  onClick="checkTestScore(this);"  validate="validateCheckedGroup"    caption="tests"   name='GSIB_testNames[]' id='GSIB_testNames0'   value='CAT'   onmouseover="showTipOnline('Tick the appropriate box and provide test Registration and score (if available)',this);" onmouseout="hidetip();" ></input><span  onmouseover="showTipOnline('Tick the appropriate box and provide test Registration and score (if available)',this);" onmouseout="hidetip();" >CAT</span>&nbsp;&nbsp;
				<input type='checkbox'  onClick="checkTestScore(this);"  validate="validateCheckedGroup"  caption="tests"   name='GSIB_testNames[]' id='GSIB_testNames1'   value='MAT'     onmouseover="showTipOnline('Tick the appropriate box and provide test Registration and score (if available)',this);" onmouseout="hidetip();" ></input><span  onmouseover="showTipOnline('Tick the appropriate box and provide test Registration and score (if available)',this);" onmouseout="hidetip();" >MAT</span>&nbsp;&nbsp;
				<input type='checkbox'  onClick="checkTestScore(this);"  validate="validateCheckedGroup"      caption="tests"   name='GSIB_testNames[]' id='GSIB_testNames2'   value='CMAT'     onmouseover="showTipOnline('Tick the appropriate box and provide test Registration and score (if available)',this);" onmouseout="hidetip();" ></input><span  onmouseover="showTipOnline('Tick the appropriate box and provide test Registration and score (if available)',this);" onmouseout="hidetip();" >CMAT</span>&nbsp;&nbsp;
				<input type='checkbox'  onClick="checkTestScore(this);"  validate="validateCheckedGroup"  caption="tests"   name='GSIB_testNames[]' id='GSIB_testNames3'   value='GMAT'     onmouseover="showTipOnline('Tick the appropriate box and provide test Registration and score (if available)',this);" onmouseout="hidetip();" ></input><span  onmouseover="showTipOnline('Tick the appropriate box and provide test Registration and score (if available)',this);" onmouseout="hidetip();" >GMAT</span>&nbsp;&nbsp;
				<input type='checkbox'  onClick="checkTestScore(this);"  validate="validateCheckedGroup"  caption="tests"   name='GSIB_testNames[]' id='GSIB_testNames4'   value='XAT'     onmouseover="showTipOnline('Tick the appropriate box and provide test Registration and score (if available)',this);" onmouseout="hidetip();" ></input><span  onmouseover="showTipOnline('Tick the appropriate box and provide test Registration and score (if available)',this);" onmouseout="hidetip();" >XAT</span>&nbsp;&nbsp;
				<input type='checkbox'  onClick="checkTestScore(this);"  validate="validateCheckedGroup"  caption="tests"   name='GSIB_testNames[]' id='GSIB_testNames5'   value='GET'     onmouseover="showTipOnline('Tick the appropriate box and provide test Registration and score (if available)',this);" onmouseout="hidetip();" ></input><span  onmouseover="showTipOnline('Tick the appropriate box and provide test Registration and score (if available)',this);" onmouseout="hidetip();" >GET</span>&nbsp;&nbsp;
				
				<?php if(isset($GSIB_testNames) && $GSIB_testNames!=""){ ?>
				<script>
				    objCheckBoxes = document.forms["OnlineForm"].elements["GSIB_testNames[]"];
				    var countCheckBoxes = objCheckBoxes.length;
				    for(var i = 0; i < countCheckBoxes; i++){
					      objCheckBoxes[i].checked = false;

					      <?php $arr = explode(",",$GSIB_testNames);
				...
				<div style='display:none'><div class='errorMsg' id= 'GSIB_testNames_error'></div></div>
				</div>
				</div>
			</li>
			...
			<li id="get1" style="display:none;">
				<div class='additionalInfoLeftCol'>
				<label>GET REGN NO: </label>
				<div class='fieldBoxLarge'>
				<input class="textboxLarge" type='text' name='getRollNumberAdditional' id='getRollNumberAdditional'  validate="validateStr"    caption="regn no"   minlength="2"   maxlength="50"        tip="Mention your Registration number for the exam."   value=''   />
				<?php if(isset($getRollNumberAdditional) && $getRollNumberAdditional!=""){ ?>
				  <script>
				      document.getElementById("getRollNumberAdditional").value = "<?php echo str_replace("\n", '\n', $getRollNumberAdditional );  ?>";
				      document.getElementById("getRollNumberAdditional").style.color = "";
				  </script>
				<?php } ?>
				
				<div style='display:none'><div class='errorMsg' id= 'getRollNumberAdditional_error'></div></div>
				</div>
				</div>
				...
				<div class='fieldBoxLarge'>
				<input type='text' name='getDateOfExaminationAdditional' id='getDateOfExaminationAdditional' readonly maxlength='10'    validate="validateDateForms"  caption="date"      tip="Mention the date on which the examination was conducted."     onmouseover="showTipOnline('Mention the date on which the examination was conducted.',this);" onmouseout="hidetip();"  onClick="var cal = new CalendarPopup('calendardiv'); cal.select($('getDateOfExaminationAdditional'),'getDateOfExaminationAdditional_dateImg','dd/MM/yyyy');" />
				&nbsp;<img src='/public/images/eventIcon.gif' style='cursor:pointer' align='absmiddle' id='getDateOfExaminationAdditional_dateImg' onClick="var cal = new CalendarPopup('calendardiv'); cal.select($('getDateOfExaminationAdditional'),'getDateOfExaminationAdditional_dateImg','dd/MM/yyyy'); return false;" />
				<?php if(isset($getDateOfExaminationAdditional) && $getDateOfExaminationAdditional!=""){ ?>
				  <script>
				      document.getElementById("getDateOfExaminationAdditional").value = "<?php echo str_replace("\n", '\n', $getDateOfExaminationAdditional );  ?>";
				      document.getElementById("getDateOfExaminationAdditional").style.color = "";
				  </script>
				<?php } ?>
				
				<div style='display:none'><div class='errorMsg' id= 'getDateOfExaminationAdditional_error'></div></div>
				</div>
				</div>
			</li>

			<li id="get2" style="display:none; border-bottom:1px dotted #c0c0c0; padding-bottom:15px">
				<div class='additionalInfoLeftCol'>
				<label>GET Score: </label>
				<div class='fieldBoxLarge'>
				<input type='text' name='getScoreAdditional' id='getScoreAdditional'   validate="validateFloat"    caption="score"   minlength="1"   maxlength="5"     tip="Mention how much you scored in the exam. If the exam authorities have only declared percentiles for the exam, enter <b>NA</b>."  allowNA="true"   value=''  />
				<?php if(isset($getScoreAdditional) && $getScoreAdditional!=""){ ?>
				  <script>
				      document.getElementById("getScoreAdditional").value = "<?php echo str_replace("\n", '\n', $getScoreAdditional );  ?>";
				      document.getElementById("getScoreAdditional").style.color = "";
				  </script>
				<?php } ?>
				
				<div style='display:none'><div class='errorMsg' id= 'getScoreAdditional_error'></div></div>
				</div>
				</div>
				
				<div class='additionalInfoRightCol'>
				<label>GET Percentile: </label>
				<div class='fieldBoxLarge'>
				<input type='text' name='getPercentileAdditional' id='getPercentileAdditional'   validate="validateFloat" allowNA="true"  caption="Percentile"   minlength="1"   maxlength="5"      tip="Mention your percentile in the exam. If you don't know your percentile, enter <b>NA</b>."   value=''  />
				<?php if(isset($getPercentileAdditional) && $getPercentileAdditional!=""){ ?>
				  <script>
				      document.getElementById("getPercentileAdditional").value = "<?php echo str_replace("\n", '\n', $getPercentileAdditional );  ?>";
				      document.getElementById("getPercentileAdditional").style.color = "";
				  </script>
				<?php } ?>
				
				<div style='display:none'><div class='errorMsg' id= 'getPercentileAdditional_error'></div></div>
				</div>
				</div>
			</li>
		...
		<?php if($action != 'updateScore'):?>
			<li>
				...
				<div class='fieldBoxLarge'>
				<input type='checkbox'  validate="validateChecked" checked   required="true"   caption="Please check to accept terms"   name='declarationGSIB[]' id='declarationGSIB0'   value='1'    title="I agree to the terms stated above"   onmouseover="showTipOnline('Please check to accept terms',this);" onmouseout="hidetip();" ></input><span  onmouseover="showTipOnline('Please check to accept terms',this);" onmouseout="hidetip();" ></span>&nbsp;&nbsp;
				<?php if(isset($declarationGSIB) && $declarationGSIB!=""){ ?>
				<script>
				    objCheckBoxes = document.forms["OnlineForm"].elements["declarationGSIB[]"];
				    var countCheckBoxes = objCheckBoxes.length;
				    for(var i = 0; i < countCheckBoxes; i++){
					      objCheckBoxes[i].checked = false;

					      <?php $arr = explode(",",$declarationGSIB);
						    for($x=0;$x<count($arr);$x++){ ?>
							  if(objCheckBoxes[i].value == "<?php echo $arr[$x];?>") {
								  objCheckBoxes[i].checked = true;
							  }
			      ...
			      <?php } ?>
				<div style='display:none'><div class='errorMsg' id= 'declarationGSIB0_error'></div></div>
				</div>
				</div>
			</li>
			<?php endif; ?>
  ...
  <script>
    ...
    for(var j=0; j<6; j++){
		checkTestScore(document.getElementById('GSIB_testNames'+j));
	}
