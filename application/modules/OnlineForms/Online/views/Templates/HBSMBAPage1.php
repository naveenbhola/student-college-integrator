<script>
  function checkTestScore(obj){
	...
	var objects1 = new Array(key+"RollNumberAdditional",key+"ScoreAdditional",key+"DateOfExaminationAdditional",key+"RankAdditional",key+"PercentileAdditional",key+"PercentileHBS");
	if(obj && $(key+"1") && $(key+"2")){
	...
	<div class='formSection'>
		<ul>
			...
			<li>
				...
				<input type='checkbox'  onClick="checkTestScore(this);"  validate="validateCheckedGroup"    caption="tests"   name='HBS_testNames[]' id='HBS_testNames0'   value='CAT'   onmouseover="showTipOnline('Tick the appropriate box and provide test Registration and score (if available)',this);" onmouseout="hidetip();" ></input><span  onmouseover="showTipOnline('Tick the appropriate box and provide test Registration and score (if available)',this);" onmouseout="hidetip();" >CAT</span>&nbsp;&nbsp;
				<input type='checkbox'  onClick="checkTestScore(this);"  validate="validateCheckedGroup"  caption="tests"   name='HBS_testNames[]' id='HBS_testNames1'   value='XAT'     onmouseover="showTipOnline('Tick the appropriate box and provide test Registration and score (if available)',this);" onmouseout="hidetip();" ></input><span  onmouseover="showTipOnline('Tick the appropriate box and provide test Registration and score (if available)',this);" onmouseout="hidetip();" >XAT</span>&nbsp;&nbsp;
				<input type='checkbox'  onClick="checkTestScore(this);"  validate="validateCheckedGroup"      caption="tests"   name='HBS_testNames[]' id='HBS_testNames2'   value='ATMA'     onmouseover="showTipOnline('Tick the appropriate box and provide test Registration and score (if available)',this);" onmouseout="hidetip();" ></input><span  onmouseover="showTipOnline('Tick the appropriate box and provide test Registration and score (if available)',this);" onmouseout="hidetip();" >ATMA</span>&nbsp;&nbsp;
				<input type='checkbox'  onClick="checkTestScore(this);"  validate="validateCheckedGroup"  caption="tests"   name='HBS_testNames[]' id='HBS_testNames3'   value='CMAT'     onmouseover="showTipOnline('Tick the appropriate box and provide test Registration and score (if available)',this);" onmouseout="hidetip();" ></input><span  onmouseover="showTipOnline('Tick the appropriate box and provide test Registration and score (if available)',this);" onmouseout="hidetip();" >CMAT</span>&nbsp;&nbsp;
				<input type='checkbox'  onClick="checkTestScore(this);"  validate="validateCheckedGroup"  caption="tests"   name='HBS_testNames[]' id='HBS_testNames4'   value='MAT'     onmouseover="showTipOnline('Tick the appropriate box and provide test Registration and score (if available)',this);" onmouseout="hidetip();" ></input><span  onmouseover="showTipOnline('Tick the appropriate box and provide test Registration and score (if available)',this);" onmouseout="hidetip();" >MAT</span>&nbsp;&nbsp;
				<input type='checkbox'  onClick="checkTestScore(this);"  validate="validateCheckedGroup"   required="true"   caption="tests"   name='HBS_testNames[]' id='HBS_testNames5'   value='GMAT'     onmouseover="showTipOnline('Tick the appropriate box and provide test Registration and score (if available)',this);" onmouseout="hidetip();" ></input><span  onmouseover="showTipOnline('Tick the appropriate box and provide test Registration and score (if available)',this);" onmouseout="hidetip();" >GMAT</span>&nbsp;&nbsp;
				<?php if(isset($HBS_testNames) && $HBS_testNames!=""){ ?>
				<script>
				    objCheckBoxes = document.forms["OnlineForm"].elements["HBS_testNames[]"];
				    var countCheckBoxes = objCheckBoxes.length;
				    for(var i = 0; i < countCheckBoxes; i++){
					      objCheckBoxes[i].checked = false;

					      <?php $arr = explode(",",$HBS_testNames);
				...
				<div style='display:none'><div class='errorMsg' id= 'HBS_testNames_error'></div></div>
				</div>
				</div>
			</li>
			...
			<li id='cmat2' style='display:none;border-bottom:1px dotted #c0c0c0; padding-bottom:15px'>
				...
				<div class='fieldBoxLarge'>
				    <input type='text' name='cmatPercentileHBS' id='cmatPercentileHBS'         tip="Mention your Percentile in the exam. If you don't know your percentile, enter NA."   value='' allowNA='true' caption='percentile'  minlength=1  maxlength=5   validate='validateFloat'  />
				    <?php if(isset($cmatPercentileHBS) && $cmatPercentileHBS!=""){ ?>
				    <script>
					document.getElementById("cmatPercentileHBS").value = "<?php echo str_replace("\n", '\n', $cmatPercentileHBS );  ?>";
					document.getElementById("cmatPercentileHBS").style.color = "";
				    </script>
				    <?php } ?>
	    
				    <div style='display:none'><div class='errorMsg' id= 'cmatPercentileHBS_error'></div></div>
				</div>
			    </div>
		...
		<ul>
			...
			<li>
				...
				<div class='fieldBoxLarge' style="width:620px; color:#666666; font-style:italic">
					I hereby declare that all the particulars stated in this application are true to the best of my knowledge and belief. I shall abide by the rules and regulations of GITAM University. In the event of submission of incorrect or untrue information at the time of registration or in future, I understand that my admission is liable for cancellation. Further I understand that my admission is purely provisional and subject to the fulfilment of the eligibility conditions. I agree to recieve SMS on my mobile from GITAM University.
				</div>
				<div class='additionalInfoLeftCol'>
				<label>I agree to the terms stated above: </label>
				<div class='fieldBoxLarge'>
				<input type='checkbox'  validate="validateChecked" checked   required="true"   caption="Please check to accept terms"   name='HBS_agreeToTerms[]' id='HBS_agreeToTerms1'   value='1'    title="I agree to the terms stated above"   onmouseover="showTipOnline('Please check to accept terms',this);" onmouseout="hidetip();" ></input><span  onmouseover="showTipOnline('Please check to accept terms',this);" onmouseout="hidetip();" ></span>&nbsp;&nbsp;
				<?php if(isset($HBS_agreeToTerms) && $HBS_agreeToTerms!=""){ ?>
				<script>
				    objCheckBoxes = document.forms["OnlineForm"].elements["HBS_agreeToTerms[]"];
				    var countCheckBoxes = objCheckBoxes.length;
				    for(var i = 0; i < countCheckBoxes; i++){
					      objCheckBoxes[i].checked = false;
					      <?php $arr = explode(",",$HBS_agreeToTerms);
					      error_log($HBS_agreeToTerms);
						    for($x=0; $x<count($arr); $x++) { ?>
							  if(objCheckBoxes[i].value == "<?php echo $arr[$x];?>") {
								  objCheckBoxes[i].checked = true;
							  }
			      ...
			      <?php } ?>
				<div style='display:none'><div class='errorMsg' id= 'HBS_agreeToTerms1_error'></div></div>
				</div>
				</div>
			</li>
...
<script>
    ...
    for(var j=0; j<6; j++){
		checkTestScore(document.getElementById('HBS_testNames'+j));
	}
