...
<div class='formChildWrapper'>
	<div class='formSection'>
		...
		<li>
			<h3 class="upperCase">Application For:</h3>
				...
				<input type='radio' name='appliedLocation' id='appliedLocation2'   value='bothBK'     onmouseover="showTipOnline('Please select your desired XIME campus.',this);" onmouseout="hidetip();" ></input><span  onmouseover="showTipOnline('Please select your desired XIME campus.',this);" onmouseout="hidetip();" >XIME, Bangalore and Kochi</span>&nbsp;&nbsp;
	    ...
	    <?php endif; ?>
            <li>
                ...
                <div class='additionalInfoLeftCol' style="width:670px;">
                    ...
                    <div class='fieldBoxLarge' style="width:320px;">
                        ...
                        <input onClick="checkTestScore(this);" type='checkbox'  validate="validateCheckedGroup"   required="true"   caption="tests"   name='XIMEKOCHI_testNames[]' id='XIMEKOCHI_testNames3'   value='ATMA'     onmouseover="showTipOnline('Tick the appropriate box and provide test score, percentile, registration number and exam date (if available)',this);" onmouseout="hidetip();" ></input><span  onmouseover="showTipOnline('Tick the appropriate box and provide test score, percentile, registration number and exam date (if available)',this);" onmouseout="hidetip();" >ATMA</span>&nbsp;&nbsp;
            ...
            <li id='xat1' style="display:none;">
                ...
                <div class='additionalInfoRightCol'>
                    ...
                    <div class='fieldBoxLarge'>
                        <input type='text' name='xatScoreXIME' id='xatScoreXIME'         tip="Mention your percentile in the exam. If you don't know your percentile, enter NA."   value=''   allowNA='true' caption='percentile' minlength=1 maxlength=5 validate='validateFloat' />
                        <?php if(isset($xatScoreXIME) && $xatScoreXIME!=""){ ?>
                        <script>
                            document.getElementById("xatScoreXIME").value = "<?php echo str_replace("\n", '\n', $xatScoreXIME );  ?>";
                            document.getElementById("xatScoreXIME").style.color = "";
                        </script>
                        <?php } ?>

                        <div style='display:none'><div class='errorMsg' id= 'xatScoreXIME_error'></div></div>
                    </div>
                </div>
            ...
            <li id="xat2" style="display:none; border-bottom:1px dotted #c0c0c0; padding-bottom:15px">
                ...
                <div class='fieldBoxLarge'>
                <input class="textboxLarge" type='text' name='xatIdXIME' id='xatIdXIME'  validate="validateStr"    caption="regn no"   minlength="2"   maxlength="50"        tip="Mention your Registration number for the exam."   value=''   />
                <?php if(isset($xatIdXIME) && $xatIdXIME!=""){ ?>
                  <script>
                      document.getElementById("xatIdXIME").value = "<?php echo str_replace("\n", '\n', $xatIdXIME );  ?>";
                      document.getElementById("xatIdXIME").style.color = "";
                  </script>
                <?php } ?>

                <div style='display:none'><div class='errorMsg' id= 'xatIdXIME_error'></div></div>
                </div>
                </div>
            ...
            <?php
            if(isset($XIMEKOCHI_testNames) && $XIMEKOCHI_testNames!="" && strpos($XIMEKOCHI_testNames,'ATMA')!==false){ ?>
            <script>
                checkTestScore(document.getElementById('XIMEKOCHI_testNames3'));
            </script>
                <?php
            }
            ?>
			...
			<li>
				...
				<div class='additionalInfoLeftCol'>
				<label>Age as on 1/7/2014: </label>
				<div class='fieldBoxLarge'>
			...
			<li>
				<h3 class="upperCase">Languages known (other than English):</h3>
				<div class='additionalInfoLeftCol' style="width:470px">
				<label>Language: </label>
				<div class='fieldBoxSmall'>
				<input type='text' name='language1XIME' id='language1XIME'  validate="validateStr"    caption="language"   minlength="0"   maxlength="50"     tip="Enter other languages that you know (other than English)."   value=''   />
				<?php if(isset($language1XIME) && $language1XIME!=""){ ?>
				  <script>
				      document.getElementById("language1XIME").value = "<?php echo str_replace("\n", '\n', $language1XIME );  ?>";
				      document.getElementById("language1XIME").style.color = "";
				  </script>
				<?php } ?>
				
				<div style='display:none'><div class='errorMsg' id= 'language1XIME_error'></div></div>
				</div>
				</div>

				<div class='additionalInfoRightCol'>
				<div class='fieldBoxLarge'>
				<input type='checkbox' name='language1checksXIME[]' id='language1checksXIME0'   value='Read'  onmouseover="showTipOnline('Please select if you can read, write and speak the language you entered.',this);" onmouseout="hidetip();" ></input><span  onmouseover="showTipOnline('Please select if you can read, write and speak the language you entered.',this);" onmouseout="hidetip();" >Read</span>&nbsp;&nbsp;
				<input type='checkbox' name='language1checksXIME[]' id='language1checksXIME1'   value='Write'     onmouseover="showTipOnline('Please select if you can read, write and speak the language you entered.',this);" onmouseout="hidetip();" ></input><span  onmouseover="showTipOnline('Please select if you can read, write and speak the language you entered.',this);" onmouseout="hidetip();" >Write</span>&nbsp;&nbsp;
				<input type='checkbox' name='language1checksXIME[]' id='language1checksXIME2'   value='Speak'     onmouseover="showTipOnline('Please select if you can read, write and speak the language you entered.',this);" onmouseout="hidetip();" ></input><span  onmouseover="showTipOnline('Please select if you can read, write and speak the language you entered.',this);" onmouseout="hidetip();" >Speak</span>&nbsp;&nbsp;
				<?php if(isset($language1checksXIME) && $language1checksXIME!=""){ ?>
				<script>
				    objCheckBoxes = document.forms["OnlineForm"].elements["language1checksXIME[]"];
				    var countCheckBoxes = objCheckBoxes.length;
				    for(var i = 0; i < countCheckBoxes; i++){
					      objCheckBoxes[i].checked = false;

					      <?php $arr = explode(",",$language1checksXIME);
						    for($x=0;$x<count($arr);$x++){ ?>
							  if(objCheckBoxes[i].value == "<?php echo $arr[$x];?>") {
								  objCheckBoxes[i].checked = true;
							  }
				...
				<div style='display:none'><div class='errorMsg' id= 'language1checksXIME_error'></div></div>
				</div>
				</div>
			</li>
			...
			<li>
				...
				<label>Language: </label>
				<div class='fieldBoxSmall'>
				<input type='text' name='language2XIME' id='language2XIME'  validate="validateStr"    caption="language"   minlength="0"   maxlength="50"     tip="Enter other languages that you know (other than English)."   value=''   />
				<?php if(isset($language2XIME) && $language2XIME!=""){ ?>
				  <script>
				      document.getElementById("language2XIME").value = "<?php echo str_replace("\n", '\n', $language2XIME );  ?>";
				      document.getElementById("language2XIME").style.color = "";
				  </script>
				<?php } ?>
				
				<div style='display:none'><div class='errorMsg' id= 'language2XIME_error'></div></div>
				</div>
				</div>

				<div class='additionalInfoRightCol'>
				<div class='fieldBoxLarge'>
				<input type='checkbox' name='language2checksXIME[]' id='language2checksXIME0'   value='Read'    onmouseover="showTipOnline('Please select if you can read, write and speak the language you entered.',this);" onmouseout="hidetip();" ></input><span  onmouseover="showTipOnline('Please select if you can read, write and speak the language you entered.',this);" onmouseout="hidetip();" >Read</span>&nbsp;&nbsp;
				<input type='checkbox' name='language2checksXIME[]' id='language2checksXIME1'   value='Write'     onmouseover="showTipOnline('Please select if you can read, write and speak the language you entered.',this);" onmouseout="hidetip();" ></input><span  onmouseover="showTipOnline('Please select if you can read, write and speak the language you entered.',this);" onmouseout="hidetip();" >Write</span>&nbsp;&nbsp;
				<input type='checkbox' name='language2checksXIME[]' id='language2checksXIME2'   value='Speak'     onmouseover="showTipOnline('Please select if you can read, write and speak the language you entered.',this);" onmouseout="hidetip();" ></input><span  onmouseover="showTipOnline('Please select if you can read, write and speak the language you entered.',this);" onmouseout="hidetip();" >Speak</span>&nbsp;&nbsp;
				<?php if(isset($language2checksXIME) && $language2checksXIME!=""){ ?>
				<script>
				    objCheckBoxes = document.forms["OnlineForm"].elements["language2checksXIME[]"];
				    var countCheckBoxes = objCheckBoxes.length;
				    for(var i = 0; i < countCheckBoxes; i++){
					      objCheckBoxes[i].checked = false;

					      <?php $arr = explode(",",$language2checksXIME);
						    for($x=0;$x<count($arr);$x++){ ?>
							  if(objCheckBoxes[i].value == "<?php echo $arr[$x];?>") {
								  objCheckBoxes[i].checked = true;
							  }
				...
				<div style='display:none'><div class='errorMsg' id= 'language2checksXIME_error'></div></div>
				</div>
				</div>
			</li>
			...
			<li>
				...
				<label>Language: </label>
				<div class='fieldBoxSmall'>
				<input type='text' name='language3XIME' id='language3XIME'  validate="validateStr"    caption="language"   minlength="0"   maxlength="50"     tip="Enter other languages that you know (other than English)."   value=''   />
				<?php if(isset($language3XIME) && $language3XIME!=""){ ?>
				  <script>
				      document.getElementById("language3XIME").value = "<?php echo str_replace("\n", '\n', $language3XIME );  ?>";
				      document.getElementById("language3XIME").style.color = "";
				  </script>
				<?php } ?>
				
				<div style='display:none'><div class='errorMsg' id= 'language3XIME_error'></div></div>
				</div>
				</div>

				<div class='additionalInfoRightCol'>
				<div class='fieldBoxLarge'>
				<input type='checkbox' name='language3checksXIME[]' id='language3checksXIME0'   value='Read'  onmouseover="showTipOnline('Please select if you can read, write and speak the language you entered.',this);" onmouseout="hidetip();" ></input><span  onmouseover="showTipOnline('Please select if you can read, write and speak the language you entered.',this);" onmouseout="hidetip();" >Read</span>&nbsp;&nbsp;
				<input type='checkbox' name='language3checksXIME[]' id='language3checksXIME1'   value='Write'     onmouseover="showTipOnline('Please select if you can read, write and speak the language you entered.',this);" onmouseout="hidetip();" ></input><span  onmouseover="showTipOnline('Please select if you can read, write and speak the language you entered.',this);" onmouseout="hidetip();" >Write</span>&nbsp;&nbsp;
				<input type='checkbox' name='language3checksXIME[]' id='language3checksXIME2'   value='Speak'     onmouseover="showTipOnline('Please select if you can read, write and speak the language you entered.',this);" onmouseout="hidetip();" ></input><span  onmouseover="showTipOnline('Please select if you can read, write and speak the language you entered.',this);" onmouseout="hidetip();" >Speak</span>&nbsp;&nbsp;
				<?php if(isset($language3checksXIME) && $language3checksXIME!=""){ ?>
				<script>
				    objCheckBoxes = document.forms["OnlineForm"].elements["language3checksXIME[]"];
				    var countCheckBoxes = objCheckBoxes.length;
				    for(var i = 0; i < countCheckBoxes; i++){
					      objCheckBoxes[i].checked = false;

					      <?php $arr = explode(",",$language3checksXIME);
						    for($x=0;$x<count($arr);$x++){ ?>
							  if(objCheckBoxes[i].value == "<?php echo $arr[$x];?>") {
								  objCheckBoxes[i].checked = true;
							  }
				...
				<div style='display:none'><div class='errorMsg' id= 'language3checksXIME_error'></div></div>
				</div>
				</div>
			</li>
    ...
    ?>
			...
			<li>
				...
				<input type='checkbox' name='cameToKnowAboutXIME[]' id='cameToKnowAboutXIME7'   value='Shiksha' ></input><span>Shiksha.com</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<input type='checkbox' name='cameToKnowAboutXIME[]' id='cameToKnowAboutXIME0'   value='Newspaper' ></input><span>Newspaper</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<input type='checkbox' name='cameToKnowAboutXIME[]' id='cameToKnowAboutXIME1'   value='Magazine'    ></input><span >Magazine</span>&nbsp;&nbsp;
				...
				<input type='checkbox' name='cameToKnowAboutXIME[]' id='cameToKnowAboutXIME3'   value='XIME website'    ></input><span >XIME website</span>&nbsp;&nbsp;
			...
			<li>
				...
				<div class='fieldBoxLarge'>
				<input type='text' name='otherDetailsXIME' id='otherDetailsXIME'  validate="validateStr"   caption="other details"   minlength="2"   maxlength="250"     tip="Please specify from where did you hear about XIME."   value='' disabled  />
