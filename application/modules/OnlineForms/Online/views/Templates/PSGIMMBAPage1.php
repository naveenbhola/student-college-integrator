	...
	<div class='formSection'>
		...
		<ul>
			...
			<li>
				...
				<input type='checkbox'  validate="validateCheckedGroup"   required="true"   caption="courses you want to apply for"   name='PSG_course[]' id='PSG_course0'   value='MBA - German Indian Management Studies'   title="Course Applied For"   onmouseover="showTipOnline('Please select courses you want to apply for',this);" onmouseout="hidetip();" ></input><span  onmouseover="showTipOnline('Please select courses you want to apply for',this);" onmouseout="hidetip();" >MBA - German Indian Management Studies</span>&nbsp;&nbsp;<br/>

				<input type='checkbox'  validate="validateCheckedGroup"   required="true"   caption="courses you want to apply for"   name='PSG_course[]' id='PSG_course1'   value='MBA - University of Toledo'    title="Course Applied For"   onmouseover="showTipOnline('Please select courses you want to apply for',this);" onmouseout="hidetip();" ></input><span  onmouseover="showTipOnline('Please select courses you want to apply for',this);" onmouseout="hidetip();" >MBA - University of Toledo</span>&nbsp;&nbsp;
			...
			<li>
                                ...
                                <div class='fieldBoxLarge'  style="width:600px">
                                        <b>Note: </b>Application form Fees for one course is Rs. 1000 and for two courses is Rs. 2000.
                                </div>
                                </div>
			...
			<li id="cmat" style="display:none">
				...
				<div class='fieldBoxLarge'>
				<input type='text' name='cmatRankAdditional' id='cmatRankAdditional'      validate="validateStr"    caption="Rank"   minlength="1"   maxlength="50"      tip="Mention your Rank in the exam. If you don't know your rank, enter <b>NA</b>."   value=''  allowNA="true"  />
