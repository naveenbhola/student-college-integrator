<script>
  ...
  function resetExamFields(objectsArr){
	...
	<div class='formSection'>
		...
		<input validate="validateCheckedGroup" required="true" caption="Exams" onClick="checkTestScore(this);" type='checkbox' name='MIMTBSCHOOL_testNames[]' id='MIMTBSCHOOL_testNames0'   value='CAT'    onmouseover="showTipOnline('Tick the appropriate box and provide the roll number, test date and score (if available)',this);" onmouseout="hidetip();" /><span  onmouseover="showTipOnline('Tick the appropriate box and provide the roll number, test date and score (if available)',this);" onmouseout="hidetip();" >CAT</span>&nbsp;&nbsp;
		<input validate="validateCheckedGroup" required="true" caption="Exams" onClick="checkTestScore(this);" type='checkbox' name='MIMTBSCHOOL_testNames[]' id='MIMTBSCHOOL_testNames1'   value='MAT'     onmouseover="showTipOnline('Tick the appropriate box and provide the roll number, test date and score (if available)',this);" onmouseout="hidetip();" /><span  onmouseover="showTipOnline('Tick the appropriate box and provide the roll number, test date and score (if available)',this);" onmouseout="hidetip();" >MAT</span>&nbsp;&nbsp;
		
		<input validate="validateCheckedGroup" required="true" caption="Exams" onClick="checkTestScore(this);" type='checkbox' name='MIMTBSCHOOL_testNames[]' id='MIMTBSCHOOL_testNames2'   value='XAT'     onmouseover="showTipOnline('Tick the appropriate box and provide the roll number, test date and score (if available)',this);" onmouseout="hidetip();" /><span  onmouseover="showTipOnline('Tick the appropriate box and provide the roll number, test date and score (if available)',this);" onmouseout="hidetip();" >XAT</span>&nbsp;&nbsp;

                <input validate="validateCheckedGroup" required="true" caption="Exams" onClick="checkTestScore(this);" type='checkbox' name='MIMTBSCHOOL_testNames[]' id='MIMTBSCHOOL_testNames3'   value='ATMA'     onmouseover="showTipOnline('Tick the appropriate box and provide the roll number, test date and score (if available)',this);" onmouseout="hidetip();" /><span  onmouseover="showTipOnline('Tick the appropriate box and provide the roll number, test date and score (if available)',this);" onmouseout="hidetip();" >ATMA</span>&nbsp;&nbsp;
	
		<?php if(isset($MIMTBSCHOOL_testNames) && $MIMTBSCHOOL_testNames!=""){ ?>
		<script>
		    objCheckBoxes = document.forms["OnlineForm"].elements["MIMTBSCHOOL_testNames[]"];
		    var countCheckBoxes = objCheckBoxes.length;
		    for(var i = 0; i < countCheckBoxes; i++){
			      objCheckBoxes[i].checked = false;
			      <?php $arr = explode(",",$MIMTBSCHOOL_testNames);
		...
		<div style='display:none'><div class='errorMsg' id= 'MIMTBSCHOOL_testNames_error'></div></div>
		</div>
		</div>
	</li>
	...
	<?php
	    if(isset($MIMTBSCHOOL_testNames) && $MIMTBSCHOOL_testNames!="" && strpos($MIMTBSCHOOL_testNames,'CAT')!==false){ ?>
	    <script>
		    checkTestScore(document.getElementById('MIMTBSCHOOL_testNames0'));
	    </script>
	<?php
	    }
	?>
	...
	<?php
	    if(isset($MIMTBSCHOOL_testNames) && $MIMTBSCHOOL_testNames!=""){ 
		    $tests = explode(',',$MIMTBSCHOOL_testNames);
		    foreach ($tests as $test){
			  if($test=='MAT'){
	    ?>
	    <script>
		    checkTestScore(document.getElementById('MIMTBSCHOOL_testNames1'));
	    </script>
	<?php }
	      }
	    }
	...
	<?php
	    if(isset($MIMTBSCHOOL_testNames) && $MIMTBSCHOOL_testNames!="" && strpos($MIMTBSCHOOL_testNames,'XAT')!==false){ ?>
	    <script>
		    checkTestScore(document.getElementById('MIMTBSCHOOL_testNames2'));
	    </script>
	<?php
	    }
	?>
	...
	<li id="atma1" style="display:none;">
				...
				<div class='fieldBoxLarge'>
				<input type='text' name='atmaDateOfExaminationAdditional' id='atmaDateOfExaminationAdditional' readonly maxlength='10'  validate="validateDateForms"  caption="date"      tip="Mention the date on which the examination was conducted."     onmouseover="showTipOnline('Mention the date on which the examination was conducted.',this);" onmouseout="hidetip();"  onClick="var cal = new CalendarPopup('calendardiv'); cal.select($('atmaDateOfExaminationAdditional'),'atmaDateOfExaminationAdditional','dd/MM/yyyy');" />
			...
			<li id="atma2" style="display:none;">
				...
				<div class='fieldBoxLarge'>
				<input type='text' name='atmaPercentileAdditional' id='atmaPercentileAdditional'  validate="validateFloat" caption="percentile"   minlength="1"   maxlength="5"     tip="Mention your percentile in the exam. If you don't know your percentile, you can leave this field blank, enter NA."   value=''    allowNA = 'true' />
				...
				<?php
	    if(isset($MIMTBSCHOOL_testNames) && $MIMTBSCHOOL_testNames!="" && strpos($MIMTBSCHOOL_testNames,'ATMA')!==false){ ?>
	    <script>
		    checkTestScore(document.getElementById('MIMTBSCHOOL_testNames4'));
	    </script>
	<?php
	    }
	?>
			...
			<label style="font-weight:normal; padding-top:0">I hereby declare that:&nbsp;</label>
				...
				I, on admission, will adhere to the rules and discipline of Mangalmay. I have clearly understood the eligibility requirements as per norms of the course applied for and confirm that, I fulfill all the requirements for admission to this course. I hold my self responsible for the dues and prompt payment of fees. I have noted that the fees once paid are not refundable, under any circumstance. I have filled up the application a after carefully reading all the instructions given in the prospectus. I declare that the particulars furnished above are true to the best of my knowledge and belief, if anything is found untrue, my admission may be cancelled by the Institute. I also undertake that i shall not seek inter-institute transfer after admission.
				<div class="spacer10 clearFix"></div>
				<div>
				<input type='checkbox' name='MIMTBSCHOOL_agreeToTerms' id='MIMTBSCHOOL_agreeToTerms' value='1' required="true" validate="validateChecked" caption="Please agree to the terms stated above">&nbsp;I agree to the terms stated above

			      <?php if(isset($MIMTBSCHOOL_agreeToTerms) && $MIMTBSCHOOL_agreeToTerms!=""){ ?>
				<script>
				    objCheckBoxes = document.forms["OnlineForm"].elements["MIMTBSCHOOL_agreeToTerms"];
				    var countCheckBoxes = 1;
				    for(var i = 0; i < countCheckBoxes; i++){ 
					      objCheckBoxes.checked = false;
					      <?php $arr = explode(",",$MIMTBSCHOOL_agreeToTerms);
						    for($x=0;$x<count($arr);$x++){ ?>
			      ...
			      <?php } ?>
				<div style='display:none'><div class='errorMsg' id= 'MIMTBSCHOOL_agreeToTerms_error'></div></div>
  ...
  function showMoreGroups(groupId,maxAllowed){
   ...
   for(var j=0; j<4; j++){
        ...
        checkTestScore(document.getElementById('MIMTBSCHOOL_testNames'+j)); 
    } 
  </script>
