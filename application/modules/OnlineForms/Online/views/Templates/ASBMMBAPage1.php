...
understand that my application may be rejected and admission cancelled if any information provided herein is found to be incorrect at any time.
				...
				<div class='fieldBoxLarge'>
				<input type='checkbox' name='agreeToTermsASBM' id='agreeToTermsASBM'   value='1'  required="true" validate="validateChecked" caption="Please agree to the terms stated above"></input><span ><span>&nbsp;&nbsp;
				<?php if(isset($agreeToTermsASBM) && $agreeToTermsASBM!=""){ ?>
				<script>
				    objCheckBoxes = document.forms["OnlineForm"].elements["agreeToTermsASBM"];
				    var countCheckBoxes = 1;
				    for(var i = 0; i < countCheckBoxes; i++){ 
					     objCheckBoxes.checked = false;
					      <?php $arr = explode(",",$agreeToTermsASBM);
				...
				<div style='display:none'><div class='errorMsg' id= 'agreeToTermsASBM_error'></div></div>
				</div>
				</div>
			</li>
			<?php endif; ?>
