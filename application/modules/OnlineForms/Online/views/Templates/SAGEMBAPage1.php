	...
	<div class='formSection'>
		<ul>
			...
			<li>	
				...
				<div class='fieldBoxLarge'>
				<input type='checkbox' name='agreeToTermsSAGE' id='agreeToTermsSAGE'   value='1'  required="true" caption="Please agree to the terms stated above" validate="validateChecked"  ></input><span ><span>&nbsp;&nbsp;
				<?php if(isset($agreeToTermsSAGE) && $agreeToTermsSAGE!=""){ ?>
				<script>
				    objCheckBoxes = document.forms["OnlineForm"].elements["agreeToTermsSAGE"];
				    var countCheckBoxes = 1;
				    for(var i = 0; i < countCheckBoxes; i++){
					      objCheckBoxes.checked = false;

					      <?php $arr = explode(",",$agreeToTermsSAGE);
				...
				<div style='display:none'><div class='errorMsg' id= 'agreeToTermsSAGE_error'></div></div>
				</div>
				</div>
			</li>
			<?php endif; ?>
