	...
	<div class='formSection'>
		<ul> 
			...
			<?php if($action != 'updateScore'):?>
				...
				<input type='checkbox'  validate="validateCheckedGroup"   required="true"   caption="the course of your choice"   name='IIMS_program[]' id='IIMS_program0'   value='PGDM'  title="Select the course of your choice"   onmouseover="showTipOnline('Select the course you are applying to. Multiple courses can be selected.',this);" onmouseout="hidetip();" checked ></input><span  onmouseover="showTipOnline('Select the course you are applying to. Multiple courses can be selected.',this);" onmouseout="hidetip();" >PGDM</span>&nbsp;&nbsp;
				<input type='checkbox'  validate="validateCheckedGroup"   required="true"   caption="the course of your choice"   name='IIMS_program[]' id='IIMS_program1'   value='PGDM(Retail)'  title="Select the course of your choice"   onmouseover="showTipOnline('Select the course you are applying to. Multiple courses can be selected.',this);" onmouseout="hidetip();" ></input><span  onmouseover="showTipOnline('Select the course you are applying to. Multiple courses can be selected.',this);" onmouseout="hidetip();" >PGDM(Retail)</span>&nbsp;&nbsp;

                            <?php if(isset($IIMS_program) && $IIMS_program!=""){ ?>
				<script>
				    objCheckBoxes = document.forms["OnlineForm"].elements["IIMS_program[]"];
				    var countCheckBoxes = objCheckBoxes.length;
				    for(var i = 0; i < countCheckBoxes; i++){
					      objCheckBoxes[i].checked = false;

					      <?php $arr = explode(",",$IIMS_program);
				...
				<div style='display:none'><div class='errorMsg' id= 'IIMS_program_error'></div></div>
				</div>
				</div>
			...
			<li>
				...
				<div class='fieldBoxLarge' style="width:500px">
			        ...
			        <input type='checkbox'  onClick="checkTestScore(this);"  validate="validateCheckedGroup"   required="true"   caption="tests"   name='IIMS_testNames[]' id='IIMS_testNames0'   value='MHCET'     onmouseover="showTipOnline('Tick the appropriate box and provide test Registration and score (if available)',this);" onmouseout="hidetip();" ></input><span  onmouseover="showTipOnline('Tick the appropriate box and provide test Registration and score (if available)',this);" onmouseout="hidetip();" >MH-CET</span>&nbsp;&nbsp;
				<input type='checkbox'  onClick="checkTestScore(this);"  validate="validateCheckedGroup"   required="true"   caption="tests"   name='IIMS_testNames[]' id='IIMS_testNames1'   value='CMAT'     onmouseover="showTipOnline('Tick the appropriate box and provide test Registration and score (if available)',this);" onmouseout="hidetip();" ></input><span  onmouseover="showTipOnline('Tick the appropriate box and provide test Registration and score (if available)',this);" onmouseout="hidetip();" >CMAT</span>&nbsp;&nbsp;
                                <input type='checkbox'  onClick="checkTestScore(this);"  validate="validateCheckedGroup"   required="true"   caption="tests"   name='IIMS_testNames[]' id='IIMS_testNames2'   value='CAT'     onmouseover="showTipOnline('Tick the appropriate box and provide test Registration and score (if available)',this);" onmouseout="hidetip();" ></input><span  onmouseover="showTipOnline('Tick the appropriate box and provide test Registration and score (if available)',this);" onmouseout="hidetip();" >CAT</span>&nbsp;&nbsp;
                                 <input type='checkbox'  onClick="checkTestScore(this);"  validate="validateCheckedGroup"   required="true"   caption="tests"   name='IIMS_testNames[]' id='IIMS_testNames3'   value='MAT'     onmouseover="showTipOnline('Tick the appropriate box and provide test Registration and score (if available)',this);" onmouseout="hidetip();" ></input><span  onmouseover="showTipOnline('Tick the appropriate box and provide test Registration and score (if available)',this);" onmouseout="hidetip();" >MAT</span>&nbsp;&nbsp;
                                <input type='checkbox'  onClick="checkTestScore(this);"  validate="validateCheckedGroup"   required="true"   caption="tests"   name='IIMS_testNames[]' id='IIMS_testNames4'   value='XAT'     onmouseover="showTipOnline('Tick the appropriate box and provide test Registration and score (if available)',this);" onmouseout="hidetip();" ></input><span  onmouseover="showTipOnline('Tick the appropriate box and provide test Registration and score (if available)',this);" onmouseout="hidetip();" >XAT</span>&nbsp;&nbsp;
                                <input type='checkbox'  onClick="checkTestScore(this);"  validate="validateCheckedGroup"   required="true"   caption="tests"   name='IIMS_testNames[]' id='IIMS_testNames5'   value='ATMA'     onmouseover="showTipOnline('Tick the appropriate box and provide test Registration and score (if available)',this);" onmouseout="hidetip();" ></input><span  onmouseover="showTipOnline('Tick the appropriate box and provide test Registration and score (if available)',this);" onmouseout="hidetip();" >ATMA</span>&nbsp;&nbsp;
                                 
                                 <input type='checkbox'  onClick="checkTestScore(this);"  validate="validateCheckedGroup"   required="true"   caption="tests"   name='IIMS_testNames[]' id='IIMS_testNames6'   value='JMET'     onmouseover="showTipOnline('Tick the appropriate box and provide test Registration and score (if available)',this);" onmouseout="hidetip();" ></input><span  onmouseover="showTipOnline('Tick the appropriate box and provide test Registration and score (if available)',this);" onmouseout="hidetip();" >JMET</span>&nbsp;&nbsp;
		      
				
				<?php if(isset($IIMS_testNames) && $IIMS_testNames!=""){?>
				<script>
				    objCheckBoxes = document.forms["OnlineForm"].elements["IIMS_testNames[]"];
				    var countCheckBoxes = objCheckBoxes.length;
				    for(var i = 0; i < countCheckBoxes; i++){
					      objCheckBoxes[i].checked = false;

					      <?php $arr = explode(",",$IIMS_testNames);
				...
				<div style='display:none'><div class='errorMsg' id= 'IIMS_testNames_error'></div></div>
				</div>
				</div>
			</li>
			...
			<li id="mhcet2" style="display:none; border-bottom:1px dotted #c0c0c0; padding-bottom:15px">
				...
				<div class='additionalInfoRightCol'>
				<label>MH-CET Rank: </label>
				<div class='fieldBoxLarge'>
				<input type='text' name='mhcetRankAdditional' id='mhcetRankAdditional'  validate="validateInteger"    caption="Rank"   minlength="1"   maxlength="7"     tip="Mention your Rank in the exam. If you dont know your rank, you can leave this field blank."   value='' />
			...
			<li id="cmat2" style="display:none; border-bottom:1px dotted #c0c0c0; padding-bottom:15px">
				...
				<div class='fieldBoxLarge'>
				<input type='text' name='cmatRankAdditional' id='cmatRankAdditional'  validate="validateInteger"    caption="Rank"   minlength="1"   maxlength="7"     tip="Mention your Rank in the exam. If you dont know your rank, you can leave this field blank."   value='' />
			...
			<label style="font-weight:normal; padding-top:0">Declaration by Applicant:&nbsp;</label>
...
<li>I certify that all information provided on this application is complete & accurate.I agree to familarize myself with all the rules and regulations of the programme set forth by the institute & abide by them. I would uphold the standards and respect the principles of the organization for higher learning.</li>
  ...
  function showMoreGroups(groupId,maxAllowed){
   ...
   for(var j=0; j<7; j++){
        ...
        checkTestScore(document.getElementById('IIMS_testNames'+j)); 
    } 
  </script>
