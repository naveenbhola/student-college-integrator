...
<div class='formChildWrapper'>
	<div class='formSection'>
		<ul>
			...
			<li>
				...
				<input type='checkbox'  onClick="checkTestScore(this);"  validate="validateCheckedGroup"    caption="tests"   name='BIBS_testNames[]' id='BIBS_testNames0'   value='CAT'   onmouseover="showTipOnline('Tick the appropriate box and provide test Registration and score (if available)',this);" onmouseout="hidetip();" ></input><span  onmouseover="showTipOnline('Tick the appropriate box and provide test Registration and score (if available)',this);" onmouseout="hidetip();" >CAT</span>&nbsp;&nbsp;
				<input type='checkbox'  onClick="checkTestScore(this);"  validate="validateCheckedGroup"  caption="tests"   name='BIBS_testNames[]' id='BIBS_testNames1'   value='MAT'     onmouseover="showTipOnline('Tick the appropriate box and provide test Registration and score (if available)',this);" onmouseout="hidetip();" ></input><span  onmouseover="showTipOnline('Tick the appropriate box and provide test Registration and score (if available)',this);" onmouseout="hidetip();" >MAT</span>&nbsp;&nbsp;
				<input type='checkbox'  onClick="checkTestScore(this);"  validate="validateCheckedGroup"  caption="tests"   name='BIBS_testNames[]' id='BIBS_testNames2'   value='XAT'     onmouseover="showTipOnline('Tick the appropriate box and provide test Registration and score (if available)',this);" onmouseout="hidetip();" ></input><span  onmouseover="showTipOnline('Tick the appropriate box and provide test Registration and score (if available)',this);" onmouseout="hidetip();" >XAT</span>&nbsp;&nbsp;
				<input type='checkbox'  onClick="checkTestScore(this);"  validate="validateCheckedGroup"  caption="tests"   name='BIBS_testNames[]' id='BIBS_testNames3'   value='BIBSAT'     onmouseover="showTipOnline('Tick the appropriate box and provide test Registration and score (if available)',this);" onmouseout="hidetip();" ></input><span  onmouseover="showTipOnline('Tick the appropriate box and provide test Registration and score (if available)',this);" onmouseout="hidetip();" >BIBSAT</span>&nbsp;&nbsp;
				
				<?php if(isset($BIBS_testNames) && $BIBS_testNames!=""){ ?>
				<script>
				    objCheckBoxes = document.forms["OnlineForm"].elements["BIBS_testNames[]"];
				    var countCheckBoxes = objCheckBoxes.length;
				    for(var i = 0; i < countCheckBoxes; i++){
					      objCheckBoxes[i].checked = false;

					      <?php $arr = explode(",",$BIBS_testNames);
				...
				<div style='display:none'><div class='errorMsg' id= 'BIBS_testNames_error'></div></div>
				</div>
				</div>
			</li>
			...
			<li id="bibsat1" style="display:none;">
				<div class='additionalInfoLeftCol'>
				<label>BIBSAT REGN NO: </label>
				<div class='fieldBoxLarge'>
				<input class="textboxLarge" type='text' name='bibsatRollNumberAdditional' id='bibsatRollNumberAdditional'  validate="validateStr"    caption="regn no"   minlength="2"   maxlength="50"        tip="Mention your Registration number for the exam."   value=''   />
				<?php if(isset($bibsatRollNumberAdditional) && $bibsatRollNumberAdditional!=""){ ?>
				  <script>
				      document.getElementById("bibsatRollNumberAdditional").value = "<?php echo str_replace("\n", '\n', $bibsatRollNumberAdditional );  ?>";
				      document.getElementById("bibsatRollNumberAdditional").style.color = "";
				  </script>
				<?php } ?>
				
				<div style='display:none'><div class='errorMsg' id= 'bibsatRollNumberAdditional_error'></div></div>
				</div>
				</div>

				<div class='additionalInfoRightCol'>
				<label>BIBSAT Date: </label>
				<div class='fieldBoxLarge'>
				<input type='text' name='bibsatDateOfExaminationAdditional' id='bibsatDateOfExaminationAdditional' readonly maxlength='10'    validate="validateDateForms"  caption="date"      tip="Mention the date on which the examination was conducted."     onmouseover="showTipOnline('Mention the date on which the examination was conducted.',this);" onmouseout="hidetip();"  onClick="var cal = new CalendarPopup('calendardiv'); cal.select($('bibsatDateOfExaminationAdditional'),'bibsatDateOfExaminationAdditional_dateImg','dd/MM/yyyy');" />
				&nbsp;<img src='/public/images/eventIcon.gif' style='cursor:pointer' align='absmiddle' id='bibsatDateOfExaminationAdditional_dateImg' onClick="var cal = new CalendarPopup('calendardiv'); cal.select($('bibsatDateOfExaminationAdditional'),'bibsatDateOfExaminationAdditional_dateImg','dd/MM/yyyy'); return false;" />
				<?php if(isset($bibsatDateOfExaminationAdditional) && $bibsatDateOfExaminationAdditional!=""){ ?>
				  <script>
				      document.getElementById("bibsatDateOfExaminationAdditional").value = "<?php echo str_replace("\n", '\n', $bibsatDateOfExaminationAdditional );  ?>";
				      document.getElementById("bibsatDateOfExaminationAdditional").style.color = "";
				  </script>
				<?php } ?>
				
				<div style='display:none'><div class='errorMsg' id= 'bibsatDateOfExaminationAdditional_error'></div></div>
				</div>
				</div>
			</li>

			<li id="bibsat2" style="display:none; border-bottom:1px dotted #c0c0c0; padding-bottom:15px">
				<div class='additionalInfoLeftCol'>
				<label>BIBSAT Score: </label>
				<div class='fieldBoxLarge'>
				<input type='text' name='bibsatScoreAdditional' id='bibsatScoreAdditional'   validate="validateFloat"    caption="score"   minlength="1"   maxlength="5"     tip="Mention how much you scored in the exam. If the exam authorities have only declared percentiles for the exam, enter <b>NA</b>."  allowNA="true"   value=''/>
				<?php if(isset($bibsatScoreAdditional) && $bibsatScoreAdditional!=""){ ?>
				  <script>
				      document.getElementById("bibsatScoreAdditional").value = "<?php echo str_replace("\n", '\n', $bibsatScoreAdditional );  ?>";
				      document.getElementById("bibsatScoreAdditional").style.color = "";
				  </script>
				<?php } ?>
				
				<div style='display:none'><div class='errorMsg' id= 'bibsatScoreAdditional_error'></div></div>
				</div>
				</div>
				
				<div class='additionalInfoRightCol'>
				<label>BIBSAT Percentile: </label>
				<div class='fieldBoxLarge'>
				<input type='text' name='bibsatPercentileAdditional' id='bibsatPercentileAdditional'   validate="validateFloat" allowNA="true"  caption="Percentile"   minlength="1"   maxlength="5"      tip="Mention your percentile in the exam. If you don't know your percentile, enter <b>NA</b>."   value=''  />
				<?php if(isset($bibsatPercentileAdditional) && $bibsatPercentileAdditional!=""){ ?>
				  <script>
				      document.getElementById("bibsatPercentileAdditional").value = "<?php echo str_replace("\n", '\n', $bibsatPercentileAdditional );  ?>";
				      document.getElementById("bibsatPercentileAdditional").style.color = "";
				  </script>
				<?php } ?>
				
				<div style='display:none'><div class='errorMsg' id= 'bibsatPercentileAdditional_error'></div></div>
				</div>
				</div>
			</li>
		...
		<?php if($action != 'updateScore'):?>
			<li>
				...
				<div class='fieldBoxLarge'>
				<input type='checkbox'  validate="validateChecked" checked   required="true"   caption="Please check to accept terms"   name='declarationBIBS[]' id='declarationBIBS0'   value='1'    title="I agree to the terms stated above"   onmouseover="showTipOnline('Please check to accept terms',this);" onmouseout="hidetip();" ></input><span  onmouseover="showTipOnline('Please check to accept terms',this);" onmouseout="hidetip();" ></span>&nbsp;&nbsp;
				<?php if(isset($declarationBIBS) && $declarationBIBS!=""){ ?>
				<script>
				    objCheckBoxes = document.forms["OnlineForm"].elements["declarationBIBS[]"];
				    var countCheckBoxes = objCheckBoxes.length;
				    for(var i = 0; i < countCheckBoxes; i++){
					      objCheckBoxes[i].checked = false;

					      <?php $arr = explode(",",$declarationBIBS);
						    for($x=0;$x<count($arr);$x++){ ?>
							  if(objCheckBoxes[i].value == "<?php echo $arr[$x];?>") {
								  objCheckBoxes[i].checked = true;
							  }
			      ...
			      <?php } ?>
				<div style='display:none'><div class='errorMsg' id= 'declarationBIBS0_error'></div></div>
				</div>
				</div>
			</li>
			<?php endif; ?>
  ...
  <script>
    ...
    for(var j=0; j<4; j++){
		checkTestScore(document.getElementById('BIBS_testNames'+j));
	}
