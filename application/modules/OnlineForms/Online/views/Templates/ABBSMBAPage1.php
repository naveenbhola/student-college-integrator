<script>
	...
	<div class='formSection'>
		<ul> 
			...
			<li>
				...
				<input type='checkbox'  onClick="checkTestScore(this);"  validate="validateCheckedGroup"   required="true"   caption="tests"   name='ABBS_testNames[]' id='ABBS_testNames0'   value='CAT'   onmouseover="showTipOnline('Tick the appropriate box and provide test Registration and score (if available)',this);" onmouseout="hidetip();" ></input><span  onmouseover="showTipOnline('Tick the appropriate box and provide test Registration and score (if available)',this);" onmouseout="hidetip();" >CAT</span>&nbsp;&nbsp;
				<input type='checkbox'  onClick="checkTestScore(this);"  validate="validateCheckedGroup"   required="true"   caption="tests"   name='ABBS_testNames[]' id='ABBS_testNames1'   value='MAT'     onmouseover="showTipOnline('Tick the appropriate box and provide test Registration and score (if available)',this);" onmouseout="hidetip();" ></input><span  onmouseover="showTipOnline('Tick the appropriate box and provide test Registration and score (if available)',this);" onmouseout="hidetip();" >MAT</span>&nbsp;&nbsp;
				<input type='checkbox'   onClick="checkTestScore(this);" validate="validateCheckedGroup"   required="true"   caption="tests"   name='ABBS_testNames[]' id='ABBS_testNames2'   value='CMAT'     onmouseover="showTipOnline('Tick the appropriate box and provide test Registration and score (if available)',this);" onmouseout="hidetip();" ></input><span  onmouseover="showTipOnline('Tick the appropriate box and provide test Registration and score (if available)',this);" onmouseout="hidetip();" >CMAT</span>&nbsp;&nbsp;
				<?php if(isset($ABBS_testNames) && $ABBS_testNames!=""){ ?>
				<script>
				    objCheckBoxes = document.forms["OnlineForm"].elements["ABBS_testNames[]"];
				
				    var countCheckBoxes = objCheckBoxes.length;
				    for(var i = 0; i < countCheckBoxes; i++){
					      objCheckBoxes[i].checked = false;

					      <?php $arr = explode(",",$ABBS_testNames);
				...
				<div style='display:none'><div class='errorMsg' id= 'ABBS_testNames_error'></div></div>
				</div>
				</div>
			</li>
		...
		<li id="cat2" style="display:none; border-bottom:1px dotted #c0c0c0; padding-bottom:15px">
			...
			<li>
				...
				?>
				I hereby declare that I have known the financial obligation of my ward and I can afford to pay all the costs and I undertake to pay the tution and other fees payable to the College under the rules in force & which may be framed from time to time by the Management. 
				I have read all the rules and conditions my ward has to follow and agree to the applicant's admission to First Year Class. I shall be responsible for his/her good conduct, attendance and discipline during the period of his/her stay in the College.
				I understand thaht the promotion to the next higher class is not automatic. I assure that my ward will not indulge in any act which will tarnish the image of the College. If he/she does so he/she may be expelled from the College. I will not have any
				claim whatsoever for the refund of fees, if my ward leaves the College on his/her own will or expelled by the College for breach of conduct, discipline or rules of the College. If discontinued from the course inbetween, I agree to pay the entire course fee due from my ward's admission.
				I stand by the admission/approval rules of the concerned University and stand to oblige by it and its regulations. I also stand by the declaration given by my son/daughter to the college.
				</div>
				<div class="spacer10 clearFix"></div>
				<div class='additionalInfoLeftCol'>
				<label>I agree to the terms stated above: </label>
				<div class='fieldBoxLarge'>
				<input type='checkbox' name='agreeToTermsABBS' id='agreeToTermsABBS'  value='1'  required="true" caption="Please agree to the terms stated above" validate="validateChecked"></input><span ><span>&nbsp;&nbsp;
				<?php if(isset($agreeToTermsABBS) && $agreeToTermsABBS!=""){ ?>
				<script>
				    objCheckBoxes = document.forms["OnlineForm"].elements["agreeToTermsABBS"];
				    var countCheckBoxes = 1;
				    for(var i = 0; i < countCheckBoxes; i++){
					      objCheckBoxes.checked = false;
					      <?php $arr = explode(",",$agreeToTermsABBS);
						    for($x=0;$x<count($arr);$x++){ ?>
				...
				<div style='display:none'><div class='errorMsg' id= 'agreeToTermsABBS_error'></div></div>
				</div>
				</div>
			</li>
			<?php endif; ?>
  ...
  function showMoreGroups(groupId,maxAllowed){
   ...
   for(var j=0; j<3; j++){ 
        checkTestScore(document.getElementById('ABBS_testNames'+j)); 
    } 
  </script>
