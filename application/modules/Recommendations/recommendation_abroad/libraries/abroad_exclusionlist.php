...
class Abroad_ExclusionList
{
	...
	function getExclusionListFromRecommendations($users)
	{
		...
		$applied_courses = $this->_ci->abroad_recommendation_model->getAppliedCourses($users,RECO_NUM_DAYS);
		...
		$recommendations_sent_last_mail = $this->_ci->abroad_recommendation_model->getRecommendationsSent($users,3);
