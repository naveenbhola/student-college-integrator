<?php 
	...
	$shortDisplayName = (strlen($leaderBoardInfo['firstname'].' '.$leaderBoardInfo['lastname']) > 14)?substr($leaderBoardInfo['firstname'].' '.$leaderBoardInfo['lastname'],0,14).'...':$leaderBoardInfo['firstname'].' '.$leaderBoardInfo['lastname'];
