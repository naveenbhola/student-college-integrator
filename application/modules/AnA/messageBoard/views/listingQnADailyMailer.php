...
<br />
Dear user<br /><br />
<?php echo $noOfQuestions; ?> new questions about <a href="<?php echo $ListingUrl; ?>" target="_blank"><?php echo $listingTitle; ?></a> have been posted on Shiksha today.<br /><br />
Answer queries about your institute and connect with prospective student directly.<br /><br />
<a href="<?php echo $urlToBeSentInMail; ?>" target="_blank">Login here</a> to answer the questions.<br /><br />
...
?>
	&diams; &nbsp; <a href="<?php echo $temp['url']; ?>" target="_blank"><?php echo $temp['msgTxt']; ?></a><br /><br />
<?php
	endforeach;
?><br /><br />
