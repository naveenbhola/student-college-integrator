    	...
    	<div>
            ...
            <div style="margin-right:249px">
            	<div class="float_L" style="width:100%">
                    ...
                    <div style="width:100%" id="confirmationMessageContainerForQuestion">
                    	<div class="shik_confirmationMsg">
                        	<div style="width:100%">
                            	<div class="float_L" style="width:96%">
                                	<div style="width:100%">
                                    	<div><b>Your question has been successfully posted</b></div>
                                        <div style="padding-top:8px">Points Consumed: <b>10</b>
                                ...
                                <div class="float_L" style="width:4%">
                                	<div><a href="javascript:void(0);" class="spirit_header shik_crossButton" style="text-decoration:none" onClick="javascript:showDiv(new Array('confirmationMessageContainerForQuestion'),-1);">&nbsp;</a></div>
                                </div>
                    ...
                    <!--Start_Question_And_Answer-->
						<?php
							$data = array('typeOfPage' => 'question');
							$this->load->view('messageBoard/questionListingForActivityLandingPage',$data);
						?>
                    <!--End_Question_And_Answer-->
                    <div class="defaultAdd lineSpace_10">&nbsp;</div>
                    <!--Start_Recently_Question-->
						<?php $this->load->view('messageBoard/recentQuestion'); ?>
                    <!--End_Recently_Question-->
					<div class="defaultAdd lineSpace_10">&nbsp;</div>
						<?php
            				$bannerProperties1 = array('pageId'=>'QUESTION_POST_SUCCESS', 'pageZone'=>'FOOTER');
