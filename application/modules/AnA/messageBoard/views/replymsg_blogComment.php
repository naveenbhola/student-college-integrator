...
<div class="fbkBx" id="completeMsgContent<?php echo $msgId; ?>" <?php if(isset($isWall) && $isWall==1 && $actionToBePerformed == 'addComment') echo "style='width:490px;'";?>>
	<div class="<?php echo $ansDivClass; ?> wdh100">
		...
		<div style="margin:0 5px 0 62px;">
				<div>
				  ...
				  <span style="padding-bottom:10px;position:relative" id="msgTxtContent<?php echo $msgId; ?>" class="<?php echo $userAnswerForQuestionDetail; ?> lineSpace_18">
					  <?php 
				...
				<div class="float_L fcdGya">a few secs ago</span></div>
