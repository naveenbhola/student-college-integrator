<?php
	...
	function getDisplayNameText($userId, $entityUserId, $displayName, $vcardStatus)
	{
		...
		$userDisplayText = '<a onclick = "trackEventByGA(\'homepagecafetickerclick\',this.innerHTML)" href="'.$userProfile.$displayName.'">'.$displayName.'</a>';
...
<?php $homeUrl = SHIKSHA_ASK_HOME; ?>
<!-- Top Div Start -->
<div>
	<div style="display:none;" id="abuseFormText"></div>
	<div style="font-size:17px"><b>Cafe Buzz!</b> Latest from Shiksha Cafe</div>
	<div class="lineSpace_5"></div>
	<!-- Container Div Start -->
	<div style="position:relative;height:245px;margin-left:10px;overflow:hidden;cursor:pointer;" onClick="window.location='<?php echo $homeUrl;?>';">
<?php
	for($i=0;$i<count($questionList);$i++)
	{
		...
		if(isset($questionList[$i][0]['alreadyAnswered']) && ($questionList[$i][0]['alreadyAnswered'] > 0)){
			$ansNowLink = '<div class="normaltxt_11p_blk "><img src="/public/images/greenChk.gif" align="absmiddle" />&nbsp;<a href="'.$questionUrl.'"  style="color:#000000;" onclick = "trackEventByGA(\'homepagecafetickerclick\',this.innerHTML)">You have already answered this question</a></div>';
		}
		...
		$questionUserDisplayTextForHeading = '<a onclick = "trackEventByGA(\'homepagecafetickerclick\',this.innerHTML)" href="'.$userProfile.$questionUserDisplayName.'">'.$questionUserDisplayName.'\'s</a>';
		$questionUserDisplayText = getDisplayNameText($userId, $questionUserId, $questionUserDisplayName, $questionVCardStatus);
		$questionUserLevelText = '<span class=\'forA \'><a onclick = "trackEventByGA(\'homepagecafetickerclick\',this.innerHTML)" href="/shikshaHelp/ShikshaHelp/upsInfo">'.$questionUserLevel.'</a></span>';
		...
		$answerUserDisplayTextForHeading = '<a onclick = "trackEventByGA(\'homepagecafetickerclick\',this.innerHTML)" href="'.$userProfile.$answerUserDisplayName.'">'.$answerUserDisplayName.'\'s</a>';
		$answerUserDisplayText = getDisplayNameText($userId, $answerUserId, $answerUserDisplayName, $answerVCardStatus);
		$answerUserLevelText = '<span class=\'forA \'><a onclick = "trackEventByGA(\'homepagecafetickerclick\',this.innerHTML)" href="/shikshaHelp/ShikshaHelp/upsInfo">'.$answerUserLevel.'</a></span>';
		$raterUserDisplayText = getDisplayNameText($userId, $raterUserId, $raterUserDisplayName, $raterVCardStatus);
		$raterUserLevelText = '<span class=\'forA \'><a onclick = "trackEventByGA(\'homepagecafetickerclick\',this.innerHTML)" href="/shikshaHelp/ShikshaHelp/upsInfo">'.$raterUserLevel.'</a></span>';
		$commenterUserDisplayText = getDisplayNameText($userId, $commenterUserId, $commenterUserDisplayName, $commenterVCardStatus);
		$commenterUserLevelText = '<span class=\'forA \'><a onclick = "trackEventByGA(\'homepagecafetickerclick\',this.innerHTML)" href="/shikshaHelp/ShikshaHelp/upsInfo">'.$commenterUserLevel.'</a></span>';
		...
		$listingTitle='';
		$heightOfText = 'height:26px;overflow:hidden;';
		$heightOfTitle = 'height:13px;overflow:hidden;line-height:18px';
?>
	<!-- Main Div Start -->
	<div class="aqAns" style="position:absolute;height:50px; width:480px; padding-top:5px;padding-bottom:5px;left:0px;top:<?php echo ( (($showCount-$displayEntries)*(-1)) * 60);?>px;<?php if($showCount>$displayEntries) echo 'opacity:0; display:none;';?>" id="wish<?php echo $showCount?>" onclick = "trackEventByGA('homepagecafetickerclick','COMPELTE_TICKER_CLICK');">
		...
		<div class="wdh100">
			...
			<div class="imgBx">
				<?php if($userId == $userImageURLOwnerId){ ?>
				  <img id="<?php echo 'userProfileImageForAnswer'.$questionList[$i][0]['msgId'];?>" src="<?php echo getTinyImage($userImageURL);?>" onclick="trackEventByGA('homepagecafetickerclick',this.innerHTML);"/>
				<?php }else{ ?>
				  <img src="<?php echo getTinyImage($userImageURL);?>" 
onclick="trackEventByGA('homepagecafetickerclick',this.innerHTML);"/>
				<?php } ?>
			</div>
				...
				<div class="wdh100 float_L">
					...
					<?php 
						switch($questionList[$i]['type']){
							case 'question':
								  echo "<div style='padding-bottom:4px;".$heightOfTitle."'><b>".$questionUserDisplayText."</b>&nbsp;".$questionUserLevelText." <b>asked</b> a question <span class='grayFont'>".makeRelativeTime($questionList[$i][0]['creationDate'])."</span></div>";
							...
							case 'discussioncomment':
								  ...
								  echo "<div style='padding-bottom:4px;".$heightOfTitle."'><b>".$commenterUserDisplayText."</b>&nbsp;".$commenterUserLevelText." <b>commented</b> on ".$displayNameString." discussion post &nbsp;<span class='grayFont'>".makeRelativeTime($questionList[$i][$userCommentTimeDisplayNumber]['creationDate'])."</span></div>";
							...
							case 'announcement':
								  ...
								  echo "<div style='padding-bottom:4px;".$heightOfTitle."'><b>".$questionUserDisplayText."</b>&nbsp;".$questionUserLevelText." <b>posted</b> <a href='".$questionList[$i][0]['url']."' $questionFontStyle>".$questionList[$i][0]['msgTxt']."</a> <span class='grayFont'>".makeRelativeTime($questionList[$i][0]['creationDate'])."</span></div>";
								  $discussionText = html_entity_decode(html_entity_decode($questionList[$i][0]['description'],ENT_NOQUOTES,'UTF-8'));
							...
							case 'announcementcomment':
								  ...
								  echo "<div style='padding-bottom:4px;".$heightOfTitle."'><b>".$commenterUserDisplayText."</b>&nbsp;".$commenterUserLevelText." <b>commented</b> on ".$displayNameString." post &nbsp;<span class='grayFont'>".$time."</span></div>";
								  $discussionCText = html_entity_decode(html_entity_decode($questionList[$i][$userCommentTimeDisplayNumber]['msgTxt'],ENT_NOQUOTES,'UTF-8'));
								  $discussionCText = substr($discussionCText, 0, 197);
								  echo "<div ".$questionFontClass." style='".$heightOfText."'>".$discussionCText."</div></a>";
								  break;
							case 'answer':
								  echo "<div style='padding-bottom:4px;".$heightOfTitle."'><b>".$answerUserDisplayText."</b>&nbsp;".$answerUserLevelText." <b>answered</b> ".$questionUserDisplayTextForHeading." question <span class='grayFont'>".makeRelativeTime($questionList[$i][1]['creationDate'])."</span></div>";
							...
							case 'rating':
								  ...
								  echo "<div style='padding-bottom:4px;".$heightOfTitle."'><b>".$raterUserDisplayText."</b>&nbsp;".$raterUserLevelText.$showOtherRating." <b>upvoted <img src='/public/images/hUp.gif'/> </b>".$answerUserDisplayTextForHeading." answer <span class='grayFont'>".makeRelativeTime($questionList[$i]['sortingTime'])."</span></div>";
								  $answerText = html_entity_decode(html_entity_decode($answerText,ENT_NOQUOTES,'UTF-8'));
								  $answerText = formatQNAforQuestionDetailPage(substr($answerText,0,197),300); 
								  echo "<div ".$answerFontClass." style='".$heightOfText."'>".$answerText."</div>";
								  break;
							case 'bestanswer':
								  echo "<div style='padding-bottom:4px;height:12px;overflow:hidden;'><b>".$answerUserDisplayText."</b>&nbsp;".$answerUserLevelText." your answer is selected as <b>\"The Best Answer\"</b> by ".$questionUserDisplayText."</div>";
								  $answerText = html_entity_decode(html_entity_decode($answerText,ENT_NOQUOTES,'UTF-8'));
								  $answerText = formatQNAforQuestionDetailPage(substr($answerText,0,197),300); 
								  echo "<div ".$answerFontClass." style='".$heightOfText."'>".$answerText."</div>";
								  break;
							case 'comment':
								  ...
								  echo "<div style='padding-bottom:4px;".$heightOfTitle."'><b>".$commenterUserDisplayText."</b>&nbsp;".$commenterUserLevelText." <b>commented</b> on ".$displayNameString." answer <span class='grayFont'>".makeRelativeTime($questionList[$i][$commentNumberToDisplay]['creationDate'])."</span></div>";
								  $discussionCText = html_entity_decode(html_entity_decode($questionList[$i][$userCommentTimeDisplayNumber]['msgTxt'],ENT_NOQUOTES,'UTF-8'));
								  $discussionCText = formatQNAforQuestionDetailPage(substr($discussionCText, 0, 197),300);
								  echo "<div ".$questionFontClass." style='".$heightOfText."'>".$discussionCText."</div></a>";
								  break;
...
<div class="lineSpace_5"></div>
<div><b><a onclick="trackEventByGA('homepagecafetickerclick',this.innerHTML);" href='<?php echo $homeUrl;?>'>View all activities &#187</a></b></div>
