	...
	<?php } else { ?>
	    ...
	    <?php $counter = 1; foreach ($forms as $form):?>
	        <tr <?php if ($counter%2 == 0) {echo 'class="alt-row"';} $counter++; ?>>
	            ...
	            <td><?php echo $allAdminData[$form['createdBy']]['displayname']; ?></td>
	            <td><a href='/mailer/MarketingFormMailer/MIS/<?php echo $form['fid']; ?>' target='_blank' class='mislink'>MIS</a></td>
				<td><a href='/mailer/MarketingFormMailer/HtmlSnippet/<?php echo $form['id']; ?>' class='htmllink'>HTML</a></td>
				<td><a href='/mailer/MarketingFormMailer/EditForm/<?php echo $form['id']; ?>'><img src='https://www.shiksha.com/public/images/edit-icn.gif' /></a></td>
