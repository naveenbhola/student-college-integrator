<form name="mail" action="delete/<?php echo $type; ?>"   id="mainMailForm" onsubmit="return confirmAction();" method="post" >
	<div id="mid_Panel_inbox">
		...
		<div style="display:inline; float:left; width:100%">
			<div class="normaltxt_11p_blk_arial"><span class="fontSize_18p OrgangeFont bld">Trash</span>
			...
			<div class="row">
				...
				<div class="buttr2">
					<button class="btn-submit5 w6" type="submit" onclick="restoreMails();">
			...
			<div id="mail_container">
				...
				<?php //echo "<pre>";print_r($mail);echo "</pre>"; ?>
				<div>
					<div class="">
						<div class="lineSpace_10">&nbsp;</div>
						<div class="normaltxt_11p_blk_arial">
							...
							<div class="float_L" style="width:29%;">
								<div><img src="<?php echo $userDetails[$mail['senders_id']]['avtarimageurl'];?>" align="left" height="60" width="60"/><span class="mar_left_5p <?php echo $readClass;?>"><a href="<?php echo site_url()."getUserProfile/".$userDetails[$mail['senders_id']]['displayname']; ?>"><?php echo $userDetails[$mail['senders_id']]['displayname'];?></a></span></div>
							</div>
							<div class="float_L" style="width:48%;">													
								<div class="disBlock mar_full_8p"><a href="#" class="bld" onClick="showMail('trash',<?php echo $mail['mail_ids'][0];?>);"><?php $s=($mail['subject']!="")? $mail['subject']: "(no subject)";echo $s; ?></a></div>
								<div class="lineSpace_5"></div>
				...
				<?php endforeach; ?>
				<?php else: ?>
				<span class="normaltxt_11p_blk_arial fontSize_18p OrgangeFont bld" style="margin:10px 0px 10px 30px">You have no messages in the Trash</span>
				<?php endif;?>
			</div>
