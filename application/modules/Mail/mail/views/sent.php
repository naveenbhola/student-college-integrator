<form name="mail" action="delete/<?php echo $type; ?>"  id="mainMailForm" onsubmit="return confirmAction();" method="post" >
	<div id="mid_Panel_inbox">
		...
		<div style="display:inline; float:left; width:100%">
			<div class="normaltxt_11p_blk_arial"><span class="fontSize_18p OrgangeFont bld">Sent</span>
			...
			<div>			
				<div class="brdpink_box">
					<div class="normaltxt_11p_blk_arial">
						<div class="float_L brdright_b h28 bgpink_box" style="width:27px;"><span class="disBlock mar_top_4p mar_left_5p"><input type="checkbox" name="main" onclick="check(this,'mail_container');" value="yes" />&nbsp;</span></div>
			...
			<div id="mail_container">
					...
					<div class="">
						...
						<div class="normaltxt_11p_blk_arial">
							...
							<div class="float_L" style="width:48%;">													
								<div class="disBlock mar_full_8p"><a href="#" class="bld" onClick="showMail('sent',<?php echo $mail['mail_ids'][0];?>);"><?php $s=($mail['subject']!="")? $mail['subject']: "(no subject)";echo $s; ?></a></div>
								<div class="lineSpace_5"></div>
				...
				<?php endforeach; ?>
				<?php else: ?>
				<span class="normaltxt_11p_blk_arial fontSize_18p OrgangeFont bld" style="margin:10px 0px 10px 30px">You have no messages in the Sent</span>
				<?php endif;?>
			</div>
