...
<tr>
  ...
  <td width="508" align="center"><table border="0" cellspacing="0" cellpadding="0" style="font-family:Arial; font-size:14px; color:#444648; line-height:18px; text-align:left;" width="100%">
      ...
      <tr>
        <td width="508">Dear <?php echo $username; ?>,
          <br />
          <p><?php echo $raterDisplayName;?> has upvoted your answer.<br/></p>
          <p><b>Your answer:</b> <?php echo $answer;?></p>
          <p>Please <a href='<?php echo $linkDetailPage;?><!-- #AutoLogin --><!-- AutoLogin# -->'>click here</a> to see and rate all other answers to <?php echo $questionUsername;?>'s question.</p>
          <p>We extremely value the contribution and efforts you have taken to help students on <a href='<?php echo $link;?><!-- #AutoLogin --><!-- AutoLogin# -->'>Shiksha Caf&#233;</a> in making the right career choices and would look forward for a continued patronage.</p>
          <br/>
        </td>
      </tr>
    </table></td>
