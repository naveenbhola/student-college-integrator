...
<tr>
  ...
  <td width="508" align="center"><table border="0" cellspacing="0" cellpadding="0" style="font-family:Arial; font-size:14px; color:#444648; line-height:18px; text-align:left;" width="100%">
      ...
      <tr>
        <td width="508"><p>Dear <?php echo ucfirst($name).' '.ucfirst($lastname); ?>,</p>
          <p>Your question has been successfully posted to <?php echo ucfirst($campusRepName[0]['firstname']).' '.ucfirst($campusRepName[0]['lastname']);?> who is a current student of <?php echo $instituteName; ?>. We will notify you as soon as we receive an answer from him/her.</p>
          <p>&nbsp;</p>
        </td>
      </tr>
    </table></td>
