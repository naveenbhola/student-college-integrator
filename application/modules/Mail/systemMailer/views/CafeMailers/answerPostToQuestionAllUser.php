...
<tr>
  ...
  <td width="508" align="center"><table border="0" cellspacing="0" cellpadding="0" style="font-family:Arial; font-size:14px; color:#444648; line-height:18px; text-align:left;" width="100%">
      ...
      <tr>
        <td width="508">Dear <?php echo $NameOfUser; ?>,
          <br />
...
<p>If you like this answer <a href="<?php echo $ratingUrl;?><!-- #AutoLogin --><!-- AutoLogin# -->">click here to give it a thumbs up <img src="<?php echo SHIKSHA_HOME_URL;?>/public/images/digUp.gif" border="0" alt="Shiksha.com" height="20" width="20"/></a>.</p>
<p>However if you find it objectionable or inappropriate, please <a href="<?php echo $seoUrl;?><!-- #AutoLogin --><!-- AutoLogin# -->">click here to Report it as abuse</a> and help keep Shiksha.com clean.</p>
          <br/>
        </td>
      </tr>
    </table></td>
