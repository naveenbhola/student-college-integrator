          ...
          <tr>
            ...
            <td width="524" align="center">
            	<table border="0" cellspacing="0" cellpadding="0" style="font-family:Arial; font-size:14px; color:#444648; line-height:18px; text-align:left;" width="100%">
                  ...
                  <tr>
                    <td width="524">A new task has been added for you to participate. Click on the below link to know more about the task and start making submissions.</td>
		    </tr>
		  <tr>
			<tr><td height="15"></td></tr>
		    <td width="524"><a href="<?=$urlOfLandingPage;?><!-- #AutoLogin --><!-- AutoLogin# -->"><?=$taskName?></a></td>
                  </tr>
		  <tr><td height="15"></td></tr>
