     <td width="564" bgcolor="#ffffff" align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-family:Arial; font-size:14px; color:#585c5f; text-align:left;">
        ...
        <tr>
          ...
          <td width="508" align="center"><table border="0" cellspacing="0" cellpadding="0" style="font-family:Arial; font-size:14px; color:#444648; line-height:18px; text-align:left;" width="100%">
              ...
              <tr>
                <td width="508">Congratulations <?php echo ucwords($userDetails['firstname']);?>,<br />
                  <br />
                  You have been accepted for the mentorship programme from <?php echo $courseName;?> in <?php echo $courseObj->getInstituteName();?>.<br />
                  <br />
                  You can now guide prospective engineering students to make the right decision. You also stand to win gifts and certificate of recognition for your efforts.</td>
              </tr>
            </table></td>
          <td width="28"><img src="<?php echo IEPLADS_DOMAIN; ?>/mailers/2013/shiksha/verify3oct/images/spacer.gif" width="10" height="1" vspace="0" hspace="0" align="left" /></td>
        </tr>
        ...
        <tr>
		<td></td>
		<td width="508" style=" height:10px;">
            </td>
	</tr>
	...
	<tr>
		<td></td>
		<td width="508">
                  *You can answer questions, complete tasks and keep track of your performance on your dashboard.
            </td>
	</tr>
        <tr>
	...
	<tr>
		<td></td>
		<td width="508">
                  *You can change your password by visiting Accounts and Settings on your dashboard.
            </td>
	</tr>
        <tr>
