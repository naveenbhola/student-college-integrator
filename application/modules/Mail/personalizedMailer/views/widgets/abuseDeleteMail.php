            ...
            <tr>
              ...
              <td>
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td style="font-family:open sens, Tahoma, Helvetica, sans-serif; font-size:11px; line-height:22px; color:#999999;">One of the <?php echo $entityType;?> you posted on <a href="<?php echo $sectionURL;?><!-- #AutoLogin --><!-- AutoLogin# -->"><?php echo $section;?></a> has been removed from the site on account of abuse reports by community members and moderator.</td>
                  </tr>
