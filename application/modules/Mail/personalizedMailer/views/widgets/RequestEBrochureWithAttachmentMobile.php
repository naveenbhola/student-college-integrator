...
<tr>
  <td align="left" style=" font-family:Arial, Helvetica, sans-serif; color: #333333; font-size:12px;">The <?php echo $mailContentSecondLineText;?>brochure for <strong><?php echo htmlentities($courseName);?> at <?php echo htmlentities($instituteName);?></strong> is attached with this mail. </td>
</tr>
<?php if($clientMsg !='') { ?>
<tr>
  <td height="10"></td>
