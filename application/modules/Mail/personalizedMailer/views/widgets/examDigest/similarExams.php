...
<tr>
			...
			<?php 
			$similarExamLoopCount = 0;
                        foreach($similarExams as $key=>$data){
				if(($totalSimilarExamCount-$similarExamLoopCount)==1 && $isViewLink==1){ ?>
                                         <tr>
                       ...
                       <td valign="top" colspan="2" align="left"><a href="<?php echo $data['url'];?><!-- #AutoLogin --><!-- AutoLogin# -->" target="_blank" style="font-family:Arial, Helvetica, sans-serif; font-size:13px; color:#03818d; text-decoration:none;text-align:left;"><?php echo htmlentities($data['examName']);?></a></td>
                      </tr>
		      <?php if(($totalSimilarExamCount-$similarExamLoopCount==1) && $isViewLink==1){ ?>
                                <tr>
                      ...
                      <tr>
                        <td valign="top" colspan="3">
                          <table width="130" border="0" align="left" cellpadding="0" cellspacing="0" style="border-collapse:collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;border:1px solid #03818d;">
                            <tr>
                              <td height="25" align="center"><a href="<?php echo $viewAllLink;?><!-- #AutoLogin --><!-- AutoLogin# -->" target="_blank" style="font-family:Arial, sans-serif; color:#03818d; font-size:12px;display:block; line-height:25px; font-weight:bold; text-decoration:none;text-align:center;">View All Exams</a></td>
