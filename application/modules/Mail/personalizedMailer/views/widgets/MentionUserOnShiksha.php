            ...
            <tr>
              ...
              <td>
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td style="font-family:open sens, Tahoma, Helvetica, sans-serif; font-size:11px; color:#666666;">Dear <?php echo ucwords($mentioningUserName); ?>,</td>
                  </tr>
                  <tr>
                    <td height="15"></td>
                  </tr>
                  <tr>
                    <td style="font-family:open sens, Tahoma, Helvetica, sans-serif; font-size:11px; line-height:22px; color:#999999;"><?php echo $userName;?> has just mentioned you in 
                      <?php 
                      switch($typeOfEntity){
                      ...
                      ?>
                      .<br/>
                      <?php echo $userName;?>: <?php echo $text;?></td>
                  </tr>
                  <tr>
                    <td height="15"></td>
                  </tr>
                  <tr>
                    <td style="font-family:open sens, Tahoma, Helvetica, sans-serif; font-size:11px; line-height:22px; color:#999999;"><a href="<?php echo $link;?><!-- #AutoLogin --><!-- AutoLogin# -->">View entire thread</a> </td>
                  </tr>
            <tr>
                    <td height="10"></td>
                  </tr>
