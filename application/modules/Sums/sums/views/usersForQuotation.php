            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="3" bordercolor="#EEEEEE">
                ...
                <tr>
                    <td height="20" colspan="7" align="right">
                        <?php if($forListingPost){ ?>
                        <input type="button" value="Post College/Course" onclick="$('frmSelectUser').action='/index.php/enterprise/Enterprise/addCourseCMS';validateFormSums();">
                        <input type="button" value="Post Scholarship" onclick="$('frmSelectUser').action='/index.php/enterprise/Enterprise/addScholarshipCMS';validateFormSums();">
                        <input type="button" value="Post Notification" onclick="$('frmSelectUser').action='/index.php/enterprise/Enterprise/addAdmissionCMS';validateFormSums();">
                        <?php }else{ ?>
                        <button class="btn-submit19" onclick="$('frmSelectUser').action='/sums/Manage/getProducts/<?php echo $prodId; ?>';validateFormSums();" type="button" value="" style="width:190px">
                            <div class="btn-submit19"><p style="padding: 15px 8px 15px 5px;color:#FFFFFF; font-size:12px" class="btn-submit20">Select Product & Currency</p></div>
                        </button>
                        <?php } ?>
                    </td>
                </tr>
