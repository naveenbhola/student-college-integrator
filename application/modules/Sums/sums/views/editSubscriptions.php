<?php
    $headerComponents = array(
        ...
        'title'      =>        'SUMS - Edit/Update Subscriptions for Transacion Id: '.$transactionId.'',
        'tabName'          =>        'Register',
...
<div class="mar_full_10p">
        ...
        The following Subscriptions belong to Transaction Id: <b><?php echo $transactionId; ?></b>
        </div>
...
function fetchLatestSubsForTrans(){
    var transId = '<?php echo $transactionId; ?>';
    var flowType = '<?php echo $flowType; ?>';
    var data = "TransactionId="+transId+"&flowType="+flowType;
    new Ajax.Updater('populateTransacts','/sums/Subscription/fetchSubsForTrans/',{onBeforeAjax:beforeAjax(),parameters:(data),onComplete:function(){
...
function changeDates(id){
    ...
    if(dateSanity){
        var con = confirm("This action will change this Subscription's Dates.Are you sure to continue?");
        if(con){
            ...
            var data = "SubscriptionId="+subsId+"&startDate="+startDate+"&endDate="+endDate+"&status="+statu;
            new Ajax.Request('/sums/Subscription/changeSubsDates/',{method:'post',onBeforeAjax:beforeAjax(),parameters:(data),onSuccess:function(xmlHttp){
                    hideDataLoader($('populateTransacts'));
