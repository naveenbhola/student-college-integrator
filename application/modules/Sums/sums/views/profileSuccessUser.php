<?php
    $headerComponents = array(
        ...
        'title'      =>        'SUMS - User profile addition Success Page',
        'tabName'          =>        'Register',
...
<div class="mar_full_10p">
    ...
    <div style="margin-left:233px">		
        <div>
            ...
            <center>
                <h2 class="arial">
                    Profile of Employee <font class="OrgangeFont"><?php echo $userDetails['EmployeeId']; ?></font>  has been added successfully.</font>
                </h2>
            </center>
	   ...
	   <center>
                <h2 class="arial">
                    Sorry, This User already exist, Please try to add a different user.</font>
                </h2>
            </center>
		<?php } ?>
        </div>
