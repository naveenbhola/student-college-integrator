...
<script>
    ...
    function validateQuoteUsers(){
            ...
            new Ajax.Updater('userresults','/sums/Manage/getUsersForQuotation',{onBeforeAjax:showDataLoader($('userresults')),parameters:Form.serialize($('formForQuoteUsers')),onComplete:function(){
