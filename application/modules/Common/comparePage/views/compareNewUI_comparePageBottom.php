<?php if($courseIdArr && count($courseIdArr)>1){ ?>
...
if(isset($courseAttributeData) && count($courseAttributeData) > 0){
  echo Modules::run('comparePage/comparePage/getPopularCoursesForComparision', $courseAttributeData);
}else{ 
      echo Modules::run('comparePage/comparePage/getPopularCoursesForComparision', $courseAttributeData_fullTimeMba);
      echo Modules::run('comparePage/comparePage/getPopularCoursesForComparision', $courseAttributeData_beBtech);
    }
?>
</div>
