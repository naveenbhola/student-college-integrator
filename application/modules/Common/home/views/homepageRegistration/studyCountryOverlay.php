...
.country-layer-cols strong{font-weight:bold; margin-bottom:7px; display:block; width:125px; color:#000;}
...
<div id="userPreferenceCountrys"  style="width:535px;background-color:#ffffff;display:none;position:absolute;">
                ...
                if($i++==0){
                    if(empty($regionId))
                        ...
                        echo '<div class="country-layer-cols">
                                <strong><span><input type="checkbox" id="region_'.$regionId.'" value="'.$regionId.'" onclick="toggleRegionCountries($(\'region_'.$regionId.'\'));" /></span> '.$regionName.'</strong>
                                <ul>';
                }
                if($regionId == '') {
                    $paddingLeft = '';
    ...
    <div align="center"><input type="button" value="OK" class="orange-button okBtn" onClick="getDataFromCityLayer1();" /></div>
    <div class="spacer15 clearFix"></div>
</div>
