...
?>
    ...
    <div class="revwListBx2 whtBx bordRdus3px colge-rev" id="">
        ...
        <div class="revwListBxRgt colge-rev-rt" style="position: relative;">
            <div class="colge-arrL" courseId="<?=$courseId?>" stream="<?=$stream?>" baseCourse="<?=$baseCourseId?>" educationType="<?=$educationType?>" substream="<?=$substreamId?>">
        	...
        	<div class="colge-arrR" courseId="<?=$courseId?>" stream="<?=$stream?>" baseCourse="<?=$baseCourseId?>" educationType="<?=$educationType?>" substream="<?=$substreamId?>" style="<?=($reviewDataResult['totalReviews']==1)?'cursor:default':'cursor:pointer'?>">
