...
if(isset($reviewFormName) && $reviewFormName=='collegeReviewRating'){
		...
		<div id="popupBasicBack">	
            ...
            <a title="Shiksha.com" tabindex="6" href="http://www.shiksha.com"><img border="0" title="Shiksha.com" alt="Shiksha.com" src="/public/images/desktopLogo.png" style="margin:0 0 10px 5px;"></a>
                </div>
            </div>
                ...
                <form id="reviewForm" action="/CollegeReviewForm/CollegeReviewForm/submitReviewData"  accept-charset="utf-8" method="post" enctype="multipart/form-data"  novalidate="novalidate" name="reviewForm">
				    ...
				    <input id="reviewSource" value="<?php echo isset($_SERVER['QUERY_STRING'])?htmlentities($_SERVER['QUERY_STRING']):'';?>" type="hidden"  name="reviewSource"/>
				    <?php } ?>
                    <?php
					if(isset($reviewFormName) && $reviewFormName=='collegeReviewRating'){
			...
			<?php if($showSteps=='YES'){ ?>
						...
						<li style="float: left; width:497px;">
						  ...
						  <!-- <p>< ?php echo $descriptionText;?></p> -->
                                    ...
                                    <div class="write-review-sec">
                                    	<textarea id="review-ugcollege" name="reviewDescription" class="write-textarea2" caption="review about your <?php if(isset($reviewFormName) && $reviewFormName=='collegeReviewRating'){  echo 'College';}else{ echo 'Undergraduate College';} ?>" validate="validateStr" required="true" minlength="0" maxlength="10000"><?php echo $reviewDescription;?></textarea>
                                        <div style="display:none;"><div class="errorMsg" id="review-ugcollege_error" style="*float:left"></div></div>      
                                    	<p>(Minimum 250 characters)</p>
                                    </div>
                                 </div>
                ...
                <?php $this->load->view('CollegeReviewForm/motivationForm',array('motivationFactor' => $motivationFactor)); ?>                 
                                 ...
                                 <a style="height: 42px;" href="javascript:void(0);" class="orange-button continue-btn" onclick="doValidationABTest();removeHelpTextInForm($('reviewForm'));if(validateFields($('reviewForm')) != true){ validateReviewForm('collegeReviewRating'); validationFailed(); return false;} if( validateReviewForm('collegeReviewRating') != true){validationFailed(); return false;} loadSocialAppLogin($('reviewForm')); return false;" id="reviewSubmitButton">Submit <i class="campus-sprite  continue-icon"></i></a>
				...
				<div class="connect-form clear-width" style="margin-top:10px;">
				    ...
				    <div style="position:relative;">
						...
						<div style="display:none;"><div class="errorMsg" id="email_error" style="*float:left"></div></div>
                                    	...
                                    	<div class="flRt" style="width:47%;">
                                            <div style="width:33%; margin-right:10px;" class="flLt">
                                ...
                                <div style="display:none;"><div class="errorMsg" id="isdCode_error" style="*float:left"></div></div>   
                                    ...
                                    <div style="float:left; width:31%;">
                                    		<label style="width:170px;">Mobile Number <span>*</span></label>
                                        	<input style="width:176px;" type="text" class="text-width" value="<?php echo $mobile;?>" id = "mobile" name = "mobile" validate = "validateMobileInteger" required = "true" maxlength = "10" minlength = "10" caption = "mobile" />
						<div style="display:none;"><div class="errorMsg" id="mobile_error" style="*float:left; width:170px;"></div></div>
                                        </div>
                                    </div>
                                    </li>
                                    <!--<li class="clear-width">
				...
				<?php if($submitButtonPosition == 'bottom'){ ?>
                                 <a style="margin:20px 0 0 155px !important; height:43px;" href="javascript:void(0);" class="orange-button continue-btn" onclick="doValidationABTest();removeHelpTextInForm($('reviewForm'));if(validateFields($('reviewForm')) != true){ validateReviewForm('collegeReviewRating'); validationFailed(); return false;} if( validateReviewForm('collegeReviewRating') != true){validationFailed(); return false;} loadSocialAppLogin($('reviewForm'));return false;" id="reviewSubmitButton"><?php echo $buttonText;?> <i class="campus-sprite  continue-icon"></i></a>
                                  &nbsp;<span id="waitingDiv" style="display:none"><img src='/public/images/working.gif' border=0 align=""></span>


                 <!-- below  code loads linkedin, google sign in sdk  -->                	
				<meta name="google-signin-client_id" content="357859390114-odfme4vvnu0ir9q7t4il6bba637p9urh.apps.googleusercontent.com">

                <script src="https://apis.google.com/js/platform.js?" async defer></script>  
				 <script src="https://apis.google.com/js/api:client.js"></script>
				<script type="text/javascript" src="//platform.linkedin.com/in.js">
				    api_key:75epi68dycoji1
...
<?php
	...
	if(!isset($reviewFormName) && $reviewFormName!='collegeReviewRating'){
		$this->load->view('CA/campusRepOnBoardHeaderAnimation');
	}
?>
<script>
