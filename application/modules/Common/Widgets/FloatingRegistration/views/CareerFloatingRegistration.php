<div class="career-floating-widget" id="floatingRegistrationOpen" style="display:none;z-index:100;">
    ...
    <div class="clearFix spacer10"></div>
            ...
            <form id="form_<?=$widget?>" onsubmit="processFloatingForm('<?=$widget?>','<?=$trackingPageKeyId?>'); return false;" novalidate>
				...
				<?php } ?>
                                ...
                                <?php } ?>
                <input type='hidden' id='tracking_keyid_floatingRegistration' name='tracking_keyid' value='<?php echo $trackingPageKeyId;?>'>
                                <li style="margin-bottom:0px;">
					<button class="orange-button"  uniqueattr="CareerProduct/floatingregistration" onclick="<?php if($showAsk=='true'){ echo "trackEventByGA('ASK_NOW_BUTTON','LISTING_DETAIL_PAGE_OVERVIEW_TAB_FLOATING');";} ?> processFloatingForm('<?=$widget?>','<?=$trackingPageKeyId?>'); return false;" id="submit_<?=$widget?>"><?php echo $buttonText;?> <span class="btn-arrow"></span></button>
...
<div class="closed-wid"  onClick="registerNow('<?=$widget?>','<?=$trackingPageKeyId?>');" id="floatingRegistrationClosed" style="display:none;z-index:100; width:300px !important;">
    <div class="flLt0">
