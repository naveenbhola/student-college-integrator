...
<div id="main-wrapper">
	<div id="top-bar" style="height:20px; overflow:hidden; background:#FFF !important;">
    		<div class="top-bar-child">
                <ul>
                    <li class="naukri-logo" title="A naukri.com group company" style="padding-top:5px;"><span>A naukri.com group company</span></li>
                </ul>
      </div>
      </div>
...
<div id="logo-section">
    <h1 class="shik-logo" style="padding-top:5px;position: relative;">
       <a href="<?php echo SHIKSHA_HOME; ?>" title="Shiksha.com"><img src="<?php echo SHIKSHA_HOME."/public/images/nshik_ShikshaLogo2.gif";?>" alt="Shiksha.com" title="Shiksha.com" border="0" class="flLt"></a>
	<i class="common-sprite orange-arrow"></i>
	<a href="<?=SHIKSHA_STUDYABROAD_HOME?>" class="visit-link">Visit our new home: Study Abroad</a>
    </h1>
