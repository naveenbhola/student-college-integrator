<form method="post" autocomplete="off"  onSubmit="$('subm').disabled = true;
    ...
    Ajax.Request('/user/Userregistration/ITMarketingPage/seccodehome',{onSuccess:function(request){javascript:newuserresponse(request.responseText
        );}, evalScripts:true, parameters:Form.serialize(this)}); return false;" novalidate="novalidate" 
      id = "frm1" name = "frm1"  style="font-size:11px;font-family: Tahoma, Geneva, sans-serif;color:#2A2A2A;">
          <?php
    ...
    <div style="width:100%">
        ...
        <div>
            <div style="font-size:20px;padding-top:2px">Let's connect you to the right institute</div>
            <div style="text-align: justify;padding-top:2px">We need a few details from you to create your free Shiksha account & to get the relevant institutes contact you.</div>        </div>
    ...
    function actionDesiredCourseDD(id) {
        ...
        if ( (courseOptions[selectindex].getAttribute("ddtype") ==
            ...
            if(FLAG_LOCAL_COURSE_FORM_SELECTION != 0) {
                ...
                ajax_form_loader('/marketing/Marketing/ajaxform_mba/itcourse1');
                // reset counter
                privateCounter = 1;
            }
            ...
            if (FLAG_LOCAL_COURSE_FORM_SELECTION != 1) {
                ...
                ajax_form_loader('/marketing/Marketing/ajaxform_mba/itdegree1');
            ...
            if (FLAG_LOCAL_COURSE_FORM_SELECTION != 2) {
                ...
                ajax_form_loader('/marketing/Marketing/ajaxform_mba/graduate_course1');
                changeSelectionPreferredStudyLocation();
            }
        }
        fillCombo();
        ...
        <div>
            <div>
                ...
                <div>
                    <div>Desired Course<b class="redcolor">*</b>:</div>
                </div>
                <div id="subCategory" style="">
                    <div>
                        <select onChange= "actionDesiredCourseDD(this.value);"
                                style="font-size:11px;width:250px" name = '<?php echo $dd_name; ?>' validate =
                                'validateSelect' required = 'true' caption = 'the desired course'
                                id='homesubCategories' style="width:170px;font-size:11px"><option value=''>Select</option>
<?php
echo $string;
?>
                        </select>
...
<?php $this->load->view("marketing/user_form_mba_it_itcourses_1"); ?>
            </div>
            <!-- captcha section -->
            <div>
                ...
                <div>
                    <img align = "absbottom"
                         ...
                         randomkey=1374590985&secvariable=seccodehome" width="100" height="34"
                         id = "secureCode"/>&nbsp;<p>
                        <input type="text"
                               blurMethod='trackEventByGA("EnterCaptcha","captcha entered by user");'
                               style="width:135px;height:15px;font-size:12px" name =
                    ...
                    <div class="errorPlace"
                         style="display:none;">
                        <div class="errorMsg" id= "homesecurityCode_error">
                        </div>
                    </div>
                </div>
                <div class="lineSpace_5">&nbsp;</div>
                <div>
                    ...
                    I agree to the <a href="javascript:" onclick="popitup('/shikshaHelp/ShikshaHelp/termCondition',600,600,'yes',50,200)">terms of services</a> and <a
                                      href="javascript:" onclick="popitup('/shikshaHelp/ShikshaHelp/privacyPolicy',600,600,'yes',50,200)">privacy policy</a>
            ...
            <div>
                <div>
                    <div><input uniqueattr="MarkeingPageLayer1Submit" type="submit" id="subm" value="Submit" <?php echo (isset($userarray)&&(isset($userarray['mobile'])&&!empty($userarray['mobile'])))?"disabled=\"disabled\"":"";?> /></div>
                </div>
                <div class="clear_L ht_5">&nbsp;</div>
            </div>
            <div class="lineSpace_10">&nbsp;</div>
