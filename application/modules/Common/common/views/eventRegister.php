...
<script>
var keyname_event = "<?php echo $multkeyname; ?>";
</script>
        ...
        <div style="width:662px;background:#FFFFFF">
            <div style="border:1px solid #d5e4fb">
                <div style="background:#6391CC;height:30px;position:relative">          
                    ...
                    <div style="position:absolute;top:8px;right:10px"><img onclick="return userLoginActionOnCancle();" src="/public/images/crossImg_14_12.gif" style="cursor:pointer"/></div>
                </div>
            ...
            if ((resp != 'blank') && ( resp != '-1')) {
				...
				if(!((typeof(askInstitute) != 'undefined') && (askInstitute.successMessage=='showRegister'))){
					if (flag_get_free_alert) {
						...
						if(keyname_event == 'EVENTS') {
		                                urlTemp='/MultipleApply/MultipleApply/showoverlay/12';
		                                }else{
                                                if(eventTriggered == 'followInstitute'){
                                                checkFshareOverlay('notShikshaUserFollowInstitute');
                                                }else{    
	        	                        urlTemp='/MultipleApply/MultipleApply/showoverlay/10';
                                                }
		                                }
