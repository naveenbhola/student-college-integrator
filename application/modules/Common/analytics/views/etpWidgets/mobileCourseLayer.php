...
?>
<div class="popup_layer lyr1" id="course-compare-layer" style="display:none;">
                ...
                <div class="hlp-info">
                    <div class="cont loc-layer">
                        ...
                        <ul class="prm-lst" id="course-compare-list">
                            ...
                            ?>
                              <li onclick="selectCourseForCompare(this, event);"><p><input type="checkbox" cid="<?php echo $courseObj->getId();?>" id="ccl_<?php echo $courseObj->getId();?>" <?php echo (in_array($courseObj->getId(), $compareCourses) ? 'checked' : ''); ?>> <label for="ccl_<?php echo $courseObj->getId();?>"><?php echo htmlentities($courseName);?></label></p></li>
                            <?php
                              }
                            ?>
                        </ul>
