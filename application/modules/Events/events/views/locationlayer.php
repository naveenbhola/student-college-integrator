...
{
<!--
      var newUrl = '/events/Events/viewAllEvents/'+ countryName +'/<?php echo $fromOthers; ?>/<?php echo $category_id; ?>/<?php echo $category_name; ?>/'+ countryId +'/'+ countryName +'/0/10';
...
function opencatpage(urlsame)
{
    ...
    var url = '/events/Events/viewAllEvents/'+ country +'/<?php echo $fromOthers; ?>/<?php echo $category_id; ?>/<?php echo $category_name; ?>/'+ city +'/'+ cityname +'/0/10';
    window.location = url;
   -->
}
</script>
<script type="text/javascript">
    ...
    h = h1 > h ? h1 : h;
        var divY =  (parseInt((document.body.offsetHeight)/2)) + 27;
        var divX = (parseInt((document.body.offsetWidth)/2)) - 243;
    var posleft = (divX) +  'px';
    var postop = (divY) + 'px';
    document.write("<style>#locationlayer{left:"+posleft+" !important;top:"+postop+"!important}</style>");
</script>
<!--</div>-->
<!--End_Overlay-->
