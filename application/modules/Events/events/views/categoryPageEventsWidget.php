...
<input type="hidden" id="countrySelected" autocomplete="off" value="<?php echo $countrySelected; ?>" />
<input type="hidden" id="cityId" autocomplete="off" value="<?php echo $cityId; ?>" />
<input type="hidden" id="cityNameSelected" autocomplete="off" value="<?php echo $cityNameSelected; ?>" />
<?php $categoryNamed=$categoryData['name'];?>
<input type="hidden" id="categoryNamed" autocomplete="off" value="<?php echo $categoryNamed; ?>" />
                                <div class="wdh100">
				  ...
				  <div class="wdh100">
                                            <div class="bgTab">
                                                ...
                                                <div class="impDt" style="margin-left:5px">
                                                    <a href="javascript:viewEventsForStudyAbroad(0);" class="active">Application Deadline</a>
						    <a href="javascript:viewEventsForStudyAbroad(3);" class="unactive">Examination Date</a>
						    <a href="javascript:viewEventsForStudyAbroad(4);" class="unactive">Form Issuance</a>
						    <a href="javascript:viewEventsForStudyAbroad(2);" class="unactive">Result Declaration</a>
							...
							$onClickAll = "calloverlayEvents('$event_id','".addslashes($titleEvent)."','ALLCEVENTS','$countrySelected',$fromOthers,'$cityId','$cityNameSelected',$categoryId,'$categoryNamed');return false;";
                                                        }else {
						...
						<div>
							<div class="float_L"><div id="onClickAllInnerHtml"><input type="button" onClick="<?php echo $onClickAll; ?>;subscribeEvents('<?php echo $event_id; ?>','<?php echo addslashes($titleEvent); ?>');return false;" class="btn_scrib" value="Subscribe" /></div></div>
							<div class="float_R"><div style="line-height:21px">&nbsp;
							<?php if(!empty($total_events) && $total_events>3){?>							
							<span id="viewAllLink"><a href="<?php echo constant('SHIKSHA_EVENTS_HOME_URL') ?>/events/Events/viewAllEvents/<?php echo $countrySelected; ?>/<?php echo $fromOthers; ?>/<?php echo $categoryId; ?>/All/<?php echo $cityId?>/<?php echo $countryNameSelected; ?>/0/10/All" class="">View All</a></span>
							<?php } ?>
							</div></div>
							<div class="clear_B">&nbsp;</div>
						</div>                                            
...
function checkClass(from_others,total_events){
	...
	if(from_others==0){
		activeHTML+='<a href="javascript:viewEventsForStudyAbroad(0);" class="active">Application Deadline</a><a href="javascript:viewEventsForStudyAbroad(3);" class="unactive">Examination Date</a><a href="javascript:viewEventsForStudyAbroad(4);" class="unactive">Form Issuance</a><a href="javascript:viewEventsForStudyAbroad(2);" class="unactive">Result Declaration</a><a href="javascript:viewEventsForStudyAbroad(1);" class="unactive">Course Commencement</a><a href="javascript:viewEventsForStudyAbroad(5);" class="unactive">General</a>';
	}else if(from_others==1){
		activeHTML+='<a href="javascript:viewEventsForStudyAbroad(0);" class="unactive">Application Deadline</a><a href="javascript:viewEventsForStudyAbroad(3);" class="unactive">Examination Date</a><a href="javascript:viewEventsForStudyAbroad(4);" class="unactive">Form Issuance</a><a href="javascript:viewEventsForStudyAbroad(2);" class="unactive">Result Declaration</a><a href="javascript:viewEventsForStudyAbroad(1);" class="active">Course Commencement</a><a href="javascript:viewEventsForStudyAbroad(5);" class="unactive">General</a>';
	}else if(from_others==5){
		activeHTML+='<a href="javascript:viewEventsForStudyAbroad(0);" class="unactive">Application Deadline</a><a href="javascript:viewEventsForStudyAbroad(3);" class="unactive">Examination Date</a><a href="javascript:viewEventsForStudyAbroad(4);" class="unactive">Form Issuance</a><a href="javascript:viewEventsForStudyAbroad(2);" class="unactive">Result Declaration</a><a href="javascript:viewEventsForStudyAbroad(1);" class="unactive">Course Commencement</a><a href="javascript:viewEventsForStudyAbroad(5);" class="active">General</a>';
	}else if(from_others==3){
                activeHTML+='<a href="javascript:viewEventsForStudyAbroad(0);" class="unactive">Application Deadline</a><a href="javascript:viewEventsForStudyAbroad(3);" class="active">Examination Date</a><a href="javascript:viewEventsForStudyAbroad(4);" class="unactive">Form Issuance</a><a href="javascript:viewEventsForStudyAbroad(2);" class="unactive">Result Declaration</a><a href="javascript:viewEventsForStudyAbroad(1);" class="unactive">Course Commencement</a><a href="javascript:viewEventsForStudyAbroad(5);" class="unactive">General</a>';
        }else if(from_others==2){
                activeHTML+='<a href="javascript:viewEventsForStudyAbroad(0);" class="unactive">Application Deadline</a><a href="javascript:viewEventsForStudyAbroad(3);" class="unactive">Examination Date</a><a href="javascript:viewEventsForStudyAbroad(4);" class="unactive">Form Issuance</a><a href="javascript:viewEventsForStudyAbroad(2);" class="active">Result Declaration</a><a href="javascript:viewEventsForStudyAbroad(1);" class="unactive">Course Commencement</a><a href="javascript:viewEventsForStudyAbroad(5);" class="unactive">General</a>';
        }else if(from_others==4){
                activeHTML+='<a href="javascript:viewEventsForStudyAbroad(0);" class="unactive">Application Deadline</a><a href="javascript:viewEventsForStudyAbroad(3);" class="unactive">Examination Date</a><a href="javascript:viewEventsForStudyAbroad(4);" class="active">Form Issuance</a><a href="javascript:viewEventsForStudyAbroad(2);" class="unactive">Result Declaration</a><a href="javascript:viewEventsForStudyAbroad(1);" class="unactive">Course Commencement</a><a href="javascript:viewEventsForStudyAbroad(5);" class="unactive">General</a>';
        }
		activeHTML+='</div></div></div>';
		document.getElementById('activeUnactive').innerHTML = activeHTML;
		if(total_events>3){
		var viewAllHTML='<a href="/events/Events/viewAllEvents/'+ countrySelected +'/'+ from_others +'/'+ categoryId +'/All/'+ cityId +'/'+ countrySelected +'/0/10/All" class="">View All</a>';
		}else{
		var viewAllHTML='';
		}
...
function viewEventsForStudyAbroad(from_others){
	...
	var start=0;
        var cityId= document.getElementById('cityId').value;
	var cityNameSelected= document.getElementById('cityNameSelected').value;
        var category_id= document.getElementById('categoryId').value;
	var countrySelected=document.getElementById('countrySelected').value;
	var categoryNamed=document.getElementById('categoryNamed').value;
        var total_events=0;
	var count=3;
	var onClick = document.getElementById('onClick').value;
	var onClickAll = document.getElementById('onClickAll').value;
        var url = '/events/Events/categoryPageEvents/1/'+ from_others +'/'+ cityId + '/' + category_id +'/'+ start +'/'+ count;
        var a  = new Ajax.Request (url,{ method:'post', parameters: (category_id), onSuccess: function (xmlHttp) {
			...
			var onClickAllInnerHtml='';
				...
				for(var eventCounts =0;eventCounts<ajaxResp.length;eventCounts++ ){
					...
					if(onClickAll!=''){
                                        onClickAll='calloverlayEvents(\''+ ajaxResp[eventCounts].event_id +'\',\''+ addslashes(ajaxResp[eventCounts].event_title) +'\',\'ALLCEVENTS\',\''+ countrySelected +'\','+ajaxResp[eventCounts].fromOthers+',\''+ cityId +'\',\''+ cityNameSelected +'\','+ category_id +',\''+ categoryNamed +'\');return false;';
                                        }
					onClickAllInnerHtml='<input type="button" onClick="'+ onClickAll +'subscribeEvents(\''+ ajaxResp[eventCounts].event_id +'\',\''+ addslashes(ajaxResp[eventCounts].event_title) +'\');return false;" class="btn_scrib" value="Subscribe" />';
                                        }
			}else{
			eventsHTML+='No events to display under this selection.';
			}
			document.getElementById('eventListByType').innerHTML = eventsHTML;
			document.getElementById('onClickAllInnerHtml').innerHTML = onClickAllInnerHtml;
	...
	var days='';
        ...
        var a  = new Ajax.Request (url,{ method:'post', parameters: (from_others), onSuccess: function (xmlHttp) {
			...
			var onClickAllInnerHtml='';
					...
					eventsHTML+='</div><a href="javascript:void(0);" onClick="'+ onClick +' subscribeEvents(\''+ ajaxResp[eventCounts].event_id +'\',\''+ addslashes(ajaxResp[eventCounts].event_title) +'\');showsubscriptionlayer(0,this,false);return false;" class="vDLink_2">Subscribe</a></div><div class="clear_B"></div></li>';
                                        if(onClickAll!=''){
                                        onClickAll='calloverlayEvents(\''+ ajaxResp[eventCounts].event_id +'\',\''+ addslashes(ajaxResp[eventCounts].event_title) +'\',\'ALLCEVENTS\',\''+ countrySelected +'\','+ajaxResp[eventCounts].fromOthers+',\''+ cityId +'\',\''+ cityNameSelected +'\','+ category_id +',\''+ categoryNamed +'\');return false;';
                                        }
                                        onClickAllInnerHtml='<input type="button" onClick="'+ onClickAll +'subscribeEvents(\''+ ajaxResp[eventCounts].event_id +'\',\''+ addslashes(ajaxResp[eventCounts].event_title) +'\');showsubscriptionlayer(0,this,false);return false;" class="btn_scrib" value="Subscribe" />';                 }
                        document.getElementById('eventListByType').innerHTML = eventsHTML;
			document.getElementById('onClickAllInnerHtml').innerHTML = onClickAllInnerHtml;
			var showingEventsHTML='';
...
onLoadCP(<?php echo $total_events; ?>);
<?php } ?>
function onLoadCP(total){
