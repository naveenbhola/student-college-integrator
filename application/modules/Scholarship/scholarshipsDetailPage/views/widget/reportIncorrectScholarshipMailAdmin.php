               ...
               <tr>
                  <td>
                     ...
                     <div width="600">
                        ...
                        <p>A user has reported incorrect information on scholarship id: <?= $scholarshipId;?> </p>
			
                        <p><b>Description of error : </b> <?=htmlentities($feedbackComment)?></p>
			<?php if($email !=''){?>
			<p><b>User Email:</b> <?=htmlentities($email)?></p>
			<?php } ?>
			<p><b>Timestamp : </b> <?=$submitTime;?></p>
                        <p><b>URL Details : </b> <a href="<?=$sourcePageUrl;?>"><?=$sourcePageUrl?></a></p>
