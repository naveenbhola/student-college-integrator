...
<?php
	if(isset($relatedBlogs) && is_array($relatedBlogs) && count($relatedBlogs) > 1){
?>
	...
	<h4>Related Articles</h4>
		<ul>
				...
				<?php
					...
					$i=0;
					foreach($relatedBlogs as $temp){
						$commentsText = '';
						if($temp['blogId'] == $blogId) continue;
						$i++;
						if($i>4) break;
				...
				<li>
				 <div>
					...
					<?php } if($commentsCount == 0 && $temp['viewCount'] == 0){?>
