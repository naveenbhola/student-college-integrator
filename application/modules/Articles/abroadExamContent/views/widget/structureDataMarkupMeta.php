...
<div itemprop="author" itemscope itemtype="http://schema.org/Person"> 
    <meta itemprop="name" content="<?php echo htmlentities($contentDetails['authorInfo']['firstname']." ".$contentDetails['authorInfo']['lastname']) ?>"/>         	
</div>	 	
...
<?php if (isset($contentDetails['contentImageURL'])){?>
