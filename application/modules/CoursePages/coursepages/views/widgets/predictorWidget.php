<?php 
$predictorWidget=$widgets_data['predictorWidget']['predictorWidgetData'];
$collegePredictorExams=$predictorWidget['collegePredictorExams'];
$rankPredictorExams=$predictorWidget['rankPredictorExams'];
?>
