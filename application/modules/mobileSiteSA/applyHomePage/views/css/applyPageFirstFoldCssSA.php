...
.paralex-cont{position: absolute;bottom: 16px;width: 100%; padding: 0 10px;text-shadow: 1px 1px 5px rgba(0,0,0,0.8);}
...
p.hd-sbtl{ font-size: 14px;margin-bottom: 10px;font-weight: 600;}
*/
