    ...
    <tr>
        <td colspan="3" background="<?php echo SHIKSHA_HOME ?>/public/images/bg.gif" style="background:url(<?php echo SHIKSHA_HOME ?>/public/images/bg.gif)">
			<div style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#1A1A1A; padding:10px 35px 10px 35px; line-height:20px;">
				...
				<?php if($attachmentAvailable){ ?>
					Your requested downloadable guide is <u>attached</u> in this email:<br/> - <?= htmlentities($guideName)?> <br/>
				<?php }else{ ?>
					Your requested downloadable guide :<br/>
					<br/>
					<?php echo 'Guide - <a href = "'.$downloadLink.'">click here to download</a><br>'; ?>
				<?php } ?>
				<br/>
				...
				<br/>
				<span style="color:rgb(246,137,54);font-weight:bold;">Shiksha</span><span style="color:rgb(60,84,164);font-weight:bold;">Study Abroad</span>
				<br/>
				<br/>
...
<table width="600" border="0" cellspacing="0" cellpadding="0" align="center">
    ...
    <tr>
		<td>
			<div align="center" style="font-family:Arial, Helvetica, sans-serif; font-size:10px; padding:10px; color:#666666; line-height:14px;">
				You are receiving this email because you have requested this information for your email id
				<span style="text-decoration:underline; color:#231E19">
					<a href="#"><?php echo $userEmailId?></a>
				</span>.
				<br />
				Copyright &copy; <?php echo date('Y')?> Shiksha.com. All rights reserved.<br />
				<a href="<?php echo SHIKSHA_HOME; ?>" target="_blank" style="color:#666666">Shiksha.com</a> is located at A-88, Sector-2, NOIDA, UP 201301, INDIA
			</div>
        </td>
    </tr>
</table>