...
<link rel="icon" href="<?php echo IMGURL_SECURE?>/public/images/favicon_SA.ico" type="image/x-icon" />
<link rel="shortcut icon" href="<?php echo IMGURL_SECURE?>/public/images/favicon_SA.ico" type="image/x-icon" />    
...
<body>
<div id="allLoader" style="z-index: 1000;position: fixed; left: 0px; top: 0px; bottom: 0px; right: 0px;background: rgba(255, 255, 255, 1) none repeat scroll 0px 0px !important; "  data-role="none">
...
<?php //echo Modules::run('mcommon5/MobileSiteHamburger/getAppBanner'); ?>
<?php if($validateuser!=='false'){$this->load->view('commonModule/loggedinUser',$loggedInUserData);}?>
<header class="header" <?=($hideHeader===true?'style="display:none;"':'')?> data-role="header">
<div data-enhance = "false" style="display: table; width: 100%;height:40px;">
<a href="#hamburgerContainer" class="hem-menu" onclick = "adjustPageHeight();">
<span class="icon-bar"></span>
<span class="icon-bar"></span>
<span class="icon-bar"></span>
</a> 
<a href="<?=(SHIKSHA_STUDYABROAD_HOME)?>" class="logo"> <span class="sprite">Shiksha.com</span></a>
<?php if($validateuser!=='false'){?>
<a href="#loggedin" data-rel="dialog" data-transition="slide" class="right-menu" onclick = "fetchUserNotificationLayer(<?=($validateuser[0]['userid'])?>);"><span class="sprite"></span>
<span id="notificationCount"></span>
</a>
<?php }
else
{ ?>
<a id="registrationHeaderLink" href="#register" data-rel="dialog" data-transition="slide" class="right-menu <?php if($hideRegisterLink ==true){ echo "hide";}?>" ><span class="sprite"></span></a>
<?php
}
?>
<a id="searchLayerContainerLink" href="#searchLayerContainer" data-rel="dialog" data-transition="slide">
<i class="sprite src-headIcn"></i></a>
<div id="shortlistHeadLocation" class="header-shortlist tac hide">
<a href="<?=SHIKSHA_STUDYABROAD_HOME?>/my-saved-courses?shortlistTab=1" class="color0">
<i class="sprite star-icn"></i>
