<form id="MentorProfileForm" action="/CA/CampusAmbassador/submitMentorprofileData" accept-charset="utf-8" method="post" enctype="multipart/form-data"  novalidate="novalidate" name="MentorProfileForm">
    ...
    <input name="fromMentorshipForm" value="yes" type="hidden" />
    ...
    <div class="form-details">
        <p class="form-title form-hd-clr" >Tell Us About Yourself</p>
        <ul>
                <li class="clear-width">
                <div class="flLt">
                        <label>First Name <span>*</span> </label>
                        <input type="text" class="text-width" value="<?php echo $firstname;?>" onmouseover="showTipOnline('If your name is Ramesh Kumar Gupta, enter Ramesh as your first name',this);" onmouseout="hidetip();" id='quickfirstname_ForCA' name='quickfirstname_ForCA'  maxlength="50" minlength="1" validate="validateDisplayName" caption="First Name" required = "true" /><div style="display:none;"><div class="errorMsg" id="quickfirstname_ForCA_error"></div></div>
                </div>
                <div class="flRt">
                        <label>Last Name <span>*</span></label>
                        <input type="text" class="text-width" value="<?php echo $lastname;?>" onmouseover="showTipOnline('If your name is Ramesh Kumar Gupta, enter Gupta as your last name',this);" onmouseout="hidetip();" id='quicklastname_ForCA' name='quicklastname_ForCA'  maxlength="50" minlength="1" validate="validateDisplayName" caption="Last Name" required = "true" /><div style="display:none;"><div class="errorMsg" id="quicklastname_ForCA_error"></div></div>
                </div>
            </li>
            <li class="clear-width">
                <div class="flLt">
            ...
            <li class="clear-width">
                <div class="flLt" style="margin-right:30px; width:50%">

                    <div style="width:33%;" class="flLt">
                    <label>Country Code <span>*</span></label>
                    <select style="width:100%;" class="select-width" required="true" validate="validateSelect" caption="ISD Code" id="isdCode" name="isdCode" onchange="changeMobileFieldmaxLength(this.value, 'quickMobile_ForCA');">
                ...
                <div style="display:none;"><div class="errorMsg" id="isdCode_error" style="*float:left"></div></div>   
                    ...
                    <div class="flRt" style="width:65%;">
                        <label>Mobile Number <span>*</span> </label>
                        <input style="width:176px;" type="text" class="text-width" value="<?php echo $mobile;?>" onmouseover="showTipOnline('Please enter your correct mobile number. It will be used for all important communication with you.',this);" onmouseout="hidetip();" id = "quickMobile_ForCA" name = "quickMobile_ForCA" validate = "validateMobileInteger" required = "true" maxlength = "10" minlength = "10" caption = "mobile" />
                                <div style="display:none;"><div class="errorMsg" id="quickMobile_ForCA_error"></div></div>
                    </div>
                </div>
                <div class="flLt">
                       ...
                       <?php endif;?>
                        <input type="file" name='userApplicationfile' onmouseover="showTipOnline('Please upload photograph of size 3.5cm X 4.5cm',this);" onmouseout="hidetip();" id="Imagebox" value="<?php echo $url;?>" />
        <div style='display:none;'><div class='errorMsg' id= 'Imagebox_err'></div></div>
                  </div>
            </li>
            <li class="clear-width" style="display: none;">
                <div class="flLt">
                        <label>Address</label>
                ...
                <div class="camp-tooltip flRt">
                <i class="campus-sprite  tooltip-pointer"></i>
                This is the address to which the  gifts and rewards will be sent.
                </div>
            </li>
             <li class="clear-width">
                <div class="flLt">
             ...
             <!-- <li class="clear-width" style="margin-bottom: 25px;">
                <div>
    ...
    <div style="width: 100%; background-color: #c2c2c2; height: 1px; clear: both;"></div>
    <div class="form-details">
        <p class="form-title form-hd-clr" style="margin-top: 30px;">Tell Us About Your College</p>
        <ul>
                <li class="clear-width">
                <div class="flLt">
                        ...
                        <div class="dummy_autosuggest" id="dummy_autosuggest_1">
                            ...
                            <?php else: ?>
                            <input type="text" class="text-width" autocomplete='off' onmouseover="showTipOnline('As you type the name of the college, relevant matches will be shown in drop-down menu. Please click on the name to select.',this);" onmouseout="hidetip();" id="dummy_input" default="Type Institute name..." value="Type Institute name..." onfocus="this.hasFocus=true; checkTextElementOnTransition(this,'focus');" onblur="this.hasFocus=false; checkTextElementOnTransition(this,'blur');" validate="validateStr" minlength="1" maxlength="200" required="true" caption="College name" />
                            <?php endif; ?>
                            <div style="display:none;"><div class="errorMsg" id="institute_error_1"></div></div>
                            <div style="display:none;"><div class="errorMsg" id="dummy_input_error"></div></div>
          ...
          <div id="first_sibling_1" style="display:none">  
                <div class="" id="anaAutoSuggestor" style="position: relative;">
                        ...
                        <div style="display:none;"><div class="errorMsg" id="keywordSuggest_error"></div></div>
          ...
          <input type="hidden" name="suggested_institutes[]" id="suggested_institutes_1" value="" />
                ...
                <div class="flRt">
                        ...
                        <?php endif; ?>
        <div style="display:none;" id="loc_main"><div class="errorMsg" id="location_1_error"></div></div>
                </div>
            </li>
            ...
            <li class="clear-width">
                <div class="flLt">
                        ...
                        <?php endif; ?>
                                        <div style="display:none;"><div class="errorMsg" id="course_1_error"></div></div>
                </div>
                <div class="flRt">
                        <label>Year of completion <span>*</span> </label>
                        <?php if($userId>0 && $crIdExist=='yes'): ?>
                        <input type="text" class="select-width" disabled="disabled" value="Year of completion <?php echo $mainEducationDetails[0]['yearOfGrad']; ?>">
                        <?php else: ?>
                        <select class="select-width" onchange="" onmouseover="showTipOnline('Please click on your year of completion',this);" onmouseout="hidetip();" name="yearOfGrad[]" id="year_1" required="true" validate="validateSelect" caption="Year of completion"  ><option value="">Select</option>
                        <?php for($i=0; $i<5; $i++){?>
                            <option value="<?php echo date("Y")+$i;?>"><?php echo date("Y")+$i;?></option>
                        <?php } ?>
                        </select>
                        <?php endif; ?>
                        <div style="display:none;"><div class="errorMsg" id="year_1_error"></div></div>
                </div>
            </li>
            <li class="clear-width">
            <?php if(!empty($mentorQues)){
                $this->load->view('mentorship/mentorQna');
            }?>
            </li>
            <?php if($userId<=0 || $userId==''){ ?>
        <li class="captcha-row">
            <p style="padding-bottom: 10px;">Type in the character you see in the picture below</p>
        ...
        {
        ?>
                <div id="waitingDiv" style="display:none; text-align: center;"><img src="<?php echo SHIKSHA_HOME;?>/public/images/working.gif" border=0 align=""></div>
                <a style="height: 37px; margin-left: 220px !important; margin-top: 10px !important" href="javascript:void(0);" class="orange-button continue-btn" onclick="startValidating();removeHelpText($('MentorProfileForm')); if(validateFields($('MentorProfileForm')) != true){ validateCAForm($('MentorProfileForm')); validationFail(); return false;} if( validateCAForm($('MentorProfileForm')) != true){validationFail(); return false;} if(validateExamCheck('MentorProfileForm') != true){ return false; } storeCAData($('MentorProfileForm')); return false;">Submit</a>
                <div class="clearFix"></div>
        <p class="tac">By clicking Submit button, I agree to the <a href="javascript:void(0);" onclick="return popitup('/shikshaHelp/ShikshaHelp/termCondition')">Terms and Conditions</a></p>
        <?php
        }
        ?> 
    </div>
