<html>
	...
	<?php $this->load->view('InternalAppsCommon/headbar', array('app' => 'FailureMatrix')); ?>	
    ...
    <div style='margin:0 auto; width:1200px; border:0px solid red;'>
		...
		<div style='float:left; margin-top:	10px; margin-left:15px;'>
			<img src='/public/images/appmonitor/failurematrix2.png' height='60' />
		</div>
		...
		<div style='float:right; margin-top:25px; margin-right:10px;'>
			<a href='/FailureMatrix/FailureMatrix/edit' class='zbutton zmedium zgreen'>Add New</a>
		</div>
	</div>
	</div>
	<?php if($search != 'no') { ?>
