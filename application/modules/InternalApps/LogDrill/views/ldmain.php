...
<div style="background:#253840; height:31px; display:block; border-bottom:1px solid #2c4b58">
  <div style="margin:0 0; width:1200px; border:0px solid red;">
      <ul class="appTabs">
          ...
          <li><a href="/LogDrill/LogDrill/index" class="appActive">LogDrill</a></li>
...
<iframe src="http://10.10.16.101:8047/query" width="100%" height="100%" border="0" style="display: block; 
    background: #000;
    border: none;
    height: 100vh;
    width: 100vw;" />
