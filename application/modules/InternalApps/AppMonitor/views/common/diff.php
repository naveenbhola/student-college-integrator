 ...
 $this->load->view('AppMonitor/common/header'); ?>
	<style type="text/css">
		...
		<div style="width:100%; padding:0px; margin-top:15px;">
		    ...
		    <div style=' margin:10px 0; font-size:13px; background:#F3FAF2; color:#444; padding:20px;'>
		        <form method='post' action='/common/PerformanceLogger/showSlowQueries' id='qForm'>
					
				<div style='float:left; margin-top:5px;'>	
					
		        <div style='float:left; margin-left:30px; padding-top:3px;'>Date Range I: </div>
		        <div style='float:left; margin-left:10px; padding-top:1px;'>
		            <input type="text" id="fromDatePickerStart" value="<?php echo $defaultDateStart; ?>" style='width:100px;' /> - 
		        </div>
		        <div style='float:left; margin-left:10px; padding-top:1px;'>
		            <input type="text" id="fromDatePickerEnd" value="<?php echo $defaultDateStart; ?>" style='width:100px;' />
		        </div>


		        <div style='float:left; margin-left:30px; padding-top:3px;'>Date Range II: </div>
		        <div style='float:left; margin-left:10px; padding-top:1px;'>
		            <input type="text" id="toDatePickerStart" value="<?php echo $defaultDateEnd; ?>"  style='width:100px;' /> - 
		        </div>
		        <div style='float:left; margin-left:10px; padding-top:1px;'>
		            <input type="text" id="toDatePickerEnd" value="<?php echo $defaultDateEnd; ?>"  style='width:100px;' />
		        </div>

				</div>
		        <div style='float:left; margin-left:40px; opacity:0.4;'><a href='javascript:void(0);' onclick="updateReport();"><img src='/public/images/appmonitor/submit.png' /></a></div>
		        </form>
