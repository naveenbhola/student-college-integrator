...
<div style="width:100%; padding:0px; margin-top:15px;">
	...
	<h2 class='sub-head' style='margin-top:40px;'>Trend For Unique JS Errors</h2>
...
function updateReport() {
	...
	<?php if($dashboardType == ENT_DASHBOARD_TYPE_JS_ERROR) { ?>
		url = '/AppMonitor/JSErrors/trends';
	<?php }?>
...
options['vAxis']['title'] = 'No. of Unique Errors';
chart.draw(dataTable, options);
}
</script>
</html>