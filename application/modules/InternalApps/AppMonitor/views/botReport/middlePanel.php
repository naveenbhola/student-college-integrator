...
if(isset($result)) {
    ...
    <tr style='background: none repeat scroll 0 0 #f7f7f7;'><th width='50'>#</th><th width='120'>IP</th><th>User Agent</th><th width='120'>Status</th></tr>";
        foreach ($result as $row) {
            ...
            echo "<td><div style='width:150px; word-wrap:break-word;'>".$row['ip']."</div>";
            ...
            echo "</td>";
            echo "<td valign='top'><div style='width:700px; word-wrap:break-word;'>".$row['useragent']."</div></td>";
