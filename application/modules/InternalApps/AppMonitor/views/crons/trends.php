...
<div class='blockbg'>
	...
	<div style='float:left; margin-left:30px; padding-top:3px;'>From Date: </div>
...
<div style="width:100%; padding:0px; margin-top:15px;">
	...
	<h2 class='sub-head' style='margin-top:40px;'>Trend For Unique Crons</h2>
...
function updateReport() {
	...
	url = '/AppMonitor/CronErrors/trends';
...
options['vAxis']['title'] = 'No. of Crons';
chart.draw(dataTable, options);
}
</script>
</html>