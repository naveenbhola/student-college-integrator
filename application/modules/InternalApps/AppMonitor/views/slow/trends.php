...
<script type="text/javascript">
	...
	function updateReport() {
		...
		<?php if($dashboardType == ENT_DASHBOARD_TYPE_MEMORY) { ?>
			url = '/AppMonitor/HighMemoryPages/trends';
		<?php } else if($dashboardType == ENT_DASHBOARD_TYPE_CACHE) { ?>
			url = '/AppMonitor/CacheHeavyPages/trends';
		<?php } else { ?>
			url = '/AppMonitor/SlowPages/trends';
		<?php } ?>	
