...
<div style="margin-left:175px">
    <div class="float_L">
            <select style="font-size:11px;width:170px" name = "plan" blurMethod="when_plan_start();" required = "true" caption = "when you plan to start the course" id="when_plan_start">
        <?php
                $array= array(
