...
<div>
    ...
    <div class="mmp_banner_container">
        <div style="float:left;width:470px">
                <div id = "gallery_div_script_tpl" style="width:414px;"><?php $this->load->view('multipleMarketingPage/multipleMarketingPage_left'); ?></div>
        </div>
        <div style="float:left;width:480px;">
            <div style="background:#f4f4f4; padding:10px 0px 20px 10px;">
				<div class="OrgangeFont bld" style="font-size:20px;"><?php echo $config_data_array['form_heading']?></div>
				<div style="padding:2px 0 10px 0">We need a few details from you to create your free Shiksha account &amp; to get the relevant institutes contact you.</div>
                <?php //$this->load->view('multipleMarketingPage/multipleMarketingPage_form'); ?>
