...
<div style="width:665px;background:#000000">
    <div style="width:662px;background:#FFFFFF">
        <div style="border:1px solid #d5e4fb">
			...
			<div style="width:100%">
				...
				<div style="width:100%">
                        ...
                        <div style="width:100%">
                            ...
                            <div class="formFieldTextRight">
								<div style="width:100%">
									<div><textarea blurMethod="checkTextElementOnTransition(this,'blur');" onfocus="checkTextElementOnTransition(this,'focus');" style="width: 205px; height: 60px;color:#ada6ad;" name="otherdetails" id="otherdetails" validate="validateStr" default="Tell us how you plan to fund your overseas education, family income and any relatives who are settled abroad." maxlength="500" tip="listing_add_tag" caption="other details"><?php echo (($otherdetails  == '')?'Tell us how you plan to fund your overseas education, family income and any relatives who are settled abroad.':$otherdetails ); ?></textarea></div>
			...
			<div style="width:100%">
				<div align="center">
					<input type="Submit" class="btnMarketingOverlaySub" value="Submit" style="font-size:16px;font-weight:bold" uniqueattr="MultipleMarkeingPageAbroadLayer2Submit"/> &nbsp;
