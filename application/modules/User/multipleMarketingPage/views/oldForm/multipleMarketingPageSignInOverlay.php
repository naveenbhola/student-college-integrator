...
<form autocomplete="off" novalidate="novalidate" action="/user/Login/submit" onsubmit="new Ajax.Request('/user/Login/submit',{onSuccess:function(request){javascript:showLoginResult(request.responseText,'_marketing');}, onFailure:function(request){javascript:showLoginResult(request.responseText,'_marketing')}, evalScripts:true, parameters:Form.serialize(this)}); return false;" method="post" >
