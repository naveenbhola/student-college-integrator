...
<title>Shiksha.com - SNAP result</title>
<link href="//<?php echo CSSURL; ?>/public/css/<?php echo getCSSWithVersion('marketing'); ?>" type="text/css" rel="stylesheet" />
<link href="//<?php echo CSSURL; ?>/public/css/<?php echo getCSSWithVersion('campaignSNAP'); ?>" type="text/css" rel="stylesheet" />
...
<div id="Theader">
<div class="W990">
	<div><a href="https://www.shiksha.com/" target="_blank" title="Shiksha.com"><img src="/public/images/campaignSNAP/shikshaLogo.gif" width="276" height="84" border="0" /></a></div>
</div>
</div>
<!--End_topHeader-->
...
<div id="lftColumn">
<div>
<h2>SNAP 2012 <span>Results Declared</span></h2>
<div class="bubble">See from which college you can get GD/ PI calls</div>
<div><img src="/public/images/campaignSNAP/tuppleShad.jpg" width="352" height="17" /></div>
...
<div class="ftrContWrap">
        ...
        <ul>
        	<li>
                ...
                <p>Check your SNAP 2012 Results.</p>
            </li>
            <li>
                <div class="Searchcolz"></div>
                <p>Search &amp; Apply to colleges with your SNAP Score.</p>
            </li>
            <li>
                <div class="CnctMBA"></div>
                <p>Connect with other SNAP Students.</p>
            </li>
            <li>
            ...
            <li>
                ...
                <p>Get Alumni Review for SNAP Colleges.</p>
            </li>
        </ul>
...
<div id="rhtColumn">
<div id="formWrapper">
	<div class="OrgangeFont">Check your SNAP 2012 result right here!</div>
