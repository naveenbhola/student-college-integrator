...
<link href="//<?php echo CSSURL; ?>/public/css/<?php echo getCSSWithVersion('campaignNMAT'); ?>" type="text/css" rel="stylesheet" />
...
<div class="mainWrapper">
	<div class="fl_LFT"><a href="https://www.shiksha.com/" target="_blank" title="Shiksha.com"><img src="/public/images/campaignNMAT/shikshaLogo.gif" width="276" height="84" border="0" /></a></div>
    <div class="frmTopHeader"><img src="/public/images/campaignNMAT/formTopShad.gif" width="474" height="11" /></div>
    <div class="clr"></div>
</div>
</div>
<!--End_topHeader-->
...
<div id="lftColumn">
<div>
<h2>NMAT Score Card 2013</h2>
<h4>Results Declared</h4>
<div class="bubble">Check your NMAT score for MBA &amp; Ph.D in Management</div>
</div>
</div>
<div class="fl_RHT">
<div id="formWrapper">
	<div class="OrgangeFont">Check your NMAT result now</div>
    ...
    <div class="ftrContWrap">
        ...
        <ul>
        	<li>
                ...
                <p>Get your NMAT result</p>
            </li>
            <li>
                <div class="Searchcolz"></div>
                <p>Search and apply for colleges with your NMAT score.</p>
            </li>
            <li>
