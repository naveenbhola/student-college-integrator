...
<title>Shiksha.com - CAT result</title>
<link href="//<?php echo CSSURL; ?>/public/css/<?php echo getCSSWithVersion('marketing'); ?>" type="text/css" rel="stylesheet" />
<link href="//<?php echo CSSURL; ?>/public/css/<?php echo getCSSWithVersion('campaignCAT'); ?>" type="text/css" rel="stylesheet" />
...
<div class="mainWrapper">
	<div class="fl_LFT"><a href="https://www.shiksha.com/" target="_blank" title="Shiksha.com"><img src="/public/images/campaignCAT/shikshaLogo.gif" width="276" height="84" border="0" /></a></div>
    <div class="frmTopHeader"><img src="/public/images/campaignCAT/formTopShad.gif" width="474" height="11" /></div>
    <div class="clr"></div>
</div>
</div>
<!--End_topHeader-->
...
<div class="fl_RHT">
<div id="formWrapper">
	<!--div class="OrgangeFont">Check your result now</div>
    <div class="Txt12">We need a few details from you to create your free shiksha account.</div>
    <!--Start_Form_here-->
    <div><?php $this->load->view('marketing/new_customizedmanagement');?></div>
    <!--End_Form_here--> 	
</div>
<!--End_FormContainer--> 
    ...
    <div class="ftrContWrap">
        ...
        <ul>
        	<li>
                ...
                <p>Get your CAT result.</p>
            </li>
            <li>
                <div class="Searchcolz"></div>
                <p>Search and apply for colleges with your CAT score.</p>
            </li>
            <li>
