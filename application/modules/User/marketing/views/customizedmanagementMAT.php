...
<link href="//<?php echo CSSURL; ?>/public/css/<?php echo getCSSWithVersion('campaignMAT'); ?>" type="text/css" rel="stylesheet" />
...
<div class="mainWrapper">
	<div><a href="https://www.shiksha.com/" target="_blank" title="Shiksha.com"><img src="/public/images/campaignMAT/shikshaLogo.gif" width="276" height="84" border="0" /></a></div>
</div>
</div>
<!--End_topHeader-->
<div class="mainWrapper">
    ...
    <div class="ftrContWrap">
        ...
        <ul>
        	<li>
                ...
                <p>Get your MAT result.</p>
            </li>
            <li>
                <div class="Searchcolz"></div>
                <p>Search and apply for colleges with your MAT score.</p>
            </li>
            <li>
