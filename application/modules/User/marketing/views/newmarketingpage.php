...
<div>
    ...
    <div>
        <div style="float:left;width:460px">
                <div id = "gallery_div_script_tpl" style="width:414px;">&nbsp;</div>
        </div>
        <div style="float:right;width:480px;">
            <div style="background:#f4f4f4">
                <?php $this->load->view('marketing/new_mPageRightPanel');?>
            </div>
        </div>
...
<script id="galleryDiv_script_validate">
    ...
    function RenderInit() {
        ...
        var url = '/marketing/Marketing/load_static_html/1';
        var mysack = new sack();
        mysack.requestFile = url;
        mysack.method = 'POST';
        mysack.onLoading = function() {
            document.getElementById('gallery_div_script_tpl').innerHTML = "";
            document.getElementById('gallery_div_script_tpl').innerHTML = '<p align="center"><img src="/public/images/loader.gif" border="0" />&nbsp;<br/>Please Wait ...</p>';
        };
        mysack.onCompletion = function() {
            document.getElementById('gallery_div_script_tpl').innerHTML = "";
            document.getElementById('gallery_div_script_tpl').innerHTML = mysack.response;
            initGalleryImage();
            autoImg();
        };
        mysack.runAJAX();
...
<img height="1" width="1" style="border-style:none;" alt="" src="https://www.googleadservices.com/pagead/conversion/1053765138/?label=bdFfCNrN6gEQkty89gM&amp;guid=ON&amp;script=0"/>
</div>
</noscript>
-->
