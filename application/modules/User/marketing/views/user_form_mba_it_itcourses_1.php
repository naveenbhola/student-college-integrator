...
<div class="lineSpace_10">&nbsp;</div>
<div><b>Preferred Localities for Studies</b></div>
<div class="lineSpace_5">&nbsp;</div>
<!--Start_perference 1 and perference 2 main Div -->
<div>
    <div>
	<div><div class="" style="padding-right:5px">Preference 1: </div></div>
	<div>
	    <div><select style="width:157px; font-size: 11px;" onchange="load_preference_localities(this);" id="perference1" name="perferencecity[]"><option value="">Select City</option><?php echo $select_city_list;?></select>&nbsp;&nbsp;<select style="width:120px; font-size: 11px;" id="perferencelocality1" name="perferencelocality[]" ><option value="">Select Area</option></select></div>
	...
	<div>
	    ...
	    <div style="">
		<div><select style="width:157px; font-size: 11px;" onchange="load_preference_localities(this);" id="perference2" name="perferencecity[]"><option value="">Select City</option><?php echo $select_city_list;?></select>&nbsp;&nbsp;<select style="width:120px; font-size: 11px;" id="perferencelocality2" name="perferencelocality[]" ><option value="">Select Area</option></select></div>
	...
	<div>
	    ...
	    <div style="">
		<div><select style="width:157px; font-size:11px;" onchange="load_preference_localities(this);" id="perference3" name="perferencecity[]"><option value="">Select City</option><?php echo $select_city_list;?></select>&nbsp;&nbsp;<select style="width:120px; font-size: 11px;" id="perferencelocality3" name="perferencelocality[]" ><option value="">Select Area</option></select></div>
	...
	<div>
	    <div>
                <div>Preference 4: </div>
            </div>

	    <div style="">
		<div><select style="width:157px; font-size: 11px;" onchange="load_preference_localities(this);" id="perference4" name="perferencecity[]"><option value="">Select City</option><?php echo $select_city_list;?></select>&nbsp;&nbsp;<select style="width:120px; font-size: 11px;"  id="perferencelocality4" name="perferencelocality[]" ><option value="">Select Area</option></select></div>
...
<div><div class="errorMsg" id="perference5_error" style="*padding-left:4px;"></div></div>
<div class="lineSpace_10">&nbsp;</div>
...
<div class="lineSpace_10">&nbsp;</div>	    </div>
