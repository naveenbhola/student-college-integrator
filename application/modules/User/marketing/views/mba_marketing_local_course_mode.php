...
?>
<input type = "hidden" name = "mpagename" id = "mpagename" value = "distancelearningmanagement"/>
<div>
...
<div>
    ...
    <div style="margin-left:177px">
        <div>
            <select style="font-size:11px;width:150px" onchange="trackEventByGA('CourseDropDownClick','course drop down clicked');" name = "ug_detials_courses" validate = "validateSelect" required = "true" caption = "UG course" id="ug_detials_courses">
...
<div id="work_experience_block" id="display:none">
    <div class="float_L" style="width:175px;line-height:18px">
        <div class="txt_align_r" style="padding-right:5px">Work Experience<b class="redcolor">*</b>:</div>
    </div>
    <div style="margin-left:177px">
        <div>
        <select caption="your years of experiece" validate="validateSelect" name="ExperienceCombo" id="ExperienceCombo" tip="work_ex" style="width: 150px;">
...
<div class="lineSpace_10">&nbsp;</div>
<div id="action_block">
    <div class="float_L" style="width:175px;line-height:18px">&nbsp;</div>
    <div style="margin-left:177px">
...
<div>
    ...
    <div style="margin-left:177px">
        ...
        required="1" validate="validateMobileInteger" size="30" maxlength="10" minlength="10" id="mobile" name="mobile" class="txt_1" value = "<?php echo $userarray['mobile']?>" />
        </div>
        <div>
...
<!--<div>
        <div class="float_L" style="width:175px;line-height:18px">
            <div class="txt_align_r" style="padding-right:5px">Other Details:</div>
        </div>
        <div style="margin-left:177px">
            <div><textarea blurMethod="checkTextElementOnTransition(this,'blur');" focusmethod="checkTextElementOnTransition(this,'focus');" onfocus="checkTextElementOnTransition(this,'focus');" style="width: 205px; height: 80px;color:#ada6ad;" name="otherdetails" id="otherdetails" validate="validateStr" default="Please specify your budget and preferred institutes/colleges if any." maxlength="500" caption="other details"><?php echo (($otherdetails  == '')?'Please specify your budget and preferred institutes/colleges if any.':$otherdetails ); ?></textarea></div>
            <div>
                <div class="errorMsg" id= "otherdetails_error" style="*padding-left:4px"></div>
            </div>
        </div>
        <div class="clear_L withClear">&nbsp;</div>
</div>-->
