...
<?php
$url = '/user/Userregistration/marketingPageUserOperation';
?>
...
<?php
    ...
    foreach($marketingPageForms[$pageName] as $marketingPageFormField) {
        $this->load->view($marketingPageFormField);
    }
...
?>
    <div align="center">
        <div>
            <input uniqueattr="MarkeingPageAbroadLayer1Submit" type="submit"  id = 'subm' value="<?php echo $submitBtnCaption; ?>" style="border:0  none" class="study_btnReady" <?php if($logged!="No") echo 'disabled = "true"'; ?> uniqueattr="StudyAbroadMarketingPageSubmitButton"/>
        </div>
    </div>
