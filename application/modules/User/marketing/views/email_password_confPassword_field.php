                                ...
                                <div>
                                    ...
                                    <div style="float:left;width:155px">
										<div>
											<input type="text" id = "homeemail" name = "homeemail" value="<?php echo $userEmail; ?>" validate = "validateEmail" required = "true" caption = "email id" maxlength = "125" style = "width:150px;height:15px;font-size:12px" tip="email_idM" />
										</div>
										<div>
