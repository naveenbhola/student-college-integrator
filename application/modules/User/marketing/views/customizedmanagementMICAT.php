...
<title>Shiksha.com - MICAT result</title>
<link href="//<?php echo CSSURL; ?>/public/css/<?php echo getCSSWithVersion('marketing'); ?>" type="text/css" rel="stylesheet" />
<link href="//<?php echo CSSURL; ?>/public/css/<?php echo getCSSWithVersion('campaignMICAT'); ?>" type="text/css" rel="stylesheet" />
...
<div class="mainWrapper">
	<div class="fl_LFT"><a href="https://www.shiksha.com/" target="_blank" title="Shiksha.com"><img src="/public/images/campaignMICAT/shikshaLogo.gif" width="276" height="84" border="0" /></a></div>
    <div class="frmTopHeader"><img src="/public/images/campaignMICAT/formTopShad.gif" width="474" height="11" /></div>
    <div class="clr"></div>
</div>
</div>
<!--End_topHeader-->
...
<div class="bubble">Check your MICAT score for MBA &amp; Ph.D in Management</div>
</div>
</div>
<div class="fl_RHT">
<div id="formWrapper">
	<div class="OrgangeFont">Check your MICAT result now</div>
...
<div class="Txt13">Just fill in the small form on top to mention your educational preferences.</div>
</div>
</div>
</div>
<!--start_Footer-->
    ...
    <div class="ftrContWrap">
        ...
        <ul>
        	<li>
                ...
                <p>Get your MICAT result</p>
            </li>
            <li>
                <div class="Searchcolz"></div>
                <p>Search and apply for colleges with your MICAT score.</p>
            </li>
            <li>
                <div class="CnctMBA"></div>
                <p>Connect with other MBA aspirants.</p>
            </li>
            <li>
                <div class="ExprtAdv"></div>
                <p>Get expert advice from our panelists.</p>
            </li>
            <li>
                <div class="almReview"></div>
                <p>Get alumni review for MBA colleges.</p>
            </li>
        </ul>
        <div class="clr" style="height:53px;"></div>
    	<div class="sepratorDiv"><span style="font-size:1px;"> </span></div>
    	<div class="ftrTxt">Copyright &copy; 2012 Info Edge India Ltd. All rights reserved.</div>
    </div>
   </div>
</div>
<!--end_Footer-->
