...
<input type = "hidden" name = "marketingpagename" id = "marketingpagename" value = ""/>
                            ...
                            <div class="formFieldTextRight">
								<div style="width:100%">
                                    <div id="subCategory1" style="width:200px;border:1px solid #CCC;padding:5px 0;height:55px;overflow:auto">
                                        ...
                                        style="float:left;width:18px"><input style="margin:0" type="checkbox"
			  name="specializationId[]" value="<?php echo  $value['SpecializationId']; ?>"></span> <strong
			  style="float:left;font-weight:normal; width:155px; line-height:normal;"><?php echo
		$value['SpecializationName'];	  ?></strong></label>
                                        <?php endforeach; ?>
                                    </div>
