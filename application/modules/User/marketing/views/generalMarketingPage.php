...
<?php
    ...
    $headerHtml = $this->load->view('marketing/headerView'.$pageName,array(),true);
   			...
   			<div style="width:480px;float:left">
            	<div style="margin-left:15px">
                	...
                	<div style="width:465px">
   			            <?php $this->load->view('marketing/'.$pageName .'FormHeader');?>
						<?php $this->load->view('marketing/genralMarketingPageForm');?>
                    </div>
                    <!--End_Form-->
                </div>
            </div>
...
<div id="emptyDiv" style="display:none;">&nbsp;</div>
        ...
        <script language="javascript" src="//<?php echo JSURL; ?>/public/js/<?php echo getJSWithVersion("studyAbroad"); ?>"></script>
