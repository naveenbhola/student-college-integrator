...
Please find attached e-brochure for <?php echo htmlentities($courseName);?> at <?php echo htmlentities($instituteName);?>.<br/>
You can also view latest updates about this course by visiting <a href="<?php echo $URL;?><!-- #Tracking --><!-- Tracking# -->">shiksha.com</a>. 
<br /><br />
