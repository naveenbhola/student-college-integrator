...
<?php }?>
You requested e-brochure for <?php echo htmlentities($courseName);?>, <?php echo htmlentities($universityName);?>, <?php echo htmlentities($countryName);?>:<br/>
<a href="<?php echo $brochureDownloadLink;?><!-- #Tracking --><!-- Tracking# -->" target="_blank">Click here to download ebrochure</a>.
<br/><br/>Find out more details of this course, <a href = "<?php echo $URL;?>">visit this link</a> 
...
<br/>
<br/>
Looking for similar courses? Visit us at <a href="<?php echo SHIKSHA_STUDYABROAD_HOME; ?><!-- #Tracking --><!-- Tracking# -->">studyabroad.shiksha.com</a>
