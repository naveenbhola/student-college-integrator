...
<div>
    ...
    <div style="margin-left:190px">
        <div>
            <select style="font-size:11px;width:150px" onchange="trackEventByGA('CourseDropDownClick','course drop down clicked');" name = "ug_detials_courses" validate = "validateSelect" required = "true" caption = "your graduation course" id="ug_detials_courses_unifiedregistration">
        ...
        <div>
            <div class="errorMsg" id="ug_detials_courses_unifiedregistration_error" style="padding-left:8px;*padding-left:4px"></div>
        </div>
        <div>
        <div class="errorMsg" id="ug_detials_courses_marks_unifiedregistration_error" style="padding-left:8px;*padding-left:4px"></div>
        </div>
    </div>
    <div class="clear_L withClear">&nbsp;</div>
</div>
...
<div>
	...
	<div style="margin-left:190px">
	    <div><select style="width:109px" onchange="ShikshaUnifiedRegistarion.load_preference_localities(this);" id="perference1_unifiedregistration" name="perferencecity[]"><option value="">Select City</option><?php echo $select_city_list;?></select>&nbsp;&nbsp;<select style="width:109px;" id="perferencelocality1_unifiedregistration" name="perferencelocality[]"><option value="">Select Area</option></select></div>
