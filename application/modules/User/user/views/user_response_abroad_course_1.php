...
<?php }?>
Your requested e-brochure is <u>attached</u> in this email:<br/>
<?php echo htmlentities($courseName);?>, <?php echo htmlentities($universityName);?>, <?php echo htmlentities($countryName);?><br/>
<br/>
