...
Sorry, currently we do not have brochure available for <?php echo htmlentities($courseName);?> at <?php echo htmlentities($instituteName);?>.<br/>
However, you can view latest updates about this course by visiting <a href="<?php echo $URL;?><!-- #Tracking --><!-- Tracking# -->">shiksha.com</a>. 
<br /><br />

Regards,<br />
<b style="color:#FF7E00;">Shiksha</b><b style="color:#231E19;">.com</b><br />
</div></td>
  </tr>
</table>
