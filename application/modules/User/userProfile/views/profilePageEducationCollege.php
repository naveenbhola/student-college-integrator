...
<div class="prf-edu">
                              ...
                              if($publicProfile != true){
                                $x = "{0:'InstituteName$level',1:'CourseCompletionDate$level',2:'Board$level',3:'Subjects$level',4:'Marks$level',5:'Name$level',6:'CourseSpecialization$level'}";
                               ...
                               <div class="edu-dtls">
                                  ...
                                  <?php if(!empty($Subjects) && 0){ ?><p>Subjects:<span><?php echo $Subjects;?></span></p><?php }?>
