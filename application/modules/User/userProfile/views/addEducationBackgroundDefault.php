...
$cbseMarks = array(4=>'4 - 4.9', 5=>'5 - 5.9', 6=>'6 - 6.9', 7=>'7 - 7.9', 8=>'8 - 8.9', 9=>'9 - 10.0');
                                ...
                                <ul id ="<?php echo $level ?>" class="p-ul">
                                  ...
                                  <div class="remove-lnk">
                                    ...
                                    <li class="p-l">
                                      ...
                                      <span ><div class="regErrorMsg" style="display:none" id="undefinedCourseLevel">Please select course level</div></span >   
                                      </span>

                                       <span class="p-s" id='searchBoxCampusConnect'>
                                         <label>School Name<i>*</i></label>
                                          <input id="<?php echo $nameInstitute[$levelKey].'_'.$regFormId;?>" maxlength =150 mandatory="1" profanity="1" label="School Name"  default="School Name" caption="your School Name" regFieldId ="<?php echo $nameInstitute[$levelKey]?>" onblur="shikshaUserProfileForm['<?php echo $regFormId; ?>'].validateField(this); showCourseLevelError('undefined');" type="text" name="<?php echo $nameInstitute[$levelKey]?>" value="<?php echo  $InstituteName;?>" class="prf-inpt" />
                                    ...
                                    <li  class="p-l">
                                      <span tabIndex=1 onblur="hideSubjectLayer();" class="p-s">
                                         <label>Subjects</label>

                                              <div class="custom-drp">
                                              <p class="custm-srch"  onclick="displaySubjects();applyScrollBar('abc');" >Select Subjects</p>              
                                     ...
                                     <p class="clr"></p>
                                       ...
                                       <span class="p-s">
                                         ...
                                         <div class="custom-drp">
                                          ...
                                          <select id="marks_percnt_<?php echo $level?>" <?php if ($Board != 'ICSE'){?>style="display:none" <?php } else{?> name="<?php echo $nameMarks[$levelKey]?>" <?php }?> class="dfl-drp-dwn"  >
