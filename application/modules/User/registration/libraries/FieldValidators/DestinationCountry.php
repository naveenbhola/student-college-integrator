...
/**
 * Validator File for destination country field
 */ 

namespace registration\libraries\FieldValidators;

/**
 * Validator for destination country field
 */ 
class DestinationCountry extends AbstractValidator
{
	/**
	 * Constrcutor
	 */ 
	...
	public function validate(\registration\libraries\RegistrationFormField $field,$value,$data)
    {
		...
		/**
		 * For destination country, $value must be an array
		 */ 
		if(!is_array($value)) {
			return FALSE;
		}
