<div> 
  ...
  <div class="text-show otp-fixed">
<div class="otp-col clearFix mobile-otp-layer" id="user-Authentication-otp_<?php echo $regFormId; ?>" >
      ...
      <div class="otp-box userOTPVerification" id="user-Authentication_<?php echo $regFormId; ?>">
          ...
          <p class="pin-sent">PIN has been sent to your mobile <span id="yourMobile_<?php echo $regFormId; ?>" class="yourMobile"><?php echo $mobile; ?></span></p>
          ...
          <div class="change-box changeMobileLayer" id="changeMobileLayer" style="display:none">
               <p class="label">Enter your new mobile number</p>
                 <div class="enter-m-number"> 
                  <input type="number" id="newMobileNumber_<?php echo $regFormId; ?>" maxlength="10" class="enter-pin enter-m-number" placeholder="ENTER MOBILE NUMBER"/>
             ...
             <div class="show-otp-enter-box enterMobilePin" id="enterMobilePin">
                <p class="enter-rcv-pin" >Please enter the PIN received on your mobile</p>
                  <input type="number" class="enter-pin" placeholder="ENTER PIN" id="one-time-pass_<?php echo $regFormId; ?>" maxlength="6"/>
                    <div id="pin-Error_<?php echo $regFormId; ?>" class="regErrorMsg"></div>
                    <a class="r-pin" onclick="shikshaUserRegistrationForm['<?php echo $regFormId; ?>'].userVerificationLayer(null, 1);">Resend PIN</a> 
