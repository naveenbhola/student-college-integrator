...
?>
<li>
     <input type="submit" id="registrationSubmit_<?php echo $regFormId; ?>" value="Submit" class="orange-button" <?php if($formData['userId']) echo "disabled='disabled'"; ?> onclick="trackEventByGA('ASK_NOW_BUTTON','SHIKSHA_INTERMEDIATE_PAGE'); return shikshaUserRegistrationForm['<?php echo $regFormId; ?>'].submitForm()" />
</li>
...
<input type='hidden' id='registrationSource' name='registrationSource' value='shikshaCafe' />
