				...
				<div id="sndscreenScroll_<?php echo $regFormId; ?>" class="acc-psnlInfo ">
					...
					<div class="regtbs mt2 clearfix">
	 							<div class="overview">
									...
									<?php $this->load->view('registration/fields/LDB/response/clientCourse'); ?>
								...
								<a href="javascript:void(0);" class="reg-btn sup-btn stp2 resp-btn" tabindex="2" regformid="<?php echo $regFormId; ?>" style="right:898px !important;"><?php if(!empty($submitButtonText)){ echo $submitButtonText; }else{ echo 'Signup'; }?></a>
			</div>
