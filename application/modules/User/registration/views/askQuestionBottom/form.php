...
<?php if($isFullRegisteredUser): ?>
    <a href="javascript:void(0);" type="button" id="registrationSubmit_<?php echo $regFormId; ?>" value="<?php echo $buttonText ? $buttonText : 'Download E-Brochure';?>" class="big-button orange-btn2" onclick="trackEventByGA('ASK_NOW_BUTTON','LISTING_DETAIL_PAGE_QNA_TAB_TOP');return shikshaUserRegistrationForm['<?php echo $regFormId; ?>'].submitResponse();return false;" ><?php echo $buttonText ? $buttonText : 'Ask Now';?></a>
<?php else: ?>
    <input type="submit" id="registrationSubmit_<?php echo $regFormId; ?>" value="<?php echo $buttonText ? $buttonText : 'Ask Now';?>" class="orange-button" onclick="trackEventByGA('ASK_NOW_BUTTON','LISTING_DETAIL_PAGE_QNA_TAB_TOP');return shikshaUserRegistrationForm['<?php echo $regFormId; ?>'].submitForm()" />
<?php endif; ?>
