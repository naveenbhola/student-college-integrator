<?php if(!empty($customFormData['institute_courses'])){ ?>
	<div>
		<!-- <div><p class="field-title">Please select client course</p></div> -->
		<div style="position:relative;">
			<div class="reg-form signup-fld invalid ssLayer" layerFor="clientCourse" regFormId="<?php echo $regFormId; ?>" regfieldid="clientCourse" id="clientCourse_block_<?php echo $regFormId; ?>" type="layer" hasOptGroup="yes" label="Course">
