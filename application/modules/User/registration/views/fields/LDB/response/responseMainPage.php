<?php 
	...
	if(!empty($workExList)){ 
		echo $this->load->view('registration/fields/LDB/response/workExp'); 
	}
?>

<div><p class="field-title mt10">The course you're interested in is available in multiple streams. What is your preferred stream?</p></div>
