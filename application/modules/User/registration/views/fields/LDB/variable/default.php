...
?>
        <li <?php echo $registrationHelper->getBlockCustomAttributes('preferredStudyLocation'); ?>>
            <div style="width:100%" class="selectStyleDiv" id="preferredStudyLocationLayerButton_<?php echo $regFormId; ?>" onclick="shikshaUserRegistrationForm['<?php echo $regFormId; ?>'].showPreferredStudyLocationLayer(event)">
...
?>
        <li <?php echo $registrationHelper->getBlockCustomAttributes('residenceCityLocality'); ?>>
            <div>
                <div class="custom-dropdown">
                    <select id="residenceCityLocality_<?php echo $regFormId; ?>" name="residenceCityLocality" prefNum='1' <?php echo $registrationHelper->getFieldCustomAttributes('residenceCityLocality'); ?> onchange="shikshaUserRegistrationForm['<?php echo $regFormId; ?>'].populateLocalitiesNew(this); autoPopulateLocality(this, '<?php echo $formData['widget']; ?>','<?php echo $regFormId; ?>')" onblur="shikshaUserRegistrationForm['<?php echo $regFormId; ?>'].validateField(this)">
...
<?php
	break;
    case 'password':
	$fields[$fieldId]->setMandatory(true);
?>
