<div class="ih">
	...
	<!-- <input type="hidden" value="" name="credential" id="credential_< ?php echo $regFormId; ?>" /> -->
...
<?php if(count($level) > 1){ 
	...
	<div style="position:relative;">
		<div class="reg-form signup-fld invalid ssLayer" layerFor="level" regFormId="<?php echo $regFormId; ?>" regfieldid="level" id="level_block_<?php echo $regFormId; ?>" type="layer" label="Level" withoutOptGrp="yes" layertitle="Level" layerHeading="Level" sub-label="Select one">
