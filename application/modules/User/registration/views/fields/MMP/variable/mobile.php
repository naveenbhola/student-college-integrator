...
<?php
            /*$examFieldValueSource = $fields['exams']->getValueSource();
            $examFieldForm = $fields['exams']->getForm();
            $formSelectedDesiredCourse = $examFieldValueSource->getSelectedDesiredCourse(array('form' =>$examFieldForm));
            if($formSelectedDesiredCourse == 2 || $courseGroup == 'studyAbroad') { */
?>          
			<!-- <li data-enhance="false" <?php echo $registrationHelper->getBlockCustomAttributes('exams','float:left !important;'); ?>>
				<p>Exams Taken<span><?php echo $registrationHelper->markMandatory('exams'); ?></span> :</p>
				<div class='fields-col'>
					<div class="fields-row clearfix"> -->
					<?php //if($courseGroup == 'studyAbroad') { ?>
						<!-- <label><input type="checkbox" name="exams[]" class="exams_<?php echo $regFormId; ?>" regfieldid="exams" caption="exams" value="TOEFL"> TOEFL</label>
						<label><input type="checkbox" name="exams[]" class="exams_<?php echo $regFormId; ?>" regfieldid="exams" caption="exams" value="IELTS"> IELTS</label>
						<span id="SAT_wrapper_<?php echo $regFormId; ?>">
							<label><input type="checkbox" name="exams[]" class="exams_<?php echo $regFormId; ?>" regfieldid="exams" caption="exams" value="SAT" id="exam_SAT_<?php echo $regFormId; ?>" onclick="shikshaUserRegistrationForm['<?php echo $regFormId; ?>'].toggleExamScore(this);"> SAT</label>
							<input type="text" class="textbox2" name="SAT_score" id="SAT_score_<?php echo $regFormId; ?>" regFieldId="SAT_score" style="width:60px !important; display: none" value="Score" default="Score" caption="SAT score" maxlength="4" minscore="600" maxscore="2400" onfocus="shikshaUserRegistrationForm['<?php echo $regFormId; ?>'].removeHelpText(this);" onblur="shikshaUserRegistrationForm['<?php echo $regFormId; ?>'].restoreHelpText(this); shikshaUserRegistrationForm['<?php echo $regFormId; ?>'].validateField(this);" />
						</span>
						<div>
							<span id="GMAT_wrapper_<?php echo $regFormId; ?>" style="display:none;">
								<label><input type="checkbox" name="exams[]" class="exams_<?php echo $regFormId; ?>" regfieldid="exams" caption="exams" value="GMAT" id="exam_GMAT_<?php echo $regFormId; ?>" onclick="shikshaUserRegistrationForm['<?php echo $regFormId; ?>'].toggleExamScore(this);"> GMAT</label>
								<input type="text" class="textbox2" name="GMAT_score" id="GMAT_score_<?php echo $regFormId; ?>" regFieldId="GMAT_score" style="width:60px !important; display: none" value="Score" default="Score" caption="GMAT score" maxlength="3" minscore="400" maxscore="800" onfocus="shikshaUserRegistrationForm['<?php echo $regFormId; ?>'].removeHelpText(this);" onblur="shikshaUserRegistrationForm['<?php echo $regFormId; ?>'].restoreHelpText(this); shikshaUserRegistrationForm['<?php echo $regFormId; ?>'].validateField(this);" />
							</span>
							<span id="GRE_wrapper_<?php echo $regFormId; ?>" style="display:none;">
								<label><input type="checkbox" name="exams[]" class="exams_<?php echo $regFormId; ?>" regfieldid="exams" caption="exams" value="GRE" id="exam_GRE_<?php echo $regFormId; ?>" onclick="shikshaUserRegistrationForm['<?php echo $regFormId; ?>'].toggleExamScore(this);"> GRE</label>
								<input type="text" class="textbox2" name="GRE_score" id="GRE_score_<?php echo $regFormId; ?>" regFieldId="GRE_score" style="width:60px !important; display: none" value="Score" default="Score" caption="GRE score" maxlength="4" minscore="500" maxscore="1600" onfocus="shikshaUserRegistrationForm['<?php echo $regFormId; ?>'].removeHelpText(this);" onblur="shikshaUserRegistrationForm['<?php echo $regFormId; ?>'].restoreHelpText(this); shikshaUserRegistrationForm['<?php echo $regFormId; ?>'].validateField(this);" />
							</span>
						</div> -->
					<?php //} else { ?>
						<!-- <div class="fields-row clearfix">
						<label style="width:65px"><input type="checkbox" name="exams[]" class="exams_<?php echo $regFormId; ?>" regfieldid="exams" caption="exams" value="CAT" onclick="shikshaUserRegistrationForm['<?php echo $regFormId; ?>'].toggleExamScore(this);" /> CAT</label><input type="text" class="textbox2" name="CAT_score" id="CAT_score_<?php echo $regFormId; ?>" regFieldId="CAT_score" style="width:70px !important; display: none" value="Percentile" default="Percentile" caption="CAT percentile" maxlength="5" onfocus="shikshaUserRegistrationForm['<?php echo $regFormId; ?>'].removeHelpText(this);" onblur="shikshaUserRegistrationForm['<?php echo $regFormId; ?>'].restoreHelpText(this); shikshaUserRegistrationForm['<?php echo $regFormId; ?>'].validateField(this);" />
						</div>
						<div class="fields-row clearfix">
						<label style="width:65px"><input type="checkbox" name="exams[]" class="exams_<?php echo $regFormId; ?>" regfieldid="exams" caption="exams" value="MAT" onclick="shikshaUserRegistrationForm['<?php echo $regFormId; ?>'].toggleExamScore(this);" /> MAT</label><input type="text" class="textbox2" name="MAT_score" id="MAT_score_<?php echo $regFormId; ?>" regFieldId="MAT_score" style="width:70px !important; display: none" value="Percentile" default="Percentile" caption="MAT percentile" maxlength="5" onfocus="shikshaUserRegistrationForm['<?php echo $regFormId; ?>'].removeHelpText(this);" onblur="shikshaUserRegistrationForm['<?php echo $regFormId; ?>'].restoreHelpText(this); shikshaUserRegistrationForm['<?php echo $regFormId; ?>'].validateField(this);" />
						</div>
						<div class="fields-row clearfix">
						<label style="width:65px"><input type="checkbox" name="exams[]" class="exams_<?php echo $regFormId; ?>" regfieldid="exams" caption="exams" value="CMAT" onclick="shikshaUserRegistrationForm['<?php echo $regFormId; ?>'].toggleExamScore(this);"> CMAT</label><input type="text" class="textbox2" name="CMAT_score" id="CMAT_score_<?php echo $regFormId; ?>" regFieldId="CMAT_score" style="width:70px !important; display: none" value="Score" default="Score" caption="CMAT score" maxlength="5" minscore="0" maxscore="400" onfocus="shikshaUserRegistrationForm['<?php echo $regFormId; ?>'].removeHelpText(this);" onblur="shikshaUserRegistrationForm['<?php echo $regFormId; ?>'].restoreHelpText(this); shikshaUserRegistrationForm['<?php echo $regFormId; ?>'].validateField(this);" />
						</div> -->
					<?php //} ?>
					<!-- </div>
					<div>
					...
					<?php /*foreach(array('CAT','MAT','CMAT','SAT','GMAT','GRE') as $examWithScore) { ?>
						<div>
...
?>
        <li <?php echo $registrationHelper->getBlockCustomAttributes('isdCode'); ?>>
                ...
                <select name="isdCode" id="isdCode_<?php echo $regFormId; ?>" onchange="shikshaUserRegistrationForm['<?php echo $regFormId; ?>'].changeDesiredCourse();" regFieldId="isdCode" class="register-fields" minlength="2" maxlength="4" profanity="1" <?php echo $registrationHelper->getFieldCustomAttributes('isdCode'); ?> onblur="shikshaUserRegistrationForm['<?php echo $regFormId; ?>'].validateField(this); shikshaUserRegistrationForm['<?php echo $regFormId; ?>'].changeMobileFieldMaxlength(this.value);">
