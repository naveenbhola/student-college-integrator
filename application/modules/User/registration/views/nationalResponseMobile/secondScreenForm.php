...
<div class="SgUp-lyr" data-enhance="false">
	...
	<div class="SgUp-lyr" data-enhance="false">
	<div class="head">
		<p class="head-title fs16" id="title1_<?php echo $regFormId; ?>"><?php if(!empty($formHeading)){
		...
		<a href="javascript:void(0);" class="lyr-cls pg2cross" data-rel="back">&times;</a>
		<?php } ?>
		<div class="clear"></div>
	</div>
...
?>
	...
	<div class="Sgup-FrmSec">
		...
		<div class="scrolable-vport" id="sndscreenSroll_<?php echo $regFormId; ?>">
			...
			<input type="hidden" id="tracking_keyid_<?php echo $regFormId; ?>" name="tracking_keyid" value='<?php echo empty($trackingKeyId)?DEFAULT_TRACKING_KEY_MOBILE:$trackingKeyId; ?>' />
