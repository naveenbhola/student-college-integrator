        ...
        <ul>
            <li>
                ...
                <div class="predictor-column flLt">
			        ...
			        <div style="display:none;" id="scrError">
                        <div class="predictor-errmsg" id="rankPredictor_Score<?php echo $regFormId; ?>_error"></div>
                    </div>
                </div>

                <!-- <div class="predictor-column flRt">
                    <label><?php echo $rpConfig[$examName]['inputField']['marks']['label'];?> </label><br />
                    <input type="text" class="predictor-textfield" id="rankPredictor_BoardMarks<?php echo $regFormId; ?>" name="rankPredictor_BoardMarks" maxlength="<?php echo $rpConfig[$examName]['inputField']['marks']['maxLength'];?>" minlength="<?php echo $rpConfig[$examName]['inputField']['marks']['minLength'];?>" validate="validateFloat" caption="board marks" required = "true"/>
				    <div style="display:none;" id="pcmError">
                        <div class="predictor-errmsg" id="rankPredictor_BoardMarks<?php echo $regFormId; ?>_error"></div>
                    </div>
                </div> -->

                <div class="predictor-column flRt">
                    <label><?php echo $rpConfig[$examName]['inputField']['rollNo']['label'];?> </label><br />
                    <input type="text" class="predictor-textfield" id="rankPredictor_RollNo<?php echo $regFormId; ?>" name="rankPredictor_RollNo" maxlength="<?php echo $rpConfig[$examName]['inputField']['rollNo']['maxLength'];?>" minlength="<?php echo $rpConfig[$examName]['inputField']['rollNo']['minLength'];?>" validate="validateStr" caption="roll no" required = "true"/>
                    <div style="display:none;">
                        <div class="predictor-errmsg" id="rankPredictor_RollNo<?php echo $regFormId; ?>_error"></div>
                    </div>
                </div>
            ...
            <li>
                ...
                <div class="predictor-column flLt" <?php echo $registrationHelper->getBlockCustomAttributes('firstName', ''); ?>>
				    ...
				    <div>
                        <div class="predictor-errmsg" id="firstName_<?php echo $regFormId; ?>_error"></div>
                    </div>
                </div>
                 ...
                 <div class="predictor-column flRt" <?php echo $registrationHelper->getBlockCustomAttributes('lastName', ''); ?>>
                    ...
                    <div>
                        <div class="predictor-errmsg" id="lastName_<?php echo $regFormId; ?>_error"></div>
                    </div>
                </div>
            ...
            <li>
                ...
                <div class="predictor-column flLt" <?php echo $registrationHelper->getBlockCustomAttributes('email'); ?>>
                    ...
                    <div id="email_rpr<?php echo $regFormId; ?>">
                        <div class="predictor-errmsg" id="email_<?php echo $regFormId; ?>_error"></div>
                    </div>
                </div>
                
                 <div style="position:relative;" class="predictor-column flRt" <?php echo $registrationHelper->getBlockCustomAttributes('password', ''); ?>>
            ...
            <li>
                ...
                <div class="predictor-column flLt">
                    <div style="width:48%" class='flLt' <?php echo $registrationHelper->getBlockCustomAttributes('isdCode','');?>>
                        ...
                        <div style="display:none;">
                            <div class="errorMsg" id="isdCode_<?php echo $regFormId; ?>_error" style="*float:left"></div>
                        </div>
                    ...
                    <div style="width:48%" class='flRt' <?php echo $registrationHelper->getBlockCustomAttributes('mobile'); ?>>
                        ...
                        <div>
                            <div class="predictor-errmsg" id="mobile_<?php echo $regFormId; ?>_error"></div>
                        </div>
                    </div>
                ...
                <div class="predictor-column flRt" <?php echo $registrationHelper->getBlockCustomAttributes('residenceCity',''); ?>>
                    ...
                    <span id="residentCityParentDiv_<?php echo $regFormId; ?>" >
                        ...
                        <div>
                            <div id="residenceCityLocality_<?php echo $regFormId; ?>_error" class="predictor-errmsg"></div>
                        </div>
