...
<div>
    ...
    <div style="width:63%; float:right;text-align:left;">
        <div>
            <select style="font-size:11px;width:90%;" name = "plan" blurMethod="when_plan_start();" required = "true" caption = "when you plan to start the course" id="when_plan_start"><option value="">Select</option>
            <?php
            $array= array(
            ...
            foreach ($array as $key => $value)  {
                        ...
                        // we dont want any pre selected value here
                        $selected_string = "";
...
<div class="lineSpace_10">&nbsp;</div>
    ...
    <div style="width:63%;float:right;text-align:left;">
        <div>
        <select caption="your years of experience"  name="ExperienceCombo" id="ExperienceCombo"  style="width:90%;">
...
<div class="lineSpace_10">&nbsp;</div>
<div style="padding-left:20px"><b>Preferred Localities for Studies</b></div>
<div class="lineSpace_5">&nbsp;</div>
<!--Start_perference 1 and perference 2 main Div -->
<div>
    <div>
	<div class="float_L" style="width:35%;line-height:18px"><div class="txt_align_r" style="padding-right:5px">Preference 1: </div></div>
	<div style="width:63%;float:right;text-align:left;">
	    <div><select style="width:45%;" onchange="load_preference_localities(this);" id="perference1" name="perferencecity[]"><option value="">Select City</option><?php echo $select_city_list;?></select>&nbsp;&nbsp;<select style="width:45%;" id="perferencelocality1" name="perferencelocality[]"><option value="">Select Area</option></select></div>
	...
	<div>
	    <div class="float_L" style="width:35%;line-height:18px"><div class="txt_align_r" style="padding-right:5px">Preference 2: </div></div>
	    <div style="width:63%;float:right;text-align:left;">
		<div><select style="width:45%;" onchange="load_preference_localities(this);" id="perference2" name="perferencecity[]"><option value="">Select City</option><?php echo $select_city_list;?></select>&nbsp;&nbsp;<select style="width:45%;" id="perferencelocality2" name="perferencelocality[]" ><option value="">Select Area</option></select></div>
	...
	<div class="lineSpace_7">&nbsp;</div>
	<div>
	    <div class="float_L" style="width:35%;line-height:18px"><div class="txt_align_r" style="padding-right:5px">Preference 3: </div></div>
	    <div style="width:63%;float:right;text-align:left;">
		<div><select style="width:45%;" onchange="load_preference_localities(this);" id="perference3" name="perferencecity[]"><option value="">Select City</option><?php echo $select_city_list;?></select>&nbsp;&nbsp;<select style="width:45%;"  id="perferencelocality3" name="perferencelocality[]" ><option value="">Select Area</option></select></div>
	...
	<div class="lineSpace_7">&nbsp;</div>
	<div>
	    <div class="float_L" style="width:35%;line-height:18px"><div class="txt_align_r" style="padding-right:5px">Preference 4: </div></div>
	    <div style="width:63%;float:right;text-align:left;">
		<div><select style="width:45%;" onchange="load_preference_localities(this);" id="perference4" name="perferencecity[]"><option value="">Select City</option><?php echo $select_city_list;?></select>&nbsp;&nbsp;<select style="width:45%;"  id="perferencelocality4" name="perferencelocality[]" ><option value="">Select Area</option></select></div>
...
<div>
    <div class="float_L" style="width:35%;line-height:18px"></div>
    <div style="width:63%;float:right;text-align:left;">
...
<!--<div><div class="errorMsg" id="perference5_error" style="*padding-left:4px;width:70%;text-align:right;"></div></div>-->
<div class="lineSpace_10">&nbsp;</div>
...
<div>
        <div class="float_L" style="width:35%;">
...
<div>
    ...
    <div style="width:63%;float:right;text-align:left;">
        ...
        <div class="lineSpace_10">&nbsp;</div>
    <div id="residenceLocation" style="display:none;padding-top:10px;margin-top:10px;">
    <div class="float_L" style="width:35%;line-height:18px">
        <div class="txt_align_r" style="padding-right:5px">Residence Location<b class="redcolor">*</b>:</div>
    </div>
    <div style="width:63%;float:right;text-align:left;">
    <div>
        <select  caption = "city of residence" style = "width:65%;" class = "normaltxt_11p_blk_arial fontSize_11p" id ="citiesofquickreg" name = "citiesofquickreg" blurMethod = "validate_combo();" >
            ...
            ?>
                <!--we dont want any pre selected value-->
