...
<table cellspacing="0" cellpadding="10" border="0" width="960">
	<tbody>
		<tr>
			...
			<form
				action="/customizedmmp/mmp/saveMMPageCourses/<?php echo $page_id?>/<?php echo $page_type?>"
			...
			<button type="button" style="padding-left:10px;" onclick="location.replace('/customizedmmp/mmp/')"
			...
			<select id="moveFrom" name="moveFrom[]" size="10"  style="height:200px;width:400px;" size="10">
				...
				<?php if ($key != '14') { ?>
					<option value="<?php echo $key;?>" id="<?php echo $key;?>"><?php echo
$course?></option>
				<?php } ?>	
					<?php endforeach;?>
			</select>
