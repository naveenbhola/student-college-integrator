...
<?php for($i = 0 ; $i < count($courseList) && $i <2 ; $i++) { 
                        ...
                        $courseUrl = getSeoUrl($courseList[$i]['course_id'],"naukrishikshacourse",$courseList[$i]['courseTitle'],$tempOptionalArgs);
                        ?>
                    <div class="cbullets">
                        ...
                        ?>
                        <div style="margin-right:70px <?php echo $class_style; ?>" <?php echo $class; ?> >
                        <a href="<?php echo (($ListingMode == 'view') ?$courseUrl:'#'); ?>"><?php echo $courseList[$i]['courseTitle']; ?></a>
                        <div>   
...
<?php } ?>
                    ...
                    <div id="contractIcon" style="padding-left:20px;display:none;"><!--<img src="/public/images/plusSign.gif" />-->- <a href="#" onClick="javascript:hideAllCourses();return false;">Hide Courses</a></div>
<?php } ?>
