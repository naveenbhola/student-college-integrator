<div style="position:relative;">
    <table class="uni-table" cellspacing="0" cellpadding="0" style="padding:0px 15px;">
        <tr>
                    ...
                    <label class="l-width">Showing featured content of:</label>
                        ...
                        <ul id="examSearchFeatured" class="examSearch" style="display:none;">
                            <?php foreach($examList as $id=>$name){?>
                                <li><a href="/examPages/ExamMainCMS/manageExamPageFeaturedContent/featuredExam?examId=<?=$id?>"><?=$name?></a></li>
                            <?php } ?>
                        </ul>                         
                </div>
            ...
            <td width="21%">
               <a class="mnge-dv" style="padding:10px;" href="/examPages/ExamMainCMS/manageExamPageFeaturedContent/featuredExam">Reset Exam</a>
            </td>
        </tr>
...
<div class="search-section" style="box-sizing:border-box;padding:0 15px;">
    <table class="cms-table-structure" border="1" cellspacing="0" cellpadding="0" id='examFeaturedList'>
        <?php 
        ...
        ?>
            <tr>
                ...
                <th width="10%">Featured Exam</th>
                <th width="10%">Featured Exam Course</th>
            ...
            <?php $this->load->view('examPages/cms/featuredExamTableData');
         }
         if(count($featuredData) < 1)
            {
                echo '<tr class="no-update">';
                echo '<td colspan="10">No featured exams found.</td>';
                echo '</tr>';
            }
        ?>
    </table>
