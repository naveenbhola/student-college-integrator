<?php 
$examTitle     = ucwords($param['examName']);
    ...
    <span itemtype="https://data-vocabulary.org/Breadcrumb" itemscope=""><a itemprop="url" href="<?php echo SHIKSHA_HOME;?>"><span itemprop="title">Home</span></a></span>
        ...
        <?php if(!empty($examTitle)){
        		if($courseName){?>
    				...
    				<?php }else{?>
    					<span itemtype="https://data-vocabulary.org/Breadcrumb" itemscope="">
			        		<a itemprop="url" href="<?php echo $domain.'/'.strtolower(seo_url($courseName, "-", 30)).'/exams/'.strtolower(seo_url($examTitle, "-", 30));?>">
    			...
    			<?php }else if($streamName !='' && empty($substreamName)){?>
    				...
    				<?php }else{?>
    					<span itemtype="https://data-vocabulary.org/Breadcrumb" itemscope="">
			        		<a itemprop="url" href="<?php echo $domain.'/'.strtolower(seo_url($streamName, "-", 30)).'/exams/'.strtolower(seo_url($examTitle, "-", 30));?>">
			        			<span itemprop="title"><?php echo $examTitle;?></span>
			        		</a>
		    			</span>
    					<span class="breadcrumb-arrow">&rsaquo;</span>
    			...
    			<?php }else if($streamName !='' && !empty($substreamName)){?>
    				...
    				<?php }else{?>
    					<span itemtype="https://data-vocabulary.org/Breadcrumb" itemscope="">
			        		<a itemprop="url" href="<?php echo $domain.'/'.strtolower(seo_url($streamName, "-", 30)).'/'.strtolower(seo_url($substreamName, "-", 30)).'/exams/'.strtolower(seo_url($examTitle, "-", 30));?>">
			        			<span itemprop="title"><?php echo $examTitle;?></span>
			        		</a>
		    			</span>
    					<span class="breadcrumb-arrow">&rsaquo;</span>
