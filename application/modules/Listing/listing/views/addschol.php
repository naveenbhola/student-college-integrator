...
<div>
   ...
   <style>
	...
	<div id="mid_Panel_noLRpanel">
		<div class="">
			<div class="normaltxt_11p_blk fontSize_16p OrgangeFont"><strong>Add Scholarship </strong></div>
			...
			<div class="row normaltxt_11p_blk">
				<div class="float_R txt_align_r darkgray"><a href="addCourse" >Add Institute/Course Listing</a> | <a href="addAddmission">Add Admission Notification</a>| <a href="/payment/payment/index">Product Catalog</a></div>
			</div>
			...
			<div class="raised_lgraynoBG">
				<b class="b1"></b><b class="b2"></b><b class="b3"></b><b class="b4"></b>
					<div class="boxcontent_lgraynoBG">
						...
						<?php $this->load->view('listing/scholForm'); ?>
