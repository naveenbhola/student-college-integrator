...
$headerComponents = array('js'=>array('multipleapply','category','user','listingDetail','ajax-api','listingOverview','facebook'),
'jsFooter' =>array('common','lazyload','ana_common'),
...
echo jsb9recordServerTime('SHIKSHA_LISTING_DETAIL_TEST_OVERVIEW_PAGE',1);
?>
...
<script>
var currentPageName = 'LISTING_DETAIL_TESTPREP_OVERVIEW_TAB';
...
var sVC = '<?php if($identifier=='institute') echo $details['viewCount']; else echo $details['courseDetails']['0']['viewCount']; ?>';
