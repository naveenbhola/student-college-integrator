...
$headerComponents = array(
                          ...
                          'title' => 'Add Admission Notification',
                          'tabName' => 'Listing',
                          'taburl' => $thisUrl,
                          'product' => 'home',
...
<div>
   ...
   <style>
	...
	<div id="mid_Panel_noLRpanel">
		<div class="">
		   <div class="normaltxt_11p_blk fontSize_16p OrgangeFont"><strong>Add Admission Notification </strong></div>
            ...
            <?php endif; ?>
				...
				<div class="float_R txt_align_r darkgray"><a href="addCourse">Add Institute/Course Listing</a> | <a href="addScholarship">Add Scholarship Listing</a> | <a href="/payment/payment/index">Product Catalog</a></div>
			</div>
			...
			<div class="raised_lgraynoBG">
				<b class="b1"></b><b class="b2"></b><b class="b3"></b><b class="b4"></b>
					<div class="boxcontent_lgraynoBG">
						...
						<div class="clear_L"></div>
						<?php $this->load->view('listing/addadm'); ?>
					</div>
