...
<div class="widget-wrap clearwidth photos-vids-sec">
	...
	<div class="photo-video-tab">
        ...
        <a class="active photoLink"	style="cursor: default;text-decoration: none; " onclick="showMedia('photos');">Photos (<?php echo count($mediaData['photos']);?>)</a>
		<span>|</span> <a class="videoLink" style="cursor: pointer;text-decoration: none;"	 onclick="showMedia('videos');">Videos (<?php echo count($mediaData['videos']);?>)</a>
	   ...
	   <?php  if((count($mediaData['videos'])>0) && !(count($mediaData['photos'])>0)) {?>
		...
		<div class="viewport" style="width: 616px">
			...
			<li style = "width: 300px; height: 200px;"><img src="<? echo $video->getThumbURL() ?>"
				...
				<div class="common-sprite video-icon" onclick="openPhotoVideoOverLay('videoOverLay',<?php echo $index;?>);"></div></li>
