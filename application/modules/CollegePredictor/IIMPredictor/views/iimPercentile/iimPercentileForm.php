<?php $this->load->view('IIMPredictor/iimPercentile/iimPercentileWelcome'); ?>

<div class="base-frame">
    <div class="tab-form frame-padng">
        <h2 class="rnk-heading">Enter your expected CAT <?php echo date('Y');?> score below to predict your CAT percentile.</h2>
        ...
        <div class="src-tac">
            <a href="javascript:void(0);" id="src-btn" class="src-btn button button--orange rank_page">Predict Percentile</a>
        </div>
