<div id="cp-banner">
    <div class="base-frame"><div class="bc-wrapper"><?php $this->load->view('CP/V2/breadcrumb');?></div></div>
    <div class="clg-bg <?php if(strtoupper($examName)=='NIFT') echo 'nift-banner';?>" id="clg-bg">
        <div class="clg-txBx">
               <?php if ($examName == "jee-mains") { ?>
               <h1><?php echo strtoupper($examNameDisplay)." College Predictor ".$examYear; ?></h1>
                <h2 class="sb-hdng">Enter your <?php echo strtoupper($examNameDisplay)." ".date('Y') ?> rank to predict your colleges.</h2>
              <?php } else { ?>
                <h1><?php echo strtoupper($examNameDisplay)." ".$examYear; ?><span>  College Predictor</span></h1>
