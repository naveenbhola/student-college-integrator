...
class MY_Session extends CI_Session {
    ...
    var $CI;
    var $now;
    var $session_storage = 'database';
    var $sess_memcached_port = '';
    var $sess_memcached_nodes = array();
    var $memcache;
        ...
        switch ($this->session_storage) {
            case 'database':
                ...
                if ($this->sess_table_name != '') {
					$this->dbLibObj = DbLibCommon::getInstance('session');
					$this->CI->db = $this->dbLibObj->getWriteHandle();
                }
                break;
            case 'memcached':
                $this->memcache = new Memcache();
                foreach ($this->sess_memcached_nodes as $node) {
                    $this->memcache->addServer($node, $this->sess_memcached_port);
                }
