...
class ShikshaStats_client{
    ...
    function init(){
        ...
        $server_url = "http://snapdragon.infoedge.com/index.php/shikshaStats/shikshaStatsServer";
    ...
    function getData($timeDuration,$timeUnit,$parentId,$id,$client){ //requestArray is actually _POST array
        $this->init();
