...
/* Plz ensure that You have created virtual host named as localshiksha.com .. if NO then you will miss F-SHARE Features */
define('SHIKSHA_ENV', 'dev');
define('FACEBOOK_API_ID','185428988177601');
...
if (SHIKSHA_HOME == 'http://www.shiksha.com')
{
...
//Study Abroad --  moved to Shiksha constants now
