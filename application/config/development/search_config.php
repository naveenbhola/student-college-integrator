 ...
 * QER URL
 */
/*$config['qer_url'] = "http://localhost:8983/entity/entity";
$config['qer_url_new'] = "http://10.208.65.61:8984/query_entity_recognition/quiet";
$config['qer_url_upgraded'] = "http://172.16.3.247:8986/query_intent_entity_tagger/quiet";*/

$config['qer_url'] = "http://172.16.3.247:8985/entity/entity";
$config['qer_url_new'] = "http://172.16.3.248:8986/query_entity_recognition/quiet";
$config['qer_url_upgraded'] = "http://172.16.3.111:8983/query_intent_entity_tagger/quiet";
$config['qer_url_mapupdate'] = "http://172.16.3.111:8983/query_intent_entity_tagger/mapupdate?dbgenerate=true&candidatecsv=all";

/**
 * QUE Race URL
 */
$config['querace_url'] = "http://localhost:9090/querace/select?";
