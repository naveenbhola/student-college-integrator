...
define('MAX_ITEM_DUMP',300);

$MEMCACHE_SERVERS[] = '127.0.0.1:11211'; // add more servers as an array
...
<div class="head">
	<h1 class="memcache">
	<span class="logo"><a href="http://www.shiksha.com">memcache</a></span>
		<span class="nameinfo">memcache.php by <a href="http://www.shiksha.com">Shiksha Tech.</a></span>
	</h1>
	<hr class="memcache">
</div>
<div class=content>
